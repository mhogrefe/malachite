...
impl Integer {
    ...
    /// ```
    pub fn mod_power_of_2(self, other: u32) -> Natural {
        if self.sign {
    ...
    /// ```
    pub fn rem_power_of_2(self, other: u32) -> Integer {
        let abs_rem = self.abs.mod_power_of_2(other);
        Integer {
    ...
    pub fn rem_power_of_2_ref(&self, other: u32) -> Integer {
        let abs_rem = self.abs.mod_power_of_2_ref(other);
        Integer {
            sign: self.sign || abs_rem == 0,
            abs: abs_rem,
        }
