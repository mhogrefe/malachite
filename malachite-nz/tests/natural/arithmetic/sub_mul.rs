...
fn test_limbs_sub_mul_limb_greater() {
    ...
    test(&[123, 456], &[123], 4, &[4_294_966_927, 455], 0);
...
fn test_limbs_sub_mul_limb_same_length() {
    ...
    test(&[123, 456], &[123, 0], 4, &[4_294_966_927, 455], 0);
...
fn test_limbs_sub_mul_and_limbs_sub_mul_in_place_left() {
    ...
    test(
        ...
        &[123, 789],
        &[321, 654],
        Some(vec![4_294_927_936, 4_294_634_040, 4_294_452_078, 0]),
    );
    test(
        &[123, 456, 789, 987, 654],
        &[123, 789],
        &[321, 654],
        Some(vec![4_294_927_936, 4_294_634_040, 4_294_452_078, 986, 654]),
    );
}
