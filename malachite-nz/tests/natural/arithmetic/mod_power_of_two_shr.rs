...
macro_rules! tests_signed {
    ($t:ident, $test_mod_power_of_two_shr_i:ident) => {
        #[test]
...
tests_signed!(i8, test_mod_power_of_two_shr_i8);
tests_signed!(i16, test_mod_power_of_two_shr_i16);
tests_signed!(i32, test_mod_power_of_two_shr_i32);
tests_signed!(i64, test_mod_power_of_two_shr_i64);
tests_signed!(isize, test_mod_power_of_two_shr_isize);
