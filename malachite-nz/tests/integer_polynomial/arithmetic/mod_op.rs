...
use malachite_nz::test_util::generators::{
    integer_polynomial_gen, integer_polynomial_natural_pair_gen_var_1,
    integer_polynomial_unsigned_pair_gen, integer_polynomial_unsigned_polynomial_pair_gen,
};
...
fn mod_op_properties() {
    integer_polynomial_natural_pair_gen_var_1().test_properties(|(p, m)| {
        ...
        // Coefficient by coefficient, this is the `Integer` operation, and each result is
        // congruent to the original coefficient.
        ...
        // On a polynomial with no negative coefficients, this is the `NaturalPolynomial`
        // operation.
