...
fn random_integer_polynomials_degree_inclusive_range_helper(
    a: u64,
    b: u64,
...
#[test]
fn test_random_integer_polynomials_degree_inclusive_range() {
    // degrees in [0, 1], mean bits = 65/64
    random_integer_polynomials_degree_inclusive_range_helper(
        0,
        1,
        65,
        64,
...
#[test]
#[should_panic]
fn random_integer_polynomials_degree_inclusive_range_fail_1() {
    let _ = random_integer_polynomials_degree_inclusive_range(EXAMPLE_SEED, 3, 2, 2, 1);
}
