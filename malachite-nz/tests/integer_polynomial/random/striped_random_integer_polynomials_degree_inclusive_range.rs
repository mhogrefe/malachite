...
fn striped_random_integer_polynomials_degree_inclusive_range_helper(
    a: u64,
    b: u64,
...
#[test]
fn test_striped_random_integer_polynomials_degree_inclusive_range() {
    // degrees in [0, 1], mean stripe = 16, mean bits = 2
    striped_random_integer_polynomials_degree_inclusive_range_helper(
        0,
        1,
        16,
        1,
...
#[test]
#[should_panic]
fn striped_random_integer_polynomials_degree_inclusive_range_fail_1() {
    let _ =
        striped_random_integer_polynomials_degree_inclusive_range(EXAMPLE_SEED, 3, 2, 16, 1, 2, 1);
}
