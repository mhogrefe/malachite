...
fn round_to_multiple_of_power_of_two_assign_fail_1() {
    Integer::from(-123).round_to_multiple_of_power_of_two_assign(1, RoundingMode::Exact);
}

#[test]
#[should_panic]
fn round_to_multiple_of_power_of_two_assign_fail_2() {
    Integer::from(-123).round_to_multiple_of_power_of_two_assign(100, RoundingMode::Exact);
}
...
fn round_to_multiple_of_power_of_two_fail_1() {
    Integer::from(-123).round_to_multiple_of_power_of_two(1, RoundingMode::Exact);
}

#[test]
#[should_panic]
fn round_to_multiple_of_power_of_two_fail_2() {
    Integer::from(-123).round_to_multiple_of_power_of_two(100, RoundingMode::Exact);
}
