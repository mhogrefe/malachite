...
fn test_i32_wrapping_from_integer() {
    ...
    test("123", 123);
    test("1000000000000", -727_379_968);
    test("2147483648", -0x8000_0000);
    test("2147483649", -0x7fff_ffff);
    test("-123", -123);
    test("-1000000000000", 727_379_968);
    test("-2147483649", 0x7fff_ffff);
    test("-2147483650", 0x7fff_fffe);
}
...
fn test_i32_saturating_from_integer() {
    ...
    test("0", 0);
    test("123", 123);
    test("1000000000000", 0x7fff_ffff);
    test("2147483648", 0x7fff_ffff);
    test("2147483649", 0x7fff_ffff);
    test("-123", -123);
    test("-1000000000000", -0x8000_0000);
    test("-2147483648", -0x8000_0000);
    test("-2147483649", -0x8000_0000);
}
...
fn test_i32_overflowing_from_integer() {
    ...
    test("123", (123, false));
    test("1000000000000", (-727_379_968, true));
    test("2147483648", (-0x8000_0000, true));
    test("2147483649", (-0x7fff_ffff, true));
    test("-123", (-123, false));
    test("-1000000000000", (727_379_968, true));
    test("-2147483649", (0x7fff_ffff, true));
    test("-2147483650", (0x7fff_fffe, true));
}
...
fn test_i64_wrapping_from_integer() {
    ...
    test("123", 123);
    test("1000000000000000000000000", 2_003_764_205_206_896_640);
    test("9223372036854775808", -0x8000_0000_0000_0000);
    test("9223372036854775809", -0x7fff_ffff_ffff_ffff);
    test("-123", -123);
    test("-1000000000000000000000000", -2_003_764_205_206_896_640);
    test("-9223372036854775809", 0x7fff_ffff_ffff_ffff);
    test("-9223372036854775810", 0x7fff_ffff_ffff_fffe);
}
...
fn test_i64_saturating_from_integer() {
    ...
    test("0", 0);
    test("123", 123);
    test("1000000000000000000000000", 0x7fff_ffff_ffff_ffff);
    test("9223372036854775808", 0x7fff_ffff_ffff_ffff);
    test("9223372036854775809", 0x7fff_ffff_ffff_ffff);
    test("-123", -123);
    test("-1000000000000000000000000", -0x8000_0000_0000_0000);
    test("-9223372036854775808", -0x8000_0000_0000_0000);
    test("-9223372036854775809", -0x8000_0000_0000_0000);
}
...
fn test_i64_overflowing_from_integer() {
    ...
    test("9223372036854775808", (-0x8000_0000_0000_0000, true));
    test("9223372036854775809", (-0x7fff_ffff_ffff_ffff, true));
    test("-123", (-123, false));
    test(
        "-1000000000000000000000000",
        (-2_003_764_205_206_896_640, true),
    ...
    test("-9223372036854775809", (0x7fff_ffff_ffff_ffff, true));
    test("-9223372036854775810", (0x7fff_ffff_ffff_fffe, true));
}
