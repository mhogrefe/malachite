...
/// [`IntegerPolynomial`](super::super::IntegerPolynomial) whose variable is named by any
...
/// writing an [`IntegerPolynomial`](super::super::IntegerPolynomial) whose variable is named by any
/// [`VarScheme`](malachite_base::vars::VarScheme).
pub mod latex;
