...
macro_rules! impl_integer_shr_signed {
    ($t:ident) => {
        ...
        /// use malachite_nz::integer::Integer;
        ///
        /// assert_eq!(Integer::from(0x101u32).shr_round(8i8, RoundingMode::Down).to_string(), "1");
        /// assert_eq!(Integer::from(0x101u32).shr_round(8i16, RoundingMode::Up).to_string(), "2");
        ///
        /// assert_eq!(Integer::from(-0x101).shr_round(9i32, RoundingMode::Down).to_string(), "0");
        /// assert_eq!(Integer::from(-0x101).shr_round(9i64, RoundingMode::Up).to_string(), "-1");
