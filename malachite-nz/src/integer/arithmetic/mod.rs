...
pub mod div_exact;
/// Implementations of traits for simultaneously finding the quotient and remainder of two numbers,
...
/// multiplying two numbers and right-shifting the product with a specified rounding mode. When most
