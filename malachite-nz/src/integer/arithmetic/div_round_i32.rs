...
impl DivRound<i32> for Integer {
    ...
    /// Divides an `Integer` by an `i32` and rounds according to a specified rounding mode, taking
    ...
    /// }
    /// ```
    fn div_round(mut self, other: i32, rm: RoundingMode) -> Integer {
...
impl<'a> DivRound<i32> for &'a Integer {
    ...
    /// }
    /// ```
    fn div_round(self, other: i32, rm: RoundingMode) -> Integer {
...
impl DivRound<Integer> for i32 {
    ...
    /// Divides an `i32` by an `Integer` and rounds according to a specified rounding mode, taking
    /// the `Integer` by value. See the `RoundingMode` documentation for details.
    ///
    /// Time: worst case O(n)
    ///
...
impl<'a> DivRound<&'a Integer> for i32 {
    ...
    /// Divides a `i32` by an `Integer` and rounds according to a specified rounding mode, taking
    /// the `Integer` by reference. See the `RoundingMode` documentation for details.
    ///
    /// Time: worst case O(n)
    ///
...
impl DivRoundAssign<i32> for Integer {
    /// Divides an `Integer` by an `i32` in place and rounds according to a specified rounding mode.
