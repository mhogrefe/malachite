...
impl DivModEuclidean<Self> for Integer {
    type DivOutput = Self;
    ...
    /// assert_eq!(
    ///     Integer::from(23)
    ///         .div_mod_euclidean(Integer::from(10))
    ///         .to_debug_string(),
    ///     "(2, 3)"
    /// );
    ///
    ...
    /// ```
    #[inline]
    fn div_mod_euclidean(self, other: Self) -> (Self, Natural) {
...
impl DivModEuclidean<Integer> for &Integer {
    ...
    /// ```
    #[inline]
    fn div_mod_euclidean(self, other: Integer) -> (Integer, Natural) {
        let (q, r) = self.div_mod(&other);
        make_remainder_nonnegative(q, r, other)
    }
}
...
impl DivAssignModEuclidean<Self> for Integer {
    type ModOutput = Natural;
    ...
    /// assert_eq!(x.div_assign_mod_euclidean(Integer::from(10)), 7);
    /// assert_eq!(x, -3);
    /// ```
    #[inline]
    fn div_assign_mod_euclidean(&mut self, other: Self) -> Natural {
        let (q, r) = (&*self).div_mod_euclidean(other);
        *self = q;
        r
    }
}
