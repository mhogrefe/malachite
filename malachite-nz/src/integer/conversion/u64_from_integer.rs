...
impl CheckedFrom<Integer> for u64 {
    /// Converts an `Integer` to a `u64`, taking the `Integer` by value and returning `None` if the
...
impl<'a> CheckedFrom<&'a Integer> for u64 {
    /// Converts an `Integer` to a `u64`, taking the `Integer` by reference and returning `None` if
...
impl WrappingFrom<Integer> for u64 {
    /// Converts an `Integer` to a `u64`, taking the `Integer` by value and wrapping mod
    /// 2<pow>64</pow>.
    ///
    /// Time: worst case O(1)
    ///
...
impl<'a> WrappingFrom<&'a Integer> for u64 {
    /// Converts an `Integer` to a `u64`, taking the `Integer` by reference and wrapping mod
    /// 2<pow>64</pow>.
    ///
    /// Time: worst case O(1)
    ///
