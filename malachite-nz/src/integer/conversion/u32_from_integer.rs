...
impl CheckedFrom<Integer> for u32 {
    /// Converts an `Integer` to a `u32`, taking the `Integer` by value and returning `None` if
...
impl<'a> CheckedFrom<&'a Integer> for u32 {
    /// Converts an `Integer` to a `u32`, taking the `Integer` by reference and returning `None` if
    /// the `Integer` is negative or too large.
    ///
    /// Time: worst case O(1)
    ///
...
impl WrappingFrom<Integer> for u32 {
    /// Converts an `Integer` to a `u32`, taking the `Integer` by value and wrapping mod
    /// 2<sup>32</sup>.
    ///
    /// Time: worst case O(1)
    ///
...
impl<'a> WrappingFrom<&'a Integer> for u32 {
    /// Converts an `Integer` to a `u32`, taking the `Integer` by reference and wrapping mod
    /// 2<sup>32</sup>.
    ///
    /// Time: worst case O(1)
    ///
