...
//! Conversions between [`Integer`](crate::integer::Integer)s and Python integers.
//!
...
//! ## Examples
//!
//! Using [`Integer`](crate::integer::Integer) to correctly increment an arbitrary precision integer.
