...
/// Takes the bitwise and of an `Integer` and a `u32`, taking the `Integer` by value. The output is
/// a `u32`.
///
/// Time: worst case O(1)
///
...
/// Takes the bitwise and of a `u32` and an `Integer`, taking the `Integer` by value. The output is
/// a `u32`.
///
/// Time: worst case O(1)
///
...
/// Bitwise-ands a `u32` with an `Integer` in place, taking the `Integer` by value.
///
/// Time: worst case O(1)
///
/// Additional memory: worst case O(1)
...
/// Bitwise-ands a `u32` with an `Integer` in place, taking the `Integer` by reference.
///
/// Time: worst case O(1)
///
/// Additional memory: worst case O(1)
