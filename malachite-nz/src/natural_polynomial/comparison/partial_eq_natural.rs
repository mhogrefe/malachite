...
impl PartialEq<Natural> for NaturalPolynomial {
    /// Determines whether a [`NaturalPolynomial`] is equal to a [`Natural`].
    ///
    ...
    /// degree is equal to any [`Natural`].
    ///
...
impl PartialEq<NaturalPolynomial> for Natural {
    /// Determines whether a [`Natural`] is equal to a [`NaturalPolynomial`].
    ///
