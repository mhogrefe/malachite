...
macro_rules! impl_partial_eq_unsigned {
    ($t: ident) => {
        impl PartialEq<$t> for NaturalPolynomial {
            /// Determines whether a [`NaturalPolynomial`] is equal to a value of an unsigned
        ...
        impl PartialEq<NaturalPolynomial> for $t {
            /// Determines whether a value of an unsigned primitive integer type is equal to a
            /// [`NaturalPolynomial`].
            ///
