...
impl ToLatex for NaturalPolynomial {
    /// Writes a [`NaturalPolynomial`] as a LaTeX math-mode fragment.
    ///
    /// The variable is called `x`.
    /// [`to_latex_string_with`](NaturalPolynomial::to_latex_string_with) is the way to call it
    /// something else.
    ///
    ...
    /// );
    /// assert_eq!(
    ///     NaturalPolynomial::from_str("0").unwrap().to_latex_string(),
    ///     "0"
    /// );
    /// assert_eq!(
    ///     NaturalPolynomial::from_str("5").unwrap().to_latex_string(),
    ///     "5"
    /// );
    /// assert_eq!(
    ///     NaturalPolynomial::from_str("x").unwrap().to_latex_string(),
    ///     "x"
    /// );
    /// assert_eq!(
