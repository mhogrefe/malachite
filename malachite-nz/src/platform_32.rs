...
pub const MUL_TOOM44_THRESHOLD: usize = 542;
pub const MUL_TOOM6H_THRESHOLD: usize = 738;
pub const MUL_TOOM8H_THRESHOLD: usize = 984;

pub const MUL_TOOM32_TO_TOOM43_THRESHOLD: usize = 88;
...
pub const DC_DIV_QR_THRESHOLD: usize = 51;
pub const DC_DIVAPPR_Q_THRESHOLD: usize = 171;
pub const MAYBE_DCP1_DIVAPPR: bool = true;
pub const INV_NEWTON_THRESHOLD: usize = 170;
pub const MU_DIV_QR_THRESHOLD: usize = 1442;
pub const INV_MULMOD_BNM1_THRESHOLD: usize = 38;
