...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_integer_polynomial_is_unit);
    register_bench!(runner, benchmark_integer_polynomial_is_unit);
}

fn demo_integer_polynomial_is_unit(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_integer_polynomial_is_unit(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
