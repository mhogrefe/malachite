...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_natural_is_gaussian_integer);
    register_bench!(runner, benchmark_natural_is_gaussian_integer);
}

fn demo_natural_is_gaussian_integer(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_natural_is_gaussian_integer(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
