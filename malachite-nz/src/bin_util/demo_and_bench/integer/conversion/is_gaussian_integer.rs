...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_integer_is_gaussian_integer);
    register_bench!(runner, benchmark_integer_is_gaussian_integer);
}

fn demo_integer_is_gaussian_integer(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_integer_is_gaussian_integer(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
