...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_gaussian_integer_is_integer);
    register_bench!(runner, benchmark_gaussian_integer_is_integer);
}

fn demo_gaussian_integer_is_integer(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_gaussian_integer_is_integer(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
