...
use malachite_base::num::arithmetic::traits::{
    ...
    EqMod, EqModPowerOf2, Height, HeightRef, Parity, PowerOf2, RoundToMultipleOfPowerOf2Assign,
    Square,
};
...
pub fn special_random_natural_polynomial_unsigned_pair_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_natural_polynomial_pair_gen(
    config: &GenConfig,
...
pub fn special_random_natural_polynomial_triple_gen(
    config: &GenConfig,
...
pub fn special_random_natural_polynomial_natural_pair_gen_var_1(
    config: &GenConfig,
) -> It<(NaturalPolynomial, Natural)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_natural_polynomial_natural_unsigned_triple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_natural_polynomial_natural_natural_triple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_integer_polynomial_unsigned_pair_gen<T: PrimitiveUnsigned>(
    config: &GenConfig,
...
pub fn special_random_integer_polynomial_signed_pair_gen<T: PrimitiveSigned>(
    config: &GenConfig,
) -> It<(IntegerPolynomial, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
        ...
        &|seed| {
            striped_random_signeds(
                seed,
                config.get_or("mean_signed_stripe_n", T::WIDTH >> 1),
                config.get_or("mean_signed_stripe_d", 1),
            )
        },
    ))
}

pub fn special_random_integer_polynomial_gaussian_integer_pair_gen(
    config: &GenConfig,
...
pub fn special_random_integer_polynomial_integer_pair_gen(
    config: &GenConfig,
...
pub fn special_random_gaussian_integer_pair_gen(
    config: &GenConfig,
) -> It<(GaussianInteger, GaussianInteger)> {
    Box::new(random_pairs_from_single(striped_random_gaussian_integers(
        EXAMPLE_SEED,
        config.get_or("mean_stripe_n", 32),
        config.get_or("mean_stripe_d", 1),
        config.get_or("mean_bits_n", 64),
...
pub fn special_random_gaussian_integer_gen_var_4(config: &GenConfig) -> It<GaussianInteger> {
    Box::new(
        striped_random_gaussian_integers(
            EXAMPLE_SEED,
            config.get_or("mean_stripe_n", 32),
...
pub fn special_random_gaussian_integer_integer_pair_gen(
    config: &GenConfig,
...
pub fn special_random_gaussian_integer_natural_pair_gen(
    config: &GenConfig,
...
pub fn special_random_gaussian_integer_primitive_float_pair_gen<T: PrimitiveFloat>(
    config: &GenConfig,
...
pub fn special_random_gaussian_integer_unsigned_pair_gen_var_2<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianInteger, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_gaussian_integer_unsigned_pair_gen<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianInteger, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_integer_integer_rounding_mode_triple_gen_var_3(
    config: &GenConfig,
) -> It<(Integer, Integer, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_natural_natural_rounding_mode_triple_gen_var_3(
    config: &GenConfig,
) -> It<(Natural, Natural, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_gaussian_integer_vec_gen(config: &GenConfig) -> It<Vec<GaussianInteger>> {
    Box::new(random_vecs(
        EXAMPLE_SEED,
        &|seed| {
            striped_random_gaussian_integers(
...
pub fn special_random_unsigned_vec_unsigned_unsigned_triple_gen_var_22(
    config: &GenConfig,
) -> It<(Vec<Limb>, u64, u64)> {
    Box::new(
        random_triples(
...
pub fn special_random_natural_natural_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
    ...
    Box::new(
        random_triples(
            ...
            &|seed| {
                random_pairs_from_single(striped_random_naturals(
                    seed,
                    config.get_or("mean_stripe_n", 128),
                    config.get_or("mean_stripe_d", 1),
...
pub fn special_random_integer_integer_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
