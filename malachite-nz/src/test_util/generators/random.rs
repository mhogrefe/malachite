...
pub fn random_natural_polynomial_unsigned_pair_gen<T: PrimitiveUnsigned>(
    config: &GenConfig,
...
pub fn random_natural_polynomial_unsigned_polynomial_pair_gen<T: PrimitiveUnsigned>(
    config: &GenConfig,
...
pub fn random_natural_polynomial_natural_pair_gen(
    config: &GenConfig,
...
pub fn random_natural_polynomial_natural_natural_triple_gen_var_1(
    config: &GenConfig,
...
pub fn random_natural_polynomial_integer_pair_gen(
    config: &GenConfig,
...
pub fn random_integer_polynomial_primitive_int_pair_gen<T: PrimitiveInt>(
    config: &GenConfig,
...
pub fn random_integer_polynomial_gaussian_integer_pair_gen(
    config: &GenConfig,
...
pub fn random_integer_polynomial_integer_pair_gen(
    config: &GenConfig,
...
pub fn random_integer_polynomial_integer_pair_gen_var_1(
    config: &GenConfig,
) -> It<(IntegerPolynomial, Integer)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_integer_polynomial_natural_pair_gen_var_1(
    config: &GenConfig,
) -> It<(IntegerPolynomial, Natural)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_integer_polynomial_natural_polynomial_pair_gen(
    config: &GenConfig,
...
pub fn random_gaussian_integer_pair_gen_var_1(
    config: &GenConfig,
) -> It<(GaussianInteger, GaussianInteger)> {
    Box::new(
        random_pairs(
...
pub fn random_gaussian_integer_pair_gen_var_2(
    config: &GenConfig,
) -> It<(GaussianInteger, GaussianInteger)> {
    Box::new(
        random_pairs(
...
pub fn random_gaussian_integer_pair_gen_var_3(
    config: &GenConfig,
) -> It<(GaussianInteger, GaussianInteger)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_gaussian_integer_gen_var_3(config: &GenConfig) -> It<GaussianInteger> {
    Box::new(
        random_gaussian_integers(
            EXAMPLE_SEED,
            config.get_or("mean_bits_n", 64),
...
pub fn random_gaussian_integer_unsigned_pair_gen_var_1<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianInteger, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_integer_pair_gen_var_9(config: &GenConfig) -> It<(Integer, Integer)> {
    Box::new(
        random_pairs_from_single(random_integers(
            EXAMPLE_SEED,
            config.get_or("mean_bits_n", 64),
...
pub fn random_integer_quadruple_gen(
    config: &GenConfig,
) -> It<(Integer, Integer, Integer, Integer)> {
    Box::new(random_quadruples_from_single(random_integers(
        EXAMPLE_SEED,
        config.get_or("mean_bits_n", 64),
        config.get_or("mean_bits_d", 1),
    )))
...
pub fn random_natural_pair_gen_var_16(config: &GenConfig) -> It<(Natural, Natural)> {
    Box::new(
        random_pairs_from_single(random_naturals(
            EXAMPLE_SEED,
            config.get_or("mean_bits_n", 64),
...
pub fn random_natural_quadruple_gen(
    config: &GenConfig,
) -> It<(Natural, Natural, Natural, Natural)> {
    Box::new(random_quadruples_from_single(random_naturals(
        EXAMPLE_SEED,
        config.get_or("mean_bits_n", 64),
        config.get_or("mean_bits_d", 1),
    )))
...
pub fn random_natural_quadruple_gen_var_4(
    config: &GenConfig,
) -> It<(Natural, Natural, Natural, Natural)> {
