...
macro_rules! impl_natural_shr_signed {
    ($t:ident) => {
        ...
        /// use malachite_nz::natural::Natural;
        ///
        /// assert_eq!(Natural::from(0x101u32).shr_round(8i8, RoundingMode::Down).to_string(), "1");
        /// assert_eq!(Natural::from(0x101u32).shr_round(8i16, RoundingMode::Up).to_string(), "2");
        ///
        /// assert_eq!(Natural::from(0x101u32).shr_round(9i32, RoundingMode::Down).to_string(),
        ///     "0");
        /// assert_eq!(Natural::from(0x101u32).shr_round(9i64, RoundingMode::Up).to_string(), "1");
        /// assert_eq!(Natural::from(0x101u32).shr_round(9i8, RoundingMode::Nearest).to_string(),
        ///     "1");
        /// assert_eq!(Natural::from(0xffu32).shr_round(9i16, RoundingMode::Nearest).to_string(),
        ///     "0");
