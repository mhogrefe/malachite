...
use malachite_base::num::arithmetic::traits::{
    DivAssignMod, DivAssignModEuclidean, DivMod, DivModEuclidean,
};

impl DivModEuclidean<Self> for Natural {
    type DivOutput = Self;
    type ModOutput = Self;
    ...
    /// assert_eq!(
    ///     Natural::from(23u32)
    ///         .div_mod_euclidean(Natural::from(10u32))
    ///         .to_debug_string(),
    ///     "(2, 3)"
    /// );
    /// ```
    #[inline]
    fn div_mod_euclidean(self, other: Self) -> (Self, Self) {
        self.div_mod(other)
    }
}
...
impl DivModEuclidean<&Self> for Natural {
    ...
    /// assert_eq!(
    ///     Natural::from(456u32)
    ///         .div_mod_euclidean(&Natural::from(123u32))
    ///         .to_debug_string(),
    ///     "(3, 87)"
    /// );
    /// ```
...
impl DivModEuclidean<Natural> for &Natural {
    ...
    /// assert_eq!(
    ///     (&Natural::from(123u32))
    ///         .div_mod_euclidean(Natural::from(456u32))
    ///         .to_debug_string(),
    ///     "(0, 123)"
    /// );
    /// ```
    #[inline]
    fn div_mod_euclidean(self, other: Natural) -> (Natural, Natural) {
        self.div_mod(other)
    }
}
...
impl DivAssignModEuclidean<Self> for Natural {
    type ModOutput = Self;
    ...
    /// assert_eq!(x.div_assign_mod_euclidean(Natural::from(10u32)), 3);
    /// assert_eq!(x, 2);
    /// ```
    #[inline]
    fn div_assign_mod_euclidean(&mut self, other: Self) -> Self {
...
impl DivAssignModEuclidean<&Self> for Natural {
    ...
    /// assert_eq!(x.div_assign_mod_euclidean(&Natural::from(123u32)), 87);
    /// assert_eq!(x, 3);
    /// ```
    #[inline]
    fn div_assign_mod_euclidean(&mut self, other: &Self) -> Self {
