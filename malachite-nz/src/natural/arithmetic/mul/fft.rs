...
const MUL_FFT_TABLE3: [FFTTableNK; MUL_FFT_TABLE3_SIZE] = [
    ...
    FFTTableNK { n: 1_023, k: 11 },
    FFTTableNK { n: 543, k: 12 },
    FFTTableNK { n: 287, k: 11 },
    FFTTableNK { n: 575, k: 10 },
    FFTTableNK { n: 1_151, k: 11 },
    ...
    FFTTableNK { n: 511, k: 11 },
    FFTTableNK { n: 1_023, k: 12 },
    FFTTableNK { n: 543, k: 11 },
    FFTTableNK { n: 1_087, k: 12 },
    FFTTableNK { n: 575, k: 11 },
    FFTTableNK { n: 1_151, k: 12 },
    ...
    FFTTableNK { n: 1_407, k: 13 },
    FFTTableNK { n: 2_815, k: 15 },
    FFTTableNK { n: 767, k: 14 },
    FFTTableNK { n: 1_535, k: 13 },
    FFTTableNK { n: 3_071, k: 14 },
    FFTTableNK { n: 1_663, k: 13 },
    FFTTableNK { n: 3_455, k: 14 },
    FFTTableNK { n: 1_919, k: 16 },
    ...
    FFTTableNK { n: 5_887, k: 15 },
    FFTTableNK { n: 1_535, k: 14 },
    FFTTableNK { n: 3_455, k: 15 },
    FFTTableNK { n: 1_791, k: 14 },
    FFTTableNK { n: 3_839, k: 13 },
    FFTTableNK { n: 7_679, k: 16 },
    FFTTableNK { n: 1_023, k: 15 },
    FFTTableNK { n: 2_047, k: 14 },
    FFTTableNK { n: 4_223, k: 15 },
    FFTTableNK { n: 2_303, k: 14 },
    FFTTableNK { n: 4_863, k: 15 },
    FFTTableNK { n: 2_815, k: 14 },
    FFTTableNK { n: 5_887, k: 16 },
    FFTTableNK { n: 1_535, k: 15 },
    FFTTableNK { n: 3_327, k: 14 },
    FFTTableNK { n: 6_911, k: 15 },
    FFTTableNK { n: 3_839, k: 14 },
    FFTTableNK { n: 7_679, k: 17 },
    FFTTableNK { n: 1_023, k: 16 },
    FFTTableNK { n: 2_047, k: 15 },
    FFTTableNK { n: 4_863, k: 16 },
...
const SQR_FFT_TABLE3: [FFTTableNK; SQR_FFT_TABLE3_SIZE] = [
    ...
    FFTTableNK { n: 1_471, k: 14 },
    FFTTableNK { n: 767, k: 13 },
    FFTTableNK { n: 1_599, k: 12 },
    FFTTableNK { n: 3_199, k: 13 },
    FFTTableNK { n: 1_663, k: 14 },
    FFTTableNK { n: 895, k: 13 },
    FFTTableNK { n: 1_791, k: 15 },
    FFTTableNK { n: 511, k: 14 },
    FFTTableNK { n: 1_023, k: 13 },
    FFTTableNK { n: 2_175, k: 14 },
    FFTTableNK { n: 1_151, k: 13 },
