...
pub mod limb;
/// Code for computing only the lowest [limbs](crate#limbs) of the product of two [`Natural`]s. Code
/// for computing an approximation of the high half of a product, used in `Float` multiplication and
/// in `mul_shr_round`.
pub mod mul_high;
pub mod mul_low;
