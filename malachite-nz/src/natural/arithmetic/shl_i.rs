...
macro_rules! impl_natural_shl_signed {
    ($t:ident) => {
        ...
        ///     "1");
        /// assert_eq!(Natural::from(0x101u32).shl_round(-8i16, RoundingMode::Up).to_string(), "2");
        ///
        /// assert_eq!(Natural::from(0x101u32).shl_round(-9i32, RoundingMode::Down).to_string(),
        ///     "0");
        /// assert_eq!(Natural::from(0x101u32).shl_round(-9i64, RoundingMode::Up).to_string(), "1");
        /// assert_eq!(Natural::from(0x101u32).shl_round(-9i8, RoundingMode::Nearest).to_string(),
        ///     "1");
        /// assert_eq!(Natural::from(0xffu32).shl_round(-9i16, RoundingMode::Nearest).to_string(),
        ///     "0");
        /// assert_eq!(Natural::from(0x100u32).shl_round(-9i32, RoundingMode::Nearest).to_string(),
        ///     "0");
        ///
        /// assert_eq!(Natural::from(0x100u32).shl_round(-8i64, RoundingMode::Exact).to_string(),
        ///     "1");
        ///
