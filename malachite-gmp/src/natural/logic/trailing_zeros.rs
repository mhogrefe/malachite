...
impl Natural {
    ...
    /// use std::str::FromStr;
    ///
    /// assert_eq!(Natural::from(0).trailing_zeros(), None);
    /// assert_eq!(Natural::from(3).trailing_zeros(), Some(0));
    /// assert_eq!(Natural::from(72).trailing_zeros(), Some(3));
    /// assert_eq!(Natural::from(100).trailing_zeros(), Some(2));
