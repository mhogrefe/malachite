...
cargo clippy --tests --features bin_build --features enable_serde &&
echo "Step 75. Testing malachite-q with bin_build" &&
cargo test --release --features bin_build --features enable_serde &&
echo "Step 76. Testing malachite-q doctests without bin_build" &&
cargo test --release --doc &&
echo "Step 77. Testing malachite-q doctests without bin_build, with random" &&
cargo test --release --doc --features random &&
echo "Step 78. Documenting malachite-q" &&
RUSTDOCFLAGS="--html-in-header katex-header.html" cargo doc --lib --no-deps --features random &&
echo "Step 79. Building malachite-q lib for wasm" &&
cargo build --lib --release --target wasm32-unknown-unknown &&
cd ../malachite-float &&
echo "Step 80. Updating malachite-float" &&
cargo update &&
echo "Step 81. Formatting malachite-float" &&
cargo +nightly fmt --all &&
echo "Step 82. Running clippy on malachite-float" &&
cargo clippy --tests --features bin_build --features enable_serde &&
echo "Step 83. Testing malachite-float with bin_build" &&
cargo test --release --features bin_build --features enable_serde &&
echo "Step 84. Testing malachite-float doctests without bin_build" &&
cargo test --release --doc &&
echo "Step 85. Testing malachite-float doctests without bin_build, with random" &&
cargo test --release --doc --features random &&
echo "Step 86. Documenting malachite-float" &&
RUSTDOCFLAGS="--html-in-header katex-header.html" cargo doc --lib --no-deps --features random &&
echo "Step 87. Building malachite-float lib for wasm" &&
cargo build --lib --release --target wasm32-unknown-unknown &&
cd ../malachite-criterion-bench &&
echo "Step 88. Updating malachite-criterion-bench" &&
cargo update &&
echo "Step 89. Formatting malachite-criterion-bench" &&
cargo +nightly fmt --all &&
cd .. &&
echo "Step 90. Running additional-lints" &&
python3 additional-lints.py
