...
use malachite_base_test_util::generators::unsigned_quadruple_gen_var_10;
use malachite_base_test_util::runner::Runner;

pub(crate) fn register(runner: &mut Runner) {
    register_unsigned_demos!(runner, demo_xx_add_yy_is_zz);
    register_unsigned_benches!(runner, benchmark_xx_add_yy_is_zz_algorithms);
}

fn demo_xx_add_yy_is_zz<T: PrimitiveUnsigned>(gm: GenMode, config: GenConfig, limit: usize) {
...
fn benchmark_xx_add_yy_is_zz_algorithms<T: PrimitiveUnsigned>(
    gm: GenMode,
    config: GenConfig,
    limit: usize,
    file_name: &str,
