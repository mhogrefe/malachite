...
pub(crate) fn register(runner: &mut Runner) {
    register_unsigned_demos!(runner, demo_xxx_sub_yyy_is_zzz);
    register_unsigned_benches!(runner, benchmark_xxx_sub_yyy_is_zzz);
}

fn demo_xxx_sub_yyy_is_zzz<T: PrimitiveUnsigned>(gm: GenMode, config: GenConfig, limit: usize) {
...
fn benchmark_xxx_sub_yyy_is_zzz<T: PrimitiveUnsigned>(
    gm: GenMode,
    config: GenConfig,
    limit: usize,
    file_name: &str,
