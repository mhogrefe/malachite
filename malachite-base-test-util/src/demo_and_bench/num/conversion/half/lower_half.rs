...
pub(crate) fn register(runner: &mut Runner) {
    register_generic_demos!(runner, demo_unsigned_lower_half, u16, u32, u64, u128);
    register_generic_benches!(runner, benchmark_unsigned_lower_half, u16, u32, u64, u128);
}

fn demo_unsigned_lower_half<T: PrimitiveUnsigned + SplitInHalf>(
    gm: GenMode,
    config: GenConfig,
    limit: usize,
) where
...
fn benchmark_unsigned_lower_half<T: PrimitiveUnsigned + SplitInHalf>(
    gm: GenMode,
    config: GenConfig,
    limit: usize,
    file_name: &str,
