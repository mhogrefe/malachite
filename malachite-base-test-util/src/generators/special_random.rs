...
use generators::{
    ...
    reduce_to_fit_sub_mul_signed, reduce_to_fit_sub_mul_unsigned, unsigned_pair_gen_var_5_limit,
};
...
pub fn special_random_unsigned_pair_gen_var_4<T: PrimitiveUnsigned, U: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(T, u64)>
where
