...
line_length_exceptions = set((
    ...
    ('./malachite-base/src/num/arithmetic/mod.rs', 1041),
    ('./malachite-base/src/num/arithmetic/mod.rs', 1281),
    ('./malachite-base/src/num/arithmetic/mod.rs', 1282),
    ('./malachite-base/src/num/arithmetic/mod.rs', 1283),
    ('./malachite-base/src/num/arithmetic/mod.rs', 1284),
    ...
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 121),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 122),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 145),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 146),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 147),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 529),
    ('./malachite-nz/src/natural/arithmetic/mod.rs', 531),
