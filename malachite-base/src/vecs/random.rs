...
macro_rules! random_vecs_fixed_length {
    (
        ...
        /// `random_vecs_fixed_length_3_inputs`, `random_vecs_fixed_length_4_inputs`, and so on.
        /// See [`random_vecs_fixed_length`] for more information.
        ///
        /// Generates random length-$n$ [`Vec`]s using elements from $m$ iterators, where
        /// $m \leq n$.
        ///
        ...
        ///
        /// The probability of a particular length-$n$ [`Vec`] being generated is the product of
...
/// Generates random [`Vec`]s using elements from an iterator and with lengths from another
/// iterator, where the [`Vec`]s have no repeated elements, and the elements are in ascending
/// order.
///
