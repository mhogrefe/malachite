...
pub mod gmp_format;
/// The [`ToLatex`](latex::ToLatex) trait, for converting a value to a LaTeX math-mode fragment, the
/// [`LatexWrapper`](latex::LatexWrapper) struct that its `to_latex` method returns, and the
