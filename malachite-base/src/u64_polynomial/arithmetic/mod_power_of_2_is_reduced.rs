...
impl ModPowerOf2IsReduced for U64Polynomial {
    /// Returns whether a [`U64Polynomial`] is reduced modulo $2^k$; in other words, whether every
    /// one of its coefficients has no more than $k$ significant bits.
    ///
