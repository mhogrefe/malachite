...
/// [`U64Polynomial`](super::super::U64Polynomial) whose variable is named by any
...
/// writing a [`U64Polynomial`](super::super::U64Polynomial) whose variable is named by any
/// [`VarScheme`](malachite_base::vars::VarScheme).
pub mod latex;
