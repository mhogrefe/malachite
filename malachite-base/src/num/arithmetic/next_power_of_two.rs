...
impl_next_power_of_two!(u8);
impl_next_power_of_two!(u16);
impl_next_power_of_two!(u32);
impl_next_power_of_two!(u64);
impl_next_power_of_two!(u128);
impl_next_power_of_two!(usize);
