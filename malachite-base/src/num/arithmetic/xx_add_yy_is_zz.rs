...
fn implicit_xx_add_yy_is_zz<DT: JoinHalves + PrimitiveUnsigned + SplitInHalf>(
    x_1: DT::Half,
    x_0: DT::Half,
    y_1: DT::Half,
    y_0: DT::Half,
...
pub fn explicit_xx_add_yy_is_zz<T: PrimitiveUnsigned>(x_1: T, x_0: T, y_1: T, y_0: T) -> (T, T) {
    ...
    ($t:ident, $dt:ident) => {
        impl XXAddYYIsZZ for $t {
            ...
            fn xx_add_yy_is_zz(x_1: $t, x_0: $t, y_1: $t, y_0: $t) -> ($t, $t) {
                implicit_xx_add_yy_is_zz::<$dt>(x_1, x_0, y_1, y_0)
            }
        }
    };
}
...
impl XXAddYYIsZZ for u128 {
    ...
    fn xx_add_yy_is_zz(x_1: u128, x_0: u128, y_1: u128, y_0: u128) -> (u128, u128) {
        explicit_xx_add_yy_is_zz(x_1, x_0, y_1, y_0)
    }
}
