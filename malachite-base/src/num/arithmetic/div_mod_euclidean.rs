...
use crate::num::arithmetic::traits::{DivAssignModEuclidean, DivModEuclidean};

macro_rules! impl_div_mod_euclidean {
    ($t:ident) => {
        impl DivModEuclidean<$t> for $t {
            type DivOutput = $t;
            type ModOutput = $t;
            ...
            /// $$
            ///
            /// For unsigned integers, `div_mod_euclidean` is equivalent to
            ...
            ///
            /// # Examples
            /// See [here](super::div_mod_euclidean#div_mod_euclidean).
            #[inline]
            fn div_mod_euclidean(self, other: $t) -> ($t, $t) {
                (self.div_euclid(other), self.rem_euclid(other))
            }
        }

        impl DivAssignModEuclidean<$t> for $t {
            type ModOutput = $t;
            ...
            ///
            /// # Examples
            /// See [here](super::div_mod_euclidean#div_assign_mod_euclidean).
            #[inline]
            fn div_assign_mod_euclidean(&mut self, other: $t) -> $t {
...
apply_to_primitive_ints!(impl_div_mod_euclidean);
