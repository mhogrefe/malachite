...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_unsigned_polynomial_make_monic_mod);
    register_demo!(runner, demo_unsigned_polynomial_make_monic_mod_assign);
    register_bench!(
        runner,
        benchmark_unsigned_polynomial_make_monic_mod_evaluation_strategy
    );
}

fn demo_unsigned_polynomial_make_monic_mod(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn demo_unsigned_polynomial_make_monic_mod_assign(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_unsigned_polynomial_make_monic_mod_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "UnsignedPolynomial<u64>.make_monic_mod(u64)",
        ...
        &mut [
            ...
            (
                "UnsignedPolynomial<u64>.make_monic_mod_assign(u64)",
                &mut |(mut p, _, m)| {
