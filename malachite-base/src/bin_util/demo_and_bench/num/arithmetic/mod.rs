...
pub(crate) fn register(runner: &mut Runner) {
    ...
    wrapping_mul_sub_mul::register(runner);
    neg::register(runner);
...
mod overflowing_div;
mod overflowing_mul;
mod overflowing_mul_add_mul;
mod overflowing_mul_sub_mul;
mod overflowing_neg;
mod overflowing_pow;
...
mod wrapping_div;
mod wrapping_mul;
mod wrapping_mul_add_mul;
mod wrapping_mul_sub_mul;
mod wrapping_neg;
mod wrapping_pow;
mod wrapping_square;
mod wrapping_sub;
