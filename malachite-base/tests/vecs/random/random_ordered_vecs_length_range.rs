...
fn random_ordered_vecs_length_range_helper<I: Clone + Iterator>(
    a: u64,
    b: u64,
    ...
    I::Item: Clone + Debug + Eq + Hash + Ord,
{
    random_vecs_helper_helper(
        random_ordered_vecs_length_range(EXAMPLE_SEED, a, b, xs_gen),
        expected_values,
...
#[test]
fn test_random_ordered_vecs_length_range() {
    random_ordered_vecs_length_range_helper(
        2,
        4,
