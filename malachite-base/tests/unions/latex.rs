...
fn test_union_to_latex() {
    ...
    assert_eq!(
        Union2::<Vec<u8>, u8>::A(vec![1, 2]).to_latex().to_string(),
...
fn test_union_to_latex_is_injective() {
    ...
    let fragments = [
        Union2::<u8, u8>::A(2).to_latex().to_string(),
        Union2::<u8, u8>::B(2).to_latex().to_string(),
        Union2::<u8, u8>::A(3).to_latex().to_string(),
        Union3::<u8, u8, u8>::C(2).to_latex().to_string(),
    ];
