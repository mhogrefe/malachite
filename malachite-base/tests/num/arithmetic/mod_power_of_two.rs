...
fn test_mod_power_of_two_signed() {
    fn test<U: Copy + Debug + Eq, S: ModPowerOfTwo<Output = U> + PrimitiveSigned>(
        x: S,
        pow: u64,
        out: U,
    ) {
    ...
    test::<_, i16>(2, 1, 0);
    test::<_, i32>(260, 8, 4);
    test::<_, i16>(1_611, 4, 11);
    test::<_, i8>(123, 100, 123);
    test::<_, i64>(1_000_000_000_000, 0, 0);
    test::<_, i64>(1_000_000_000_000, 12, 0);
    test::<_, i64>(1_000_000_000_001, 12, 1);
    test::<_, i64>(999_999_999_999, 12, 4_095);
    test::<_, i64>(1_000_000_000_000, 15, 4_096);
    test::<_, i64>(1_000_000_000_000, 100, 1_000_000_000_000);
    test::<_, i128>(1_000_000_000_000_000_000_000_000, 40, 1_020_608_380_928);
    test::<_, i128>(
        1_000_000_000_000_000_000_000_000,
        64,
        2_003_764_205_206_896_640,
    );
    test::<_, i32>(0x7fff_ffff, 30, 0x3fff_ffff);
    test::<_, i32>(0x7fff_ffff, 31, 0x7fff_ffff);
    test::<_, isize>(0x7fff_ffff, 32, 0x7fff_ffff);
    test::<_, i64>(0x8000_0000, 30, 0);
    test::<_, i64>(0x8000_0000, 31, 0);
    test::<_, i64>(0x8000_0000, 32, 0x8000_0000);
    test::<_, i64>(0x8000_0001, 30, 1);
    test::<_, i64>(0x8000_0001, 31, 1);
    test::<_, i64>(0x8000_0001, 32, 0x8000_0001);
    test::<_, i64>(0xffff_ffff, 31, 0x7fff_ffff);
    test::<_, i64>(0xffff_ffff, 32, 0xffff_ffff);
    test::<_, i64>(0xffff_ffff, 33, 0xffff_ffff);
    test::<_, i64>(0x1_0000_0000, 31, 0);
    test::<_, i64>(0x1_0000_0000, 32, 0);
    test::<_, i64>(0x1_0000_0000, 33, 0x1_0000_0000);
    test::<_, i64>(0x1_0000_0001, 31, 1);
    test::<_, i64>(0x1_0000_0001, 32, 1);
    test::<_, i64>(0x1_0000_0001, 33, 0x1_0000_0001);

    test::<_, i8>(-2, 1, 0);
    test::<_, i16>(-260, 8, 252);
    test::<_, i32>(-1_611, 4, 5);
    test::<_, i128>(-123, 100, 1_267_650_600_228_229_401_496_703_205_253);
    test::<_, i64>(-1_000_000_000_000, 0, 0);
    test::<_, i64>(-1_000_000_000_000, 12, 0);
    test::<_, i64>(-1_000_000_000_001, 12, 4_095);
    test::<_, i64>(-999_999_999_999, 12, 1);
    test::<_, i64>(-1_000_000_000_000, 15, 0x7000);
    test::<_, i128>(
        -1_000_000_000_000,
        100,
        1_267_650_600_228_229_400_496_703_205_376,
    );
    test::<_, i128>(-1_000_000_000_000_000_000_000_000, 40, 78_903_246_848);
    test::<_, i128>(
        -1_000_000_000_000_000_000_000_000,
        64,
        16_442_979_868_502_654_976,
    );
    test::<_, i32>(-0x7fff_ffff, 30, 1);
    test::<_, i32>(-0x7fff_ffff, 31, 1);
    test::<_, i32>(-0x7fff_ffff, 32, 0x8000_0001);
    test::<_, isize>(-0x8000_0000, 30, 0);
    test::<_, isize>(-0x8000_0000, 31, 0);
    test::<_, isize>(-0x8000_0000, 32, 0x8000_0000);
    test::<_, i64>(-0x8000_0001, 30, 0x3fff_ffff);
    test::<_, i64>(-0x8000_0001, 31, 0x7fff_ffff);
    test::<_, i64>(-0x8000_0001, 32, 0x7fff_ffff);
    test::<_, i64>(-0xffff_ffff, 31, 1);
    test::<_, i64>(-0xffff_ffff, 32, 1);
    test::<_, i64>(-0xffff_ffff, 33, 0x1_0000_0001);
    test::<_, i64>(-0x1_0000_0000, 31, 0);
    test::<_, i64>(-0x1_0000_0000, 32, 0);
    test::<_, i64>(-0x1_0000_0000, 33, 0x1_0000_0000);
    test::<_, i64>(-0x1_0000_0001, 31, 0x7fff_ffff);
    test::<_, i64>(-0x1_0000_0001, 32, 0xffff_ffff);
    test::<_, i64>(-0x1_0000_0001, 33, 0xffff_ffff);
}
