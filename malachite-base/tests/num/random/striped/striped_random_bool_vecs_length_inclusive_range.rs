...
fn striped_random_bool_vecs_length_inclusive_range_fail_1() {
    striped_random_bool_vecs_length_inclusive_range(EXAMPLE_SEED, 1, 0, 3, 10);
}

#[test]
#[should_panic]
fn striped_random_bool_vecs_length_inclusive_range_fail_2() {
    striped_random_bool_vecs_length_inclusive_range(EXAMPLE_SEED, 2, 3, 3, 10);
}

#[test]
#[should_panic]
fn striped_random_bool_vecs_length_inclusive_range_fail_3() {
    striped_random_bool_vecs_length_inclusive_range(EXAMPLE_SEED, 4, 1, 2, 1);
}
