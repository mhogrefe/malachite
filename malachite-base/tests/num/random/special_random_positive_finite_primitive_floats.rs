...
fn special_random_positive_finite_primitive_floats_helper<T: CheckedToF64 + PrimitiveFloat>(
    ...
    let xs = special_random_positive_finite_primitive_floats::<T>(
        EXAMPLE_SEED,
...
fn test_special_random_positive_finite_primitive_floats() {
    ...
    let values = &[
        1.25, 1.625, 2.5, 1.0, 1.0, 2.0, 3.5, 1.5, 2.0, 1.0, 3.0, 2.0, 5.796875, 1.75, 1.5, 3.5,
        0.1875, 1.0, 0.25, 1.5, 6.0, 6.0, 6.0, 0.5, 0.125, 1.0, 0.1875, 4.0, 0.875, 7.0, 7.75, 3.5,
        0.125, 2.0, 0.5, 0.875, 7.0, 16.0, 16.0, 3.0, 1.0, 1.0, 8.0, 4.0, 0.375, 1.578125, 0.25,
        0.375, 1.25, 0.0625,
    ];
    let common_values = &[
        (1.0, 166447),
