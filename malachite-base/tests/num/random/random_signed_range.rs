...
macro_rules! random_signed_range_fail {
    ($t:ident, $random_signed_range_fail:ident) => {
        #[test]
        #[should_panic]
        fn $random_signed_range_fail() {
            random_signed_range::<$t>(EXAMPLE_SEED, 2, 2);
        }
    };
}
random_signed_range_fail!(i8, random_signed_range_u8_fail);
random_signed_range_fail!(i16, random_signed_range_u16_fail);
random_signed_range_fail!(i32, random_signed_range_u32_fail);
random_signed_range_fail!(i64, random_signed_range_u64_fail);
random_signed_range_fail!(i128, random_signed_range_u128_fail);
random_signed_range_fail!(isize, random_signed_range_usize_fail);
