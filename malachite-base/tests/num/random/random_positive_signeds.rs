...
fn test_random_positive_signeds() {
    ...
    let pop_median = NiceFloat(64.0);
    let sample_median = (64, None);
    let pop_moment_stats = MomentStats {
        mean: NiceFloat(64.0),
        stdev: NiceFloat(36.66060555964672),
        skewness: NiceFloat(0.0),
        kurtosis: NiceFloat(-1.2001488095238095),
    };
    let sample_moment_stats = MomentStats {
        mean: NiceFloat(63.98261700000094),
        stdev: NiceFloat(36.64980463849096),
        skewness: NiceFloat(-0.00015527063049739826),
        kurtosis: NiceFloat(-1.1989569567038294),
    };
    ...
    let pop_median = NiceFloat(16384.0);
    let sample_median = (16390, None);
    let pop_moment_stats = MomentStats {
        mean: NiceFloat(16384.0),
        stdev: NiceFloat(9459.018130863265),
        skewness: NiceFloat(0.0),
        kurtosis: NiceFloat(-1.2000000022353106),
    };
    let sample_moment_stats = MomentStats {
        mean: NiceFloat(16393.15641900105),
        stdev: NiceFloat(9458.086840822818),
        skewness: NiceFloat(-0.001138631787985122),
        kurtosis: NiceFloat(-1.2003871130729624),
    };
