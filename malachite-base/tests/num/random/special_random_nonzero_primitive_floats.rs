...
fn test_special_random_nonzero_primitive_floats() {
    ...
    let sample_median = (0.004760742, Some(0.0048828125));
    special_random_nonzero_primitive_floats_helper::<f32>(
        1,
        1,
        2,
    ...
    let sample_median = (0.00457763671875, Some(0.004638671875));
    special_random_nonzero_primitive_floats_helper::<f64>(
        1,
        1,
        2,
    ...
    let sample_median = (2.1330192451399323e-19, Some(2.168404344971009e-19));
    special_random_nonzero_primitive_floats_helper::<f64>(
        10,
        1,
        10,
