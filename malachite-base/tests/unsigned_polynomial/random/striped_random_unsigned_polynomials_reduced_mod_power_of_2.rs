...
fn striped_random_unsigned_polynomials_reduced_mod_power_of_2_helper(
    pow: u64,
...
#[test]
fn test_striped_random_unsigned_polynomials_reduced_mod_power_of_2() {
    // modulo 256, mean stripe = 8
    striped_random_unsigned_polynomials_reduced_mod_power_of_2_helper(
        8,
        8,
        1,
        2,
...
#[test]
#[should_panic]
fn striped_random_unsigned_polynomials_reduced_mod_power_of_2_fail_1() {
    let _ = striped_random_unsigned_polynomials_reduced_mod_power_of_2::<u64>(
        EXAMPLE_SEED,
        0,
        8,
        1,
...
#[test]
#[should_panic]
fn striped_random_unsigned_polynomials_reduced_mod_power_of_2_fail_2() {
    let _ = striped_random_unsigned_polynomials_reduced_mod_power_of_2::<u64>(
        EXAMPLE_SEED,
        65,
        8,
