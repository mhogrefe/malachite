...
fn random_unsigned_polynomials_reduced_mod_power_of_2_helper(
    pow: u64,
    ...
    assert_eq!(
        random_unsigned_polynomials_reduced_mod_power_of_2::<u64>(
            EXAMPLE_SEED,
            pow,
...
#[test]
fn test_random_unsigned_polynomials_reduced_mod_power_of_2() {
    // modulo 2, the polynomials over GF(2)
    random_unsigned_polynomials_reduced_mod_power_of_2_helper(
        1,
        2,
        1,
        &[
    ...
    random_unsigned_polynomials_reduced_mod_power_of_2_helper(
        ...
        1,
        &[
            "3*x^5+8*x^4+11*x^2+5*x+5",
            "7",
            "9*x^7+8*x^6+6*x^5+14*x^4+11*x^3+12*x^2+8*x+8",
            "11",
            "7*x^13+2*x^12+11*x^11+x^10+13*x^9+9*x^8+14*x^7+11*x^6+2*x^5+6*x^4+13*x^3+15*x^2+12*\
            x+11",
            "0",
            "13*x^4+6*x^3+2*x^2+10",
            "9*x^3+14*x^2+10*x+10",
            "3",
            "0",
            "5*x^5+10*x^4+13*x^3+10*x^2+x+14",
            "2*x+5",
            "0",
            "0",
            "13",
    ...
    // modulo 2^64, where nothing is excluded
    random_unsigned_polynomials_reduced_mod_power_of_2_helper(
        64,
        2,
        1,
...
#[test]
#[should_panic]
fn random_unsigned_polynomials_reduced_mod_power_of_2_fail_1() {
    let _ = random_unsigned_polynomials_reduced_mod_power_of_2::<u64>(EXAMPLE_SEED, 0, 2, 1);
}

#[test]
#[should_panic]
fn random_unsigned_polynomials_reduced_mod_power_of_2_fail_2() {
    let _ = random_unsigned_polynomials_reduced_mod_power_of_2::<u64>(EXAMPLE_SEED, 65, 2, 1);
}
