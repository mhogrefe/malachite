...
fn random_hash_maps_unique_value_count_range_helper<
...
#[test]
fn test_random_hash_maps_unique_value_count_range() {
    random_hash_maps_unique_value_count_range_helper(
        1,
        3,
    ...
    random_hash_maps_unique_value_count_range_helper(
        ...
        &[
            hashmap! {79 => 4, 80 => 2},
            hashmap! {10 => 2, 51 => 0, 59 => 4, 253 => 0},
            hashmap! {53 => 9, 85 => 7, 160 => 7, 214 => 2, 219 => 2, 245 => 2, 246 => 9},
            hashmap! {139 => 7, 233 => 4},
            hashmap! {33 => 0, 120 => 8, 158 => 0},
            hashmap! {157 => 1, 161 => 1, 202 => 2, 236 => 5},
            hashmap! {19 => 9, 72 => 3, 80 => 3, 153 => 3, 155 => 9, 194 => 3, 236 => 9},
            hashmap! {25 => 6, 68 => 6, 74 => 8, 97 => 9, 119 => 6, 252 => 9},
            hashmap! {
                13 => 6, 32 => 6, 33 => 3, 55 => 6, 69 => 6, 91 => 4, 216 => 4, 224 => 6, 241 => 4
            },
            hashmap! {8 => 0, 134 => 8, 170 => 6},
            hashmap! {127 => 9, 188 => 8, 196 => 4},
            hashmap! {30 => 6, 86 => 6, 108 => 5, 131 => 6, 155 => 6, 241 => 6},
            hashmap! {15 => 1, 16 => 1, 46 => 6, 152 => 9, 221 => 1},
            hashmap! {99 => 1, 102 => 1, 163 => 4, 196 => 0, 206 => 4},
            hashmap! {73 => 5, 153 => 7},
            hashmap! {122 => 7, 199 => 3},
            hashmap! {
...
#[test]
#[should_panic]
fn random_hash_maps_unique_value_count_range_fail_1() {
    random_hash_maps_unique_value_count_range(
        EXAMPLE_SEED,
        2,
        2,
...
#[test]
#[should_panic]
fn random_hash_maps_unique_value_count_range_fail_2() {
    random_hash_maps_unique_value_count_range(
        EXAMPLE_SEED,
        0,
        2,
...
#[test]
#[should_panic]
fn random_hash_maps_unique_value_count_range_fail_3() {
    random_hash_maps_unique_value_count_range(
        EXAMPLE_SEED,
        1,
        3,
