...
fn random_b_tree_maps_size_range_helper<
...
>(
    ...
    let xs = random_b_tree_maps_size_range(EXAMPLE_SEED, a, b, keys_gen, values_gen);
...
#[test]
fn test_random_b_tree_maps_size_range() {
    random_b_tree_maps_size_range_helper(
        2,
        4,
...
#[test]
#[should_panic]
fn random_b_tree_maps_size_range_fail() {
    random_b_tree_maps_size_range(
        EXAMPLE_SEED,
        2,
        2,
