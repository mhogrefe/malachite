...
fn exhaustive_b_tree_maps_fixed_unique_value_count_small_helper<
    I: Clone + Iterator,
    J: Clone + Iterator,
>(
    ...
    J::Item: Clone + Debug + Eq,
{
    exhaustive_b_tree_maps_small_helper_helper(
        exhaustive_b_tree_maps_fixed_unique_value_count(unique_value_count, keys, values),
        out_len,
        out,
    );
}
...
#[test]
fn test_exhaustive_b_tree_maps_fixed_unique_value_count() {
    exhaustive_b_tree_maps_fixed_unique_value_count_small_helper(
        0,
        'a'..='b',
        0..3u8,
        1,
