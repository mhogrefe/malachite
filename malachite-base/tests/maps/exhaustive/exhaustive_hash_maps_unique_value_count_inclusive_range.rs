...
fn exhaustive_hash_maps_unique_value_count_inclusive_range_small_helper<
    I: Clone + Iterator,
    J: Clone + Iterator,
>(
    a: u64,
    ...
    J::Item: Clone + Debug + Eq,
{
    exhaustive_hash_maps_small_helper_helper(
        exhaustive_hash_maps_unique_value_count_inclusive_range(a, b, keys, values),
        out_len,
        out,
    );
}
...
#[test]
fn test_exhaustive_hash_maps_unique_value_count_inclusive_range() {
    exhaustive_hash_maps_unique_value_count_inclusive_range_small_helper(
        1,
        1,
        'a'..='b',
        0..3u8,
