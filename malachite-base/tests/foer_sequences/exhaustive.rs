...
#[test]
fn test_exhaustive_foer_sequences() {
    assert_eq!(
        exhaustive_foer_sequences(nevers())
            .collect_vec()
            .to_debug_string(),
        "[[]]"
    );
    assert_eq!(
        exhaustive_foer_sequences(exhaustive_units().map(Unit))
            .take(20)
            .collect_vec()
            .to_debug_string(),
        "[[], [[()]], [()], [(), ()], [(), (), (), ()], [(), (), ()], [(), (), (), (), ()], \
    ...
    assert_eq!(
        exhaustive_foer_sequences(exhaustive_bools())
            .take(20)
            .collect_vec()
            .to_debug_string(),
