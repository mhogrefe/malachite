...
fn random_u64_polynomials_reduced_mod_helper(
    m: u64,
    ...
    assert_eq!(
        random_u64_polynomials_reduced_mod(
            EXAMPLE_SEED,
            m,
...
fn test_random_u64_polynomials_reduced_mod() {
    // modulo 3
    random_u64_polynomials_reduced_mod_helper(
        3,
        2,
        1,
        &[
...
#[test]
#[should_panic]
fn random_u64_polynomials_reduced_mod_fail_1() {
    let _ = random_u64_polynomials_reduced_mod(EXAMPLE_SEED, 0, 2, 1);
}

#[test]
#[should_panic]
fn random_u64_polynomials_reduced_mod_fail_2() {
    let _ = random_u64_polynomials_reduced_mod(EXAMPLE_SEED, 1, 2, 1);
}
