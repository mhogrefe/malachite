...
fn random_u64_polynomials_reduced_mod_power_of_2_helper(
    pow: u64,
    ...
    assert_eq!(
        random_u64_polynomials_reduced_mod_power_of_2(
            EXAMPLE_SEED,
            pow,
...
fn test_random_u64_polynomials_reduced_mod_power_of_2() {
    ...
    random_u64_polynomials_reduced_mod_power_of_2_helper(
        1,
        2,
        1,
        &[
...
#[test]
#[should_panic]
fn random_u64_polynomials_reduced_mod_power_of_2_fail_1() {
    let _ = random_u64_polynomials_reduced_mod_power_of_2(EXAMPLE_SEED, 0, 2, 1);
}

#[test]
#[should_panic]
fn random_u64_polynomials_reduced_mod_power_of_2_fail_2() {
    let _ = random_u64_polynomials_reduced_mod_power_of_2(EXAMPLE_SEED, 65, 2, 1);
}
