...
fn striped_random_u64_polynomials_reduced_mod_helper(
    m: u64,
    ...
    assert_eq!(
        striped_random_u64_polynomials_reduced_mod(
            EXAMPLE_SEED,
            m,
...
#[test]
fn test_striped_random_u64_polynomials_reduced_mod() {
    // modulo 1000, mean stripe = 8
    striped_random_u64_polynomials_reduced_mod_helper(
        1000,
        8,
        1,
        2,
...
#[test]
#[should_panic]
fn striped_random_u64_polynomials_reduced_mod_fail_1() {
    let _ = striped_random_u64_polynomials_reduced_mod(EXAMPLE_SEED, 1, 8, 1, 2, 1);
}

#[test]
#[should_panic]
fn striped_random_u64_polynomials_reduced_mod_fail_2() {
    let _ = striped_random_u64_polynomials_reduced_mod(EXAMPLE_SEED, 3, 1, 2, 2, 1);
}
