...
use malachite_base::tuples::exhaustive::{
    exhaustive_ordered_unique_pairs, exhaustive_ordered_unique_quadruples,
    exhaustive_ordered_unique_quintuples, exhaustive_ordered_unique_triples, exhaustive_units,
};
use std::fmt::Debug;
