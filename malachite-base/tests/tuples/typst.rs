...
fn test_tuple_to_typst() {
    ...
    assert_eq!((1u8, 2u8, 3u8, 4u8).to_typst_string(), "(1, 2, 3, 4)");
    assert_eq!(
        (1u8, 2u8, 3u8, 4u8, 5u8).to_typst_string(),
        "(1, 2, 3, 4, 5)"
    );
    assert_eq!(
        (1u8, 2u8, 3u8, 4u8, 5u8, 6u8).to_typst_string(),
        "(1, 2, 3, 4, 5, 6)"
    );
    assert_eq!(
        (1u8, 2u8, 3u8, 4u8, 5u8, 6u8, 7u8).to_typst_string(),
        "(1, 2, 3, 4, 5, 6, 7)"
    );
    assert_eq!(
...
fn test_tuple_to_typst_element_types() {
    ...
    assert_eq!(
        (None::<u8>, Some(1u8), ()).to_typst_string(),
        "(bot, [1], ())"
    );
    // tuples nest, and hold the other collections
    assert_eq!(((1u8, 2u8), 3u8).to_typst_string(), "((1, 2), 3)");
    assert_eq!((vec![1u8, 2], (3u8,)).to_typst_string(), "([1, 2], (3))");
}
...
fn test_tuple_to_typst_is_injective() {
    ...
    let fragments = [
        (1u8, 2u8).to_typst_string(),
        (1u8, 2u8, 3u8).to_typst_string(),
        ((1u8, 2u8), 3u8).to_typst_string(),
        (1u8, (2u8, 3u8)).to_typst_string(),
        (1u8,).to_typst_string(),
...
fn test_typst_tuple_macro() {
    ...
    assert_eq!(typst_tuple!(1u8), (1u8,).to_typst_string());
    assert_eq!(typst_tuple!(1u8, 2u8), (1u8, 2u8).to_typst_string());
    assert_eq!(
