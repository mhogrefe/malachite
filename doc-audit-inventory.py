...
# Generates the documentation-audit checklists (see DOC-CONVENTIONS.md): one file per crate under
...
def main():
    ...
    for crate in CRATES:
        ...
        with open(out_path, "w", encoding="utf-8") as out:
            ...
            out.write(
                "Generated by `doc-audit-inventory.py`; see audit/CAMPAIGN-LOG.md for the "
                "process.\n"
            )
