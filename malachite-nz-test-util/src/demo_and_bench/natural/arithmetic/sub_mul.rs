...
use malachite_nz_test_util::generators::natural_triple_gen_var_7;
...
fn demo_limbs_sub_mul_limb_same_length_in_place_left(gm: GenMode, config: GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!(
            "xs := {:?}; limbs_sub_mul_limb_same_length_in_place_left(&mut xs, {:?}, {}) = {}; \
             xs = {:?}",
            xs_old, ys, z, borrow, xs,
        );
    }
}
...
fn demo_limbs_sub_mul_limb_greater_in_place_left(gm: GenMode, config: GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!(
            "xs := {:?}; limbs_sub_mul_limb_greater_in_place_left(&mut xs, {:?}, {}) = {}; \
             xs = {:?}",
            xs_old, ys, z, borrow, xs,
        );
    }
...
fn demo_limbs_sub_mul_limb_same_length_in_place_right(
        ...
        .take(limit)
    {
        ...
        println!(
            "ys := {:?}; limbs_sub_mul_limb_same_length_in_place_right({:?}, &mut ys, {}); \
            ys = {:?}",
            ys_old, xs, z, ys,
        );
    }
...
fn demo_limbs_sub_mul_limb_greater_in_place_right(gm: GenMode, config: GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!(
            "ys := {:?}; limbs_sub_mul_limb_greater_in_place_right({:?}, &mut ys, {}); ys = {:?}",
            ys_old, xs, z, ys,
        );
    }
}
...
fn demo_limbs_sub_mul(gm: GenMode, config: GenConfig, limit: usize) {
    for (xs, ys, zs) in unsigned_vec_triple_gen_var_59()
        .get(gm, &config)
        .take(limit)
    {
        println!(
...
fn demo_limbs_sub_mul_in_place_left(gm: GenMode, config: GenConfig, limit: usize) {
    for (mut xs, ys, zs) in unsigned_vec_triple_gen_var_59()
        .get(gm, &config)
        .take(limit)
    {
        let xs_old = xs.clone();
        ...
        println!(
            "xs := {:?}; limbs_sub_mul_in_place_left(&mut xs, {:?}, {:?}); xs = {:?}",
            xs_old, ys, zs, xs,
        );
    }
}
