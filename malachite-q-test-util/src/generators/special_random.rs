...
use malachite_nz::natural::random::{striped_random_naturals, striped_random_positive_naturals};
...
pub fn special_random_string_gen_var_11(config: &GenConfig) -> It<String> {
    Box::new(
        striped_random_rationals(
            EXAMPLE_SEED,
            config.get_or("mean_stripe_n", 32),
...
pub fn special_random_string_gen_var_12(config: &GenConfig) -> It<String> {
    Box::new(
        striped_random_rationals(
            EXAMPLE_SEED,
            config.get_or("mean_stripe_n", 32),
