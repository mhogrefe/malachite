...
impl Float {
    /// Returns an approximation to $1/\pi$, with the given precision and rounded using the given
    ...
    /// Returns an approximation to $1/\pi$, with the given precision and rounded to the nearest
