...
impl Float {
    /// Returns an approximation to $\pi/4$, with the given precision and rounded using the given
    ...
    /// Returns an approximation to $\pi/4$, with the given precision and rounded to the nearest
