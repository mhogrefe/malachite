...
impl Float {
    ...
    /// assert_eq!(sqrt_5.to_string(), "2.236067977499789696409173668728");
    /// assert_eq!(o, Less);
    ///
    /// let (sqrt_5, o) = Float::sqrt_5_prec_round(100, Ceiling);
    /// assert_eq!(sqrt_5.to_string(), "2.236067977499789696409173668732");
    /// assert_eq!(o, Greater);
    /// ```
    #[inline]
    ...
    /// assert_eq!(sqrt_5.to_string(), "2.234");
    /// assert_eq!(o, Less);
    ///
