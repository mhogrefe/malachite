...
//   need finalizing); `Display` is a separate `get_str`-based implementation (to_sci.rs), not built
//   on this. Note the `'` flag divergence below for any future full-string FFI oracle.
