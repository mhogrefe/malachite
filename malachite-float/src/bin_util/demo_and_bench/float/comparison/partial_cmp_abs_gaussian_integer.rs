...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_float_partial_cmp_abs_gaussian_integer);
    register_demo!(runner, demo_gaussian_integer_partial_cmp_abs_float);
    register_bench!(
        runner,
        benchmark_float_partial_cmp_abs_gaussian_integer_algorithms
    );
}

fn demo_float_partial_cmp_abs_gaussian_integer(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn demo_gaussian_integer_partial_cmp_abs_float(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y) in float_gaussian_integer_pair_gen()
        .get(gm, config)
        .take(limit)
    {
...
fn benchmark_float_partial_cmp_abs_gaussian_integer_algorithms(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "Float.partial_cmp_abs(&GaussianInteger)",
