...
use malachite_float::test_util::generators::{
    ...
    float_float_float_rounding_mode_quadruple_gen_var_1_rm,
...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_float_add_mul_prec_round);
    register_demo!(runner, demo_float_add_mul_prec_round_debug);
    register_demo!(runner, demo_float_add_mul_prec_round_extreme);
    register_demo!(runner, demo_float_add_mul_prec_round_extreme_debug);
    register_demo!(runner, demo_float_add_mul_prec_round_ref_ref_ref);
    register_demo!(runner, demo_float_add_mul_prec_round_ref_ref_ref_debug);

    register_demo!(runner, demo_float_add_mul);
    register_demo!(runner, demo_float_add_mul_debug);
    register_demo!(runner, demo_float_add_mul_val_val_ref);
    register_demo!(runner, demo_float_add_mul_val_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_val_ref_val);
    register_demo!(runner, demo_float_add_mul_val_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_val_ref_ref);
    register_demo!(runner, demo_float_add_mul_val_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_ref_val_val);
    register_demo!(runner, demo_float_add_mul_ref_val_val_debug);
    register_demo!(runner, demo_float_add_mul_ref_val_ref);
    register_demo!(runner, demo_float_add_mul_ref_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_ref_ref_val);
    register_demo!(runner, demo_float_add_mul_ref_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_ref_ref_ref);
    register_demo!(runner, demo_float_add_mul_ref_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_assign);
    register_demo!(runner, demo_float_add_mul_assign_debug);
    register_demo!(runner, demo_float_add_mul_assign_val_ref);
    register_demo!(runner, demo_float_add_mul_assign_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_assign_ref_val);
    register_demo!(runner, demo_float_add_mul_assign_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_assign_ref_ref);
    register_demo!(runner, demo_float_add_mul_assign_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec);
    register_demo!(runner, demo_float_add_mul_prec_debug);
    register_demo!(runner, demo_float_add_mul_prec_val_val_ref);
    register_demo!(runner, demo_float_add_mul_prec_val_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec_val_ref_val);
    register_demo!(runner, demo_float_add_mul_prec_val_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_prec_val_ref_ref);
    register_demo!(runner, demo_float_add_mul_prec_val_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec_ref_val_val);
    register_demo!(runner, demo_float_add_mul_prec_ref_val_val_debug);
    register_demo!(runner, demo_float_add_mul_prec_ref_val_ref);
    register_demo!(runner, demo_float_add_mul_prec_ref_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec_ref_ref_val);
    register_demo!(runner, demo_float_add_mul_prec_ref_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_prec_ref_ref_ref);
    register_demo!(runner, demo_float_add_mul_prec_ref_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec_assign);
    register_demo!(runner, demo_float_add_mul_prec_assign_debug);
    register_demo!(runner, demo_float_add_mul_prec_assign_val_ref);
    register_demo!(runner, demo_float_add_mul_prec_assign_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_prec_assign_ref_val);
    register_demo!(runner, demo_float_add_mul_prec_assign_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_prec_assign_ref_ref);
    register_demo!(runner, demo_float_add_mul_prec_assign_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_round);
    register_demo!(runner, demo_float_add_mul_round_debug);
    register_demo!(runner, demo_float_add_mul_round_val_val_ref);
    register_demo!(runner, demo_float_add_mul_round_val_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_round_val_ref_val);
    register_demo!(runner, demo_float_add_mul_round_val_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_round_val_ref_ref);
    register_demo!(runner, demo_float_add_mul_round_val_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_round_ref_val_val);
    register_demo!(runner, demo_float_add_mul_round_ref_val_val_debug);
    register_demo!(runner, demo_float_add_mul_round_ref_val_ref);
    register_demo!(runner, demo_float_add_mul_round_ref_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_round_ref_ref_val);
    register_demo!(runner, demo_float_add_mul_round_ref_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_round_ref_ref_ref);
    register_demo!(runner, demo_float_add_mul_round_ref_ref_ref_debug);
    register_demo!(runner, demo_float_add_mul_round_assign);
    register_demo!(runner, demo_float_add_mul_round_assign_debug);
    register_demo!(runner, demo_float_add_mul_round_assign_val_ref);
    register_demo!(runner, demo_float_add_mul_round_assign_val_ref_debug);
    register_demo!(runner, demo_float_add_mul_round_assign_ref_val);
    register_demo!(runner, demo_float_add_mul_round_assign_ref_val_debug);
    register_demo!(runner, demo_float_add_mul_round_assign_ref_ref);
    register_demo!(runner, demo_float_add_mul_round_assign_ref_ref_debug);

    register_bench!(
        runner,
        benchmark_float_add_mul_prec_round_evaluation_strategy
    );
    register_bench!(
        runner,
        benchmark_float_add_mul_prec_round_library_comparison
    );
    register_bench!(runner, benchmark_float_add_mul_prec_round_algorithms);
    register_bench!(runner, benchmark_float_add_mul_evaluation_strategy);
    register_bench!(runner, benchmark_float_add_mul_library_comparison);
    register_bench!(runner, benchmark_float_add_mul_prec_evaluation_strategy);
...
fn demo_float_add_mul_prec_round(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let x_old = x.clone();
        ...
        println!(
            ...
            prec,
            rm,
            x.add_mul_prec_round(y, z, prec, rm)
        );
    }
}

fn demo_float_add_mul_prec_round_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        let y_old = y.clone();
        let z_old = z.clone();
        let (sum, o) = x.add_mul_prec_round(y, z, prec, rm);
        println!(
            "({:#x}).add_mul_prec_round({:#x}, {:#x}, {}, {}) = ({:#x}, {:?})",
...
fn demo_float_add_mul_prec_round_extreme(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_2()
        .get(gm, config)
        .take(limit)
    {
        let x_old = x.clone();
...
fn demo_float_add_mul_prec_round_extreme_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_2()
        .get(gm, config)
        .take(limit)
    {
...
fn demo_float_add_mul_prec_round_ref_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_prec_round_ref_ref_ref(&{}, &{}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            rm,
            x.add_mul_prec_round_ref_ref_ref(&y, &z, prec, rm)
        );
    }
}

fn demo_float_add_mul_prec_round_ref_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec, rm) in float_float_float_unsigned_rounding_mode_quintuple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        println!(
            "(&{:#x}).add_mul_prec_round_ref_ref_ref(&{:#x}, &{:#x}, {}, {}) = ({:#x}, {:?})",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn benchmark_float_add_mul_prec_round_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "Float.add_mul_prec_round(Float, Float, u64, RoundingMode)",
        BenchmarkType::EvaluationStrategy,
        float_float_float_unsigned_rounding_mode_quintuple_gen_var_1().get(gm, config),
        gm.name(),
        limit,
        file_name,
        &quintuple_1_2_3_4_float_float_float_primitive_int_max_complexity_bucketer(
        ...
        &mut [
            (
                "Float.add_mul_prec_round(Float, Float, u64, RoundingMode)",
                &mut |(x, y, z, prec, rm)| no_out!(x.add_mul_prec_round(y, z, prec, rm)),
            ),
            (
                "(&Float).add_mul_prec_round_ref_ref_ref(&Float, &Float, u64, RoundingMode)",
                &mut |(x, y, z, prec, rm)| {
                    no_out!(x.add_mul_prec_round_ref_ref_ref(&y, &z, prec, rm));
                },
            ),
        ],
    );
...
fn benchmark_float_add_mul_prec_round_library_comparison(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        ...
        float_float_float_unsigned_rounding_mode_quintuple_gen_var_1_rm().get(gm, config),
        gm.name(),
        limit,
        file_name,
        &pair_2_quintuple_1_2_3_4_float_float_float_primitive_int_max_complexity_bucketer(
        ...
        &mut [
            ...
            ("rug", &mut |((x, y, z, prec, rm), _)| {
                no_out!(rug_add_mul_prec_round(&x, &y, &z, prec, rm));
            }),
        ],
    );
}

fn benchmark_float_add_mul_prec_round_algorithms(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        ...
        &mut [
            ("default", &mut |(x, y, z, prec, rm)| {
                no_out!(x.add_mul_prec_round(y, z, prec, rm));
            }),
            ("naive", &mut |(x, y, z, prec, rm)| {
                no_out!(add_mul_prec_round_naive(&x, &y, &z, prec, rm));
            }),
        ],
    );
}

fn demo_float_add_mul(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn demo_float_add_mul_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_val_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "({}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_val_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_val_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "({}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_val_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_val_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "({}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_val_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_ref_val_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "(&{}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_ref_val_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_ref_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "(&{}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_ref_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_ref_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "(&{}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_ref_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_ref_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        println!(
            "(&{}).add_mul({}, {}) = {:?}",
            x,
...
fn demo_float_add_mul_ref_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
...
fn demo_float_add_mul_assign(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_assign(y.clone(), z.clone());
        println!("x := {x_old}; x.add_mul_assign({y}, {z}); x = {x}");
    }
}

fn demo_float_add_mul_assign_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = ComparableFloat(x.clone());
        x.add_mul_assign(y.clone(), z.clone());
        println!(
            "x := {:#x}; x.add_mul_assign({:#x}, {:#x}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            ComparableFloat(x)
...
fn demo_float_add_mul_assign_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_assign(y.clone(), &z);
        println!("x := {x_old}; x.add_mul_assign({y}, {z}); x = {x}");
    }
}

fn demo_float_add_mul_assign_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = ComparableFloat(x.clone());
        x.add_mul_assign(y.clone(), &z);
...
fn demo_float_add_mul_assign_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_assign(&y, z.clone());
        println!("x := {x_old}; x.add_mul_assign({y}, {z}); x = {x}");
    }
}

fn demo_float_add_mul_assign_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = ComparableFloat(x.clone());
        x.add_mul_assign(&y, z.clone());
...
fn demo_float_add_mul_assign_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = x.clone();
...
fn demo_float_add_mul_assign_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z) in float_triple_gen().get(gm, config).take(limit) {
        let mut x = x;
        let x_old = ComparableFloat(x.clone());
        x.add_mul_assign(&y, &z);
...
fn demo_float_add_mul_prec(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        println!(
            ...
            z,
            prec,
            x.clone().add_mul_prec(y.clone(), z.clone(), prec)
        );
    }
}

fn demo_float_add_mul_prec_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_prec(y.clone(), z.clone(), prec);
        println!(
            "({:#x}).add_mul_prec({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
...
fn demo_float_add_mul_prec_val_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_prec_val_val_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.clone().add_mul_prec_val_val_ref(y.clone(), &z, prec)
        );
    }
}

fn demo_float_add_mul_prec_val_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_prec_val_val_ref(y.clone(), &z, prec);
        println!(
            "({:#x}).add_mul_prec_val_val_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_val_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_prec_val_ref_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.clone().add_mul_prec_val_ref_val(&y, z.clone(), prec)
        );
    }
}

fn demo_float_add_mul_prec_val_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_prec_val_ref_val(&y, z.clone(), prec);
        println!(
            "({:#x}).add_mul_prec_val_ref_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_val_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_prec_val_ref_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.clone().add_mul_prec_val_ref_ref(&y, &z, prec)
        );
    }
}

fn demo_float_add_mul_prec_val_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_prec_val_ref_ref(&y, &z, prec);
        println!(
            "({:#x}).add_mul_prec_val_ref_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_ref_val_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_prec_ref_val_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.add_mul_prec_ref_val_val(y.clone(), z.clone(), prec)
        );
    }
}

fn demo_float_add_mul_prec_ref_val_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_prec_ref_val_val(y.clone(), z.clone(), prec);
        println!(
            "(&{:#x}).add_mul_prec_ref_val_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_ref_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_prec_ref_val_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.add_mul_prec_ref_val_ref(y.clone(), &z, prec)
        );
    }
}

fn demo_float_add_mul_prec_ref_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_prec_ref_val_ref(y.clone(), &z, prec);
        println!(
            "(&{:#x}).add_mul_prec_ref_val_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_ref_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_prec_ref_ref_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.add_mul_prec_ref_ref_val(&y, z.clone(), prec)
        );
    }
}

fn demo_float_add_mul_prec_ref_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_prec_ref_ref_val(&y, z.clone(), prec);
        println!(
            "(&{:#x}).add_mul_prec_ref_ref_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_ref_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_prec_ref_ref_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            prec,
            x.add_mul_prec_ref_ref_ref(&y, &z, prec)
        );
    }
}

fn demo_float_add_mul_prec_ref_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_prec_ref_ref_ref(&y, &z, prec);
        println!(
            "(&{:#x}).add_mul_prec_ref_ref_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_assign(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_prec_assign(y.clone(), z.clone(), prec);
        println!("x := {x_old}; x.add_mul_prec_assign({y}, {z}, {prec}); x = {x}");
    }
}

fn demo_float_add_mul_prec_assign_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_prec_assign(y.clone(), z.clone(), prec);
        println!(
            "x := {:#x}; x.add_mul_prec_assign({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_assign_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_prec_assign_val_ref(y.clone(), &z, prec);
        println!("x := {x_old}; x.add_mul_prec_assign_val_ref({y}, {z}, {prec}); x = {x}");
    }
}

fn demo_float_add_mul_prec_assign_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_prec_assign_val_ref(y.clone(), &z, prec);
        println!(
            "x := {:#x}; x.add_mul_prec_assign_val_ref({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_assign_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_prec_assign_ref_val(&y, z.clone(), prec);
        println!("x := {x_old}; x.add_mul_prec_assign_ref_val({y}, {z}, {prec}); x = {x}");
    }
}

fn demo_float_add_mul_prec_assign_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_prec_assign_ref_val(&y, z.clone(), prec);
        println!(
            "x := {:#x}; x.add_mul_prec_assign_ref_val({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_prec_assign_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_prec_assign_ref_ref(&y, &z, prec);
        println!("x := {x_old}; x.add_mul_prec_assign_ref_ref({y}, {z}, {prec}); x = {x}");
    }
}

fn demo_float_add_mul_prec_assign_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, prec) in float_float_float_unsigned_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_prec_assign_ref_ref(&y, &z, prec);
        println!(
            "x := {:#x}; x.add_mul_prec_assign_ref_ref({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            prec,
...
fn demo_float_add_mul_round(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            ...
            z,
            rm,
            x.clone().add_mul_round(y.clone(), z.clone(), rm)
        );
    }
}

fn demo_float_add_mul_round_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_round(y.clone(), z.clone(), rm);
        println!(
            "({:#x}).add_mul_round({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
...
fn demo_float_add_mul_round_val_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_round_val_val_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.clone().add_mul_round_val_val_ref(y.clone(), &z, rm)
        );
    }
}

fn demo_float_add_mul_round_val_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_round_val_val_ref(y.clone(), &z, rm);
        println!(
            "({:#x}).add_mul_round_val_val_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_val_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_round_val_ref_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.clone().add_mul_round_val_ref_val(&y, z.clone(), rm)
        );
    }
}

fn demo_float_add_mul_round_val_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_round_val_ref_val(&y, z.clone(), rm);
        println!(
            "({:#x}).add_mul_round_val_ref_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_val_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "({}).add_mul_round_val_ref_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.clone().add_mul_round_val_ref_ref(&y, &z, rm)
        );
    }
}

fn demo_float_add_mul_round_val_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.clone().add_mul_round_val_ref_ref(&y, &z, rm);
        println!(
            "({:#x}).add_mul_round_val_ref_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_ref_val_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_round_ref_val_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.add_mul_round_ref_val_val(y.clone(), z.clone(), rm)
        );
    }
}

fn demo_float_add_mul_round_ref_val_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_round_ref_val_val(y.clone(), z.clone(), rm);
        println!(
            "(&{:#x}).add_mul_round_ref_val_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_ref_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_round_ref_val_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.add_mul_round_ref_val_ref(y.clone(), &z, rm)
        );
    }
}

fn demo_float_add_mul_round_ref_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_round_ref_val_ref(y.clone(), &z, rm);
        println!(
            "(&{:#x}).add_mul_round_ref_val_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_ref_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_round_ref_ref_val({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.add_mul_round_ref_ref_val(&y, z.clone(), rm)
        );
    }
}

fn demo_float_add_mul_round_ref_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_round_ref_ref_val(&y, z.clone(), rm);
        println!(
            "(&{:#x}).add_mul_round_ref_ref_val({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_ref_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        println!(
            "(&{}).add_mul_round_ref_ref_ref({}, {}, {}) = {:?}",
            x,
            y,
            z,
            rm,
            x.add_mul_round_ref_ref_ref(&y, &z, rm)
        );
    }
}

fn demo_float_add_mul_round_ref_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let res = x.add_mul_round_ref_ref_ref(&y, &z, rm);
        println!(
            "(&{:#x}).add_mul_round_ref_ref_ref({:#x}, {:#x}, {}) = {:?}",
            ComparableFloat(x),
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_assign(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_round_assign(y.clone(), z.clone(), rm);
        println!("x := {x_old}; x.add_mul_round_assign({y}, {z}, {rm}); x = {x}");
    }
}

fn demo_float_add_mul_round_assign_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_round_assign(y.clone(), z.clone(), rm);
        println!(
            "x := {:#x}; x.add_mul_round_assign({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_assign_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_round_assign_val_ref(y.clone(), &z, rm);
        println!("x := {x_old}; x.add_mul_round_assign_val_ref({y}, {z}, {rm}); x = {x}");
    }
}

fn demo_float_add_mul_round_assign_val_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_round_assign_val_ref(y.clone(), &z, rm);
        println!(
            "x := {:#x}; x.add_mul_round_assign_val_ref({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_assign_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_round_assign_ref_val(&y, z.clone(), rm);
        println!("x := {x_old}; x.add_mul_round_assign_ref_val({y}, {z}, {rm}); x = {x}");
    }
}

fn demo_float_add_mul_round_assign_ref_val_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_round_assign_ref_val(&y, z.clone(), rm);
        println!(
            "x := {:#x}; x.add_mul_round_assign_ref_val({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn demo_float_add_mul_round_assign_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        let mut x = x;
        let x_old = x.clone();
        x.add_mul_round_assign_ref_ref(&y, &z, rm);
        println!("x := {x_old}; x.add_mul_round_assign_ref_ref({y}, {z}, {rm}); x = {x}");
    }
}

fn demo_float_add_mul_round_assign_ref_ref_debug(gm: GenMode, config: &GenConfig, limit: usize) {
    for (x, y, z, rm) in float_float_float_rounding_mode_quadruple_gen_var_1()
        .get(gm, config)
        .take(limit)
    {
        ...
        x.add_mul_round_assign_ref_ref(&y, &z, rm);
        println!(
            "x := {:#x}; x.add_mul_round_assign_ref_ref({:#x}, {:#x}, {}); x = {:#x}",
            x_old,
            ComparableFloat(y),
            ComparableFloat(z),
            rm,
...
fn benchmark_float_add_mul_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
...
fn benchmark_float_add_mul_library_comparison(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        ...
        &mut [
            ...
            ("rug", &mut |((x, y, z), _)| {
                no_out!(rug_add_mul(&x, &y, &z));
            }),
        ],
    );
}

fn benchmark_float_add_mul_prec_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "Float.add_mul_prec(Float, Float, u64)",
        BenchmarkType::EvaluationStrategy,
        ...
        &mut [
            ("all by value", &mut |(x, y, z, prec)| {
                no_out!(x.add_mul_prec(y, z, prec));
            }),
            ("all by reference", &mut |(x, y, z, prec)| {
                no_out!(x.add_mul_prec_ref_ref_ref(&y, &z, prec));
            }),
        ],
    );
}

fn benchmark_float_add_mul_prec_library_comparison(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        ...
        &mut [
            ...
            ("rug", &mut |((x, y, z, prec), _)| {
                no_out!(rug_add_mul_prec(&x, &y, &z, prec));
            }),
        ],
    );
}

fn benchmark_float_add_mul_round_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "Float.add_mul_round(Float, Float, RoundingMode)",
        BenchmarkType::EvaluationStrategy,
        float_float_float_rounding_mode_quadruple_gen_var_1().get(gm, config),
        gm.name(),
        limit,
        file_name,
        ...
        &mut [
            ("all by value", &mut |(x, y, z, rm)| {
                no_out!(x.add_mul_round(y, z, rm));
            }),
            ("all by reference", &mut |(x, y, z, rm)| {
                no_out!(x.add_mul_round_ref_ref_ref(&y, &z, rm));
            }),
        ],
    );
}

fn benchmark_float_add_mul_round_library_comparison(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "Float.add_mul_round(Float, Float, RoundingMode)",
        BenchmarkType::LibraryComparison,
        float_float_float_rounding_mode_quadruple_gen_var_1_rm().get(gm, config),
        gm.name(),
        limit,
        file_name,
...
fn demo_float_add_mul_rational_prec_assign(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_prec_assign({y}, {z}, {prec}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_prec_assign_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_prec_assign_val_ref({y}, {z}, {prec}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_prec_assign_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_prec_assign_ref_val({y}, {z}, {prec}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_prec_assign_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_prec_assign_ref_ref({y}, {z}, {prec}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_round_assign(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_round_assign({y}, {z}, {rm}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_round_assign_val_ref(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_round_assign_val_ref({y}, {z}, {rm}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_round_assign_ref_val(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_round_assign_ref_val({y}, {z}, {rm}); x = {x}");
    }
}
...
fn demo_float_add_mul_rational_round_assign_ref_ref(gm: GenMode, config: &GenConfig, limit: usize) {
        ...
        .take(limit)
    {
        ...
        println!("x := {x_old}; x.add_mul_rational_round_assign_ref_ref({y}, {z}, {rm}); x = {x}");
    }
}
