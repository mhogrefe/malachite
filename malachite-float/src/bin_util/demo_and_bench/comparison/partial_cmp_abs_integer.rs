...
pub(crate) fn register(runner: &mut Runner) {
    ...
    register_bench!(runner, benchmark_float_partial_cmp_abs_integer);
    register_bench!(runner, benchmark_integer_partial_cmp_abs_float);
}
...
fn benchmark_float_partial_cmp_abs_integer(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
...
fn benchmark_integer_partial_cmp_abs_float(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
