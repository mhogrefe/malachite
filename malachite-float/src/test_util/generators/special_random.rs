...
use crate::test_util::generators::exhaustive::{
    ...
    log_base_float_base_prec_round_valid, log_base_float_base_round_valid,
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_15(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
fn striped_float_vec_pairs(seed: Seed, config: &GenConfig) -> It<(Vec<Float>, Vec<Float>)> {
    Box::new(
        random_vecs(
            seed,
            &|seed_2| {
                random_pairs_from_single(striped_random_floats(
                    seed_2,
                    config.get_or("mean_exponent_n", 64),
                    config.get_or("mean_exponent_d", 1),
                    config.get_or("mean_stripe_n", 32),
...
fn striped_extreme_float_vec_pairs(seed: Seed, config: &GenConfig) -> It<(Vec<Float>, Vec<Float>)> {
    Box::new(
        random_vecs(
            seed,
            &|seed_2| {
                random_pairs_from_single(striped_random_mixed_extreme_floats(
                    seed_2,
                    config.get_or("mean_exponent_n", 64),
                    config.get_or("mean_exponent_d", 1),
                    config.get_or("mean_stripe_n", 32),
...
pub fn special_random_float_vec_pair_gen_var_1(config: &GenConfig) -> It<(Vec<Float>, Vec<Float>)> {
    striped_float_vec_pairs(EXAMPLE_SEED, config)
}

pub fn special_random_float_vec_pair_gen_var_2(config: &GenConfig) -> It<(Vec<Float>, Vec<Float>)> {
    striped_extreme_float_vec_pairs(EXAMPLE_SEED, config)
}

pub fn special_random_float_vec_pair_unsigned_triple_gen_var_1(
    config: &GenConfig,
) -> It<(Vec<Float>, Vec<Float>, u64)> {
    Box::new(
        random_pairs(
            EXAMPLE_SEED,
            &|seed| striped_float_vec_pairs(seed, config),
            &|seed| {
                geometric_random_positive_unsigneds(
                    seed,
                    config.get_or("mean_small_n", 64),
...
pub fn special_random_float_vec_pair_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_vec_pair_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Vec<Float>, Vec<Float>, u64, RoundingMode)> {
    Box::new(
        random_triples(
            EXAMPLE_SEED,
            &|seed| striped_extreme_float_vec_pairs(seed, config),
            &|seed| {
                geometric_random_positive_unsigneds(
                    seed,
                    config.get_or("mean_small_n", 64),
...
pub fn special_random_float_vec_pair_rounding_mode_triple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_vec_pair_rounding_mode_triple_gen_var_2(
    config: &GenConfig,
) -> It<(Vec<Float>, Vec<Float>, RoundingMode)> {
    Box::new(
        random_pairs(
...
fn striped_float_vecs(seed: Seed, config: &GenConfig) -> It<Vec<Float>> {
    Box::new(random_vecs(
        seed,
        &|seed_2| {
            striped_random_floats(
...
fn striped_extreme_float_vecs(seed: Seed, config: &GenConfig) -> It<Vec<Float>> {
    Box::new(random_vecs(
        seed,
        &|seed_2| {
            striped_random_mixed_extreme_floats(
...
pub fn special_random_float_vec_gen(config: &GenConfig) -> It<Vec<Float>> {
    striped_float_vecs(EXAMPLE_SEED, config)
}

pub fn special_random_float_vec_gen_var_1(config: &GenConfig) -> It<Vec<Float>> {
    striped_extreme_float_vecs(EXAMPLE_SEED, config)
}

pub fn special_random_float_vec_unsigned_pair_gen_var_1(
    config: &GenConfig,
) -> It<(Vec<Float>, u64)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_float_vec_unsigned_rounding_mode_triple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_vec_unsigned_rounding_mode_triple_gen_var_2(
    config: &GenConfig,
) -> It<(Vec<Float>, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_vec_rounding_mode_pair_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_vec_rounding_mode_pair_gen_var_2(
    config: &GenConfig,
) -> It<(Vec<Float>, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_24(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_25(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_11(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_12(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_13(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_14(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_22(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_float_unsigned_rounding_mode_quadruple_gen_var_23(
    config: &GenConfig,
) -> It<(Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_quadruple_gen(config: &GenConfig) -> It<(Float, Float, Float, Float)> {
    Box::new(random_quadruples_from_single(striped_random_floats(
        EXAMPLE_SEED,
        config.get_or("mean_exponent_n", 64),
        config.get_or("mean_exponent_d", 1),
        config.get_or("mean_stripe_n", 32),
...
pub fn special_random_float_float_float_float_unsigned_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_float_unsigned_rounding_mode_sextuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_float_unsigned_rounding_mode_sextuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxxyz(
...
pub fn special_random_float_float_float_float_unsigned_rounding_mode_sextuple_gen_var_3(
    config: &GenConfig,
) -> It<(Float, Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxxyz(
...
pub fn special_random_float_float_float_float_unsigned_rounding_mode_sextuple_gen_var_4(
    config: &GenConfig,
) -> It<(Float, Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxxyz(
...
pub fn special_random_float_float_float_float_rounding_mode_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_float_rounding_mode_quintuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, Float, RoundingMode)> {
    Box::new(
        random_quintuples_xxxxy(
...
pub fn special_random_float_float_float_unsigned_quadruple_gen_var_1(
    config: &GenConfig,
) -> It<(Float, Float, Float, u64)> {
...
pub fn special_random_float_float_float_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, RoundingMode)> {
    Box::new(
        random_quadruples_xxxy(
...
pub fn special_random_float_float_float_unsigned_rounding_mode_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_unsigned_rounding_mode_quintuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxxyz(
...
pub fn special_random_float_float_float_unsigned_rounding_mode_quintuple_gen_var_3(
    config: &GenConfig,
) -> It<(Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxxyz(
...
pub fn special_random_float_float_float_unsigned_rounding_mode_quintuple_gen_var_4(
    config: &GenConfig,
) -> It<(Float, Float, Float, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxxyz(
...
pub fn special_random_float_float_float_rational_quadruple_gen(
    config: &GenConfig,
...
pub fn special_random_float_float_float_rational_unsigned_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_rational_unsigned_rounding_mode_sextuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_rational_unsigned_rounding_mode_sextuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxyzw(
...
pub fn special_random_float_float_float_rational_unsigned_rounding_mode_sextuple_gen_var_3(
    config: &GenConfig,
) -> It<(Float, Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxyzw(
...
pub fn special_random_float_float_float_rational_unsigned_rounding_mode_sextuple_gen_var_4(
    config: &GenConfig,
) -> It<(Float, Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_sextuples_xxxyzw(
...
pub fn special_random_float_float_float_rational_rounding_mode_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_float_rational_rounding_mode_quintuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Float, Rational, RoundingMode)> {
    Box::new(
        random_quintuples_xxxyz(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_43(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_44(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_35(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_36(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_37(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_38(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rounding_mode_triple_gen_var_42(
    config: &GenConfig,
) -> It<(Float, Float, RoundingMode)> {
    Box::new(
        random_triples_xxy(
...
pub fn special_random_float_float_rational_unsigned_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_rational_unsigned_rounding_mode_quintuple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_rational_unsigned_rounding_mode_quintuple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxyzw(
...
pub fn special_random_float_float_rational_unsigned_rounding_mode_quintuple_gen_var_3(
    config: &GenConfig,
) -> It<(Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxyzw(
...
pub fn special_random_float_float_rational_unsigned_rounding_mode_quintuple_gen_var_4(
    config: &GenConfig,
) -> It<(Float, Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quintuples_xxyzw(
...
pub fn special_random_float_float_rational_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_float_rational_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Float, Rational, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_float_string_pair_gen_var_2(config: &GenConfig) -> It<(Float, String)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| {
            striped_random_extreme_floats(
...
pub fn special_random_float_integer_unsigned_triple_gen_var_1<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(Float, Integer, T)> {
...
pub fn special_random_float_integer_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_integer_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Float, Integer, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_11(
    config: &GenConfig,
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_12(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_pair_gen_var_8(config: &GenConfig) -> It<(Float, u8)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| {
            striped_random_floats(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_43(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_46(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_21(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_22(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_23(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_24(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_29(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_30(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_31(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(random_triples(
        EXAMPLE_SEED,
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_5(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_6(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_5(
    config: &GenConfig,
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_6(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_7(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_8(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_7(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_8(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_25(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_26(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_9(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_10(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_11(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_12(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_11(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_12(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_15(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_16(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_17(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_18(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_19(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_20(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_21(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_22(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_23(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_24(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_13(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_unsigned_rounding_mode_quadruple_gen_var_14(
    config: &GenConfig,
) -> It<(Float, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_12(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_13(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_14(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_15(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_16(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_17(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_18(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_19(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_20(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_21(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_22(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rational_rounding_mode_triple_gen_var_23(
    config: &GenConfig,
) -> It<(Float, Rational, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_36(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_37(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_38(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_39(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_42(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_43(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_44(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_34(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_35(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_45(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_46(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_signed_rounding_mode_triple_gen_var_7(
    config: &GenConfig,
...
pub fn special_random_float_signed_rounding_mode_triple_gen_var_8(
    config: &GenConfig,
) -> It<(Float, i64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_27(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_28(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_32(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_33(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_signed_rounding_mode_triple_gen_var_9(
    config: &GenConfig,
) -> It<(Float, i64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_signed_rounding_mode_triple_gen_var_10(
    config: &GenConfig,
) -> It<(Float, i64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_40(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_41(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_to_sci_options_pair_gen(
    config: &GenConfig,
...
// sizing.
pub fn special_random_float_to_sci_options_pair_gen_var_2(
    config: &GenConfig,
) -> It<(Float, ToSciOptions)> {
    Box::new(
        random_pairs(
...
pub fn special_random_unsigned_pair_gen_var_51(config: &GenConfig) -> It<(u64, u64)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_unsigned_unsigned_rounding_mode_triple_gen_var_11(
    config: &GenConfig,
) -> It<(u64, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_unsigned_unsigned_rounding_mode_triple_gen_var_7<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(T, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_unsigned_rounding_mode_triple_gen_var_9(
    config: &GenConfig,
) -> It<(Rational, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_unsigned_rounding_mode_triple_gen_var_10(
    config: &GenConfig,
) -> It<(Rational, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_unsigned_rounding_mode_triple_gen_var_12(
    config: &GenConfig,
) -> It<(Rational, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_signed_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_rational_rational_unsigned_rounding_mode_quadruple_gen_var_4(
    config: &GenConfig,
) -> It<(Rational, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_rational_rational_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Rational, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_rational_rational_unsigned_rounding_mode_quadruple_gen_var_3(
    config: &GenConfig,
) -> It<(Rational, Rational, u64, RoundingMode)> {
    Box::new(
        random_quadruples_xxyz(
...
pub fn special_random_rational_float_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_rational_float_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Rational, Float, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_15(
    config: &GenConfig,
) -> It<(Float, i64, usize, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_16(
    config: &GenConfig,
) -> It<(Float, i64, usize, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_36(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_45(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_38(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_39(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_40(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_41(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_44(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_47(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_47(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_49(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_rounding_mode_pair_gen_var_50(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_37(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_48(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_13(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_15(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| cos_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_17(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| sin_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_19(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| atan_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_21(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| asin_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_23(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| acos_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_25(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| asec_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_14(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_16(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_18(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_20(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_22(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_24(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_26(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_13(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_14(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_17(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_signed_unsigned_rounding_mode_quadruple_gen_var_18(
    config: &GenConfig,
) -> It<(Float, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
// -- (Rational, PrimitiveUnsigned, PrimitiveUnsigned, RoundingMode) --
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_3(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_4(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_5(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_6(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref n, k, prec, rm)| atan_with_period_rational_prec_round_valid(n, k, prec, rm)),
    )
}

pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_7(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_9(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref n, k, prec, rm)| asec_with_period_rational_prec_round_valid(n, k, prec, rm)),
    )
}

// -- (Rational, PrimitiveSigned, PrimitiveUnsigned, RoundingMode) --
pub fn special_random_rational_signed_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(Rational, i64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
// As `random_strtofr_quadruples`, but with striped exponents and longer digit strings, so that
// extreme exponents and long mantissas are common.
fn special_random_strtofr_quadruples(
    config: &GenConfig,
    rug_compatible: bool,
) -> It<(String, u8, u64, RoundingMode)> {
    let mean_digits_n = config.get_or("mean_digits_n", 32);
    ...
    Box::new(
        random_quadruples(
            ...
            &move |seed| striped_random_signeds::<i64>(seed, mean_stripe_n, mean_stripe_d),
            &move |seed| {
                random_pairs(
                    seed,
        ...
        .map(
            move |(v, mut digits, exp, (prec, rm)): (u64, Vec<u8>, i64, (u64, RoundingMode))| {
                ...
                // Replace the tail with a run of a single digit, so that inputs land near a
                // rounding boundary: a mantissa like 4999...9 or 5000...1 is what distinguishes a
                // correct error bound in the Ziv loop from one that is slightly too small. Uniform
                // digits essentially never produce such a case.
                let len = digits.len();
                let split = usize::exact_from((v >> 16) % u64::exact_from(len + 1));
                let run = u8::exact_from((v >> 24) % 62);
...
pub fn special_random_string_unsigned_unsigned_rounding_mode_quadruple_gen_var_1(
    config: &GenConfig,
) -> It<(String, u8, u64, RoundingMode)> {
    Box::new(
        special_random_strtofr_quadruples(config, false)
            .filter(|(s, base, prec, rm)| valid_strtofr_quadruple(s, *base, *prec, *rm)),
    )
}

pub fn special_random_string_unsigned_unsigned_rounding_mode_quadruple_gen_var_2(
    config: &GenConfig,
) -> It<(String, u8, u64, RoundingMode)> {
    Box::new(special_random_strtofr_quadruples(config, true).filter(|(_, _, _, rm)| *rm != Exact))
}

// -- (String, FromSciStringOptions, PrimitiveUnsigned) --

pub fn special_random_string_from_sci_string_options_unsigned_triple_gen_var_1(
    config: &GenConfig,
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_27(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref x, n, prec, rm)| acsc_with_period_prec_round_valid(x, n, prec, rm)),
    )
}

pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_28(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_50(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_10(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_51(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_52(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_rounding_mode_pair_gen_var_52(
    config: &GenConfig,
) -> It<(Float, RoundingMode)> {
    Box::new(
        random_pairs(
...
pub fn special_random_rational_unsigned_rounding_mode_triple_gen_var_14(
    config: &GenConfig,
) -> It<(Rational, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_29(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_unsigned_rounding_mode_quadruple_gen_var_30(
    config: &GenConfig,
) -> It<(Float, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
...
pub fn special_random_float_unsigned_rounding_mode_triple_gen_var_53(
    config: &GenConfig,
) -> It<(Float, u64, RoundingMode)> {
    Box::new(
        random_triples(
...
pub fn special_random_rational_unsigned_unsigned_rounding_mode_quadruple_gen_var_11(
    config: &GenConfig,
) -> It<(Rational, u64, u64, RoundingMode)> {
    Box::new(
        random_quadruples(
        ...
        .filter(|&(ref n, k, prec, rm)| acot_with_period_rational_prec_round_valid(n, k, prec, rm)),
    )
}
