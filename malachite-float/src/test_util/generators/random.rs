...
use malachite_base::num::random::{
    random_primitive_ints, random_unsigned_inclusive_range, random_unsigned_range,
...
pub fn random_float_float_unsigned_triple_gen_var_2(config: &GenConfig) -> It<(Float, Float, u64)> {
    reshape_2_1_to_3(Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| random_float_pairs_with_precision_inclusive_range(seed, config, 1, Limb::WIDTH),
        &|seed| random_unsigned_range(seed, 1, Limb::WIDTH),
    )))
}

pub fn random_float_float_unsigned_triple_gen_var_3(config: &GenConfig) -> It<(Float, Float, u64)> {
    Box::new(
        random_float_pairs_with_precision_inclusive_range(EXAMPLE_SEED, config, 1, Limb::WIDTH)
            .map(|(x, y)| (x, y, Limb::WIDTH)),
    )
}

pub fn random_float_float_unsigned_triple_gen_var_4(config: &GenConfig) -> It<(Float, Float, u64)> {
    reshape_2_1_to_3(Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| {
            random_float_pairs_with_precision_inclusive_range(
...
pub fn random_float_float_unsigned_triple_gen_var_5(config: &GenConfig) -> It<(Float, Float, u64)> {
    reshape_2_1_to_3(Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| {
            random_float_pairs_with_precision_inclusive_range(
