...
// Whether `(x, prec, rm)` is a valid input to `Float::acot_rational_prec_round`.
pub fn acot_rational_prec_round_valid(_x: &Rational, _prec: u64, rm: RoundingMode) -> bool {
    // the arccotangent of a rational is transcendental everywhere, pi/2 at zero and pi/4 at +-1
    // included
    rm != Exact
}
...
// Whether `(x, u, rm)` is a valid input to `Float.acsc_with_period_round`.
...
// Whether `(x, u, prec, rm)` is a valid input to `Float::asec_with_period_rational_prec_round`.
...
// Whether `(x, u, prec, rm)` is a valid input to `Float::acot_with_period_rational_prec_round`.
...
// Whether `(x, u, prec, rm)` is a valid input to `Float::acsc_with_period_rational_prec_round`.
...
// Whether `(x, u, rm)` is a valid input to `Float::sin_with_period_round`.
...
// Whether `(x, u, prec, rm)` is a valid input to `Float.acos_with_period_prec_round`.
...
// Whether `(x, u, rm)` is a valid input to `Float.acos_with_period_round`.
...
// Whether `(x, u, prec, rm)` is a valid input to `Float.asec_with_period_prec_round`.
...
// Whether `(x, u, rm)` is a valid input to `Float.asec_with_period_round`.
