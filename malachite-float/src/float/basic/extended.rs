...
use crate::float::conversion::primitive_float_from_float::FloatFromFloatError;
use crate::float::conversion::rational_from_float::RationalFromFloatError;
...
impl ExtendedFloat {
    ...
    pub(crate) fn mul_prec_ref_ref(&self, other: &Self, prec: u64) -> (Self, Ordering) {
        assert!(self.is_valid());
        assert!(other.is_valid());
        assert!(self.x.is_normal());
        assert!(other.x.is_normal());
    ...
    pub(crate) fn div_prec_val_ref(self, other: &Self, prec: u64) -> (Self, Ordering) {
        assert!(self.is_valid());
        assert!(other.is_valid());
        assert!(self.x.is_normal());
        assert!(other.x.is_normal());
