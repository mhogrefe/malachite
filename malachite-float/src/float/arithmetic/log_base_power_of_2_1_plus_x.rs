...
use crate::float::arithmetic::log_base_2_1_plus_x::log_base_2_1_plus_x_exact;
...
impl Float {
    ...
    ///     Less
    /// );
    /// assert_eq!(x.to_string(), "1.7297153");
    /// ```
    #[inline]
    ...
    /// assert_eq!(x.to_string(), "1.7297158093186486280996815233624");
    /// ```
    #[inline]
...
impl LogBasePowerOf2Of1PlusX<i64> for Float {
    ...
    ///         .log_base_power_of_2_1_plus_x(2)
    ///         .to_string(),
    ///     "1.7297158093186486280996815233624"
    /// );
    /// ```
    #[inline]
