...
impl Float {
    ...
    /// assert_eq!(p.to_string(), "3.1622810");
    /// assert_eq!(o, Greater);
    /// ```
    #[inline]
    ...
    /// assert_eq!(x.to_string(), "3.1622810");
    /// ```
    #[inline]
    ...
    /// assert_eq!(p.to_string(), "3.9810753");
    /// assert_eq!(o, Greater);
    /// ```
    #[inline]
...
/// use malachite_float::float::arithmetic::power_of_10::primitive_float_power_of_10;
///
/// assert_eq!(
...
/// ```
/// use malachite_base::num::float::NiceFloat;
/// use malachite_float::float::arithmetic::power_of_10::primitive_float_power_of_10_rational;
/// use malachite_q::Rational;
///
/// assert_eq!(
