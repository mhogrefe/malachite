...
impl Float {
    ...
    /// assert_eq!(o, Less);
    ///
    /// let (p, o) = Float::power_of_2_rational_prec(Rational::ZERO, 10);
    ...
    /// assert_eq!(o, Less);
    ///
    /// let (p, o) = Float::power_of_2_rational_prec_ref(&Rational::ZERO, 10);
    /// assert_eq!(p.to_string(), "1.0000");
    /// assert_eq!(o, Equal);
    /// ```
    #[inline]
...
/// use malachite_float::float::arithmetic::power_of_2_of_float::primitive_float_power_of_2;
///
