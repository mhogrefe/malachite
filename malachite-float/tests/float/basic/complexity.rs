...
fn test_complexity() {
    ...
    test("2.6e120", "0x1.0E+100#1", 400);
    test("3.9e-121", "0x1.0E-100#1", 400);
    test("1.0e323228496", "0x4.0E+268435455#1", 1073741822);
    test("2.4e-323228497", "0x1.0E-268435456#1", 1073741824);
...
fn test_significant_bits() {
    ...
    test("1.4142135623730951", "0x1.6a09e667f3bcd#53", 53);
    test("3.1415926535897931", "0x3.243f6a8885a30#53", 53);
    test("2.6e120", "0x1.0E+100#1", 1);
    test("3.9e-121", "0x1.0E-100#1", 1);
    test("1.0e323228496", "0x4.0E+268435455#1", 1);
    test("2.4e-323228497", "0x1.0E-268435456#1", 1);
