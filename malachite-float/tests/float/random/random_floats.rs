...
fn test_random_floats() {
    ...
    let values = &[
        ...
        "-0.25", "-2.0", "Infinity", "-0.50", "-1.0", "-0.38", "NaN", "0.50", "-0.0",
    ];
    let values_hex = &[
    ...
    let values = &[
        ...
        "5.1e2", "-4.4e-16", "-6.9e-18", "-2.2e-19", "Infinity", "-1.9e50", "-1.1e12", "-3.0e-28",
        "NaN", "0.016", "-0.0",
    ];
    let values_hex = &[
        "0x8.0E+9#1",
