...
use malachite_float::test_util::float::random::random_floats_helper_helper;
...
fn test_striped_random_non_negative_finite_floats() {
    ...
    let values = &[
        "8.0", "1.0", "0.75", "0.0", "4.0", "3.5", "1.0", "2.0", "0.50", "0.50000", "2.0", "32.0",
        "0.50", "0.0", "1.0", "3.0", "0.50", "0.0", "1.0", "0.12",
    ];
    let values_hex = &[
        "0x8.0#1",
        "0x1.0#1",
    ...
    let values = &[
        "1.1e9", "1.9e-6", "24.0", "0.0", "4.8e-7", "0.11", "7.6e22", "7.4e19", "0.031",
        "3.3554e7", "1.7e38", "7.5e-9", "2.3e15", "0.0", "2.7e11", "2.2e-8", "5.6e14", "0.0",
        "0.031", "1.9e-34",
    ];
    let values_hex = &[
        "0x4.0E+7#1",
    ...
    let sample_median = (
        "0.0078124999999715817592",
        Some("0.0078124999999715817591703163301434550090"),
    );
    let sample_median_hex = (
