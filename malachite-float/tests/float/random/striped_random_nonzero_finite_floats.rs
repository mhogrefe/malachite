...
fn test_striped_random_nonzero_finite_floats() {
    ...
    let values = &[
        "-8.0", "-1.0", "-0.75", "4.0", "-3.5", "1.0", "-2.0", "-0.50", "-0.50000", "2.0", "32.0",
        "0.50", "-1.0", "-3.0", "0.50", "-1.0", "-0.12", "-1.0", "-0.055", "-1.8",
    ];
    let values_hex = &[
        "-0x8.0#1",
        "-0x1.0#1",
    ...
    let values = &[
        ...
        "-1.000",
        "-0.234",
        "-1.6248168945312499999999991728",
        "-0.062256097779",
        "-1.99988",
    ];
    let values_hex = &[
    ...
    let sample_median = ("1.2e-122", None);
    ...
    let values = &[
        ...
        "-0.03125",
        "-3.61e-34",
        "-914690595094527.99999999953434",
        "-5.0508147019e30",
        "-3.13836e57",
    ];
    let values_hex = &[
