...
fn test_random_non_positive_finite_floats() {
    ...
    let values = &[
        "-8.0", "-1.0", "-0.75", "-0.0", "-4.0", "-2.0", "-1.0", "-2.0", "-0.75", "-0.95361",
        "-2.0", "-32.0", "-0.50", "-0.0", "-1.0", "-2.0", "-0.50", "-0.0", "-1.5", "-0.12",
    ];
    let values_hex = &[
        "-0x8.0#1",
        "-0x1.0#1",
    ...
    let sample_median = ("-0.00586", Some("-0.0059"));
    ...
    let sample_median = ("-0.00744798329447", Some("-0.0074474812"));
