...
fn test_striped_random_positive_finite_floats() {
    ...
    let values = &[
        ...
        "1.0", "1.0", "2.00", "0.12", "1.0", "0.25", "1.0",
    ];
    let values_hex = &[
    ...
    let values = &[
        "2.8e-37", "7.7e-34", "3.8e-6", "2.8e-45", "2.3e15", "4.7e-10", "1.6e4", "0.11", "0.00012",
        "1.4e14", "2.1e34", "9.1e-13", "0.00012", "8.6e9", "1.3e33", "0.125", "0.000031", "4.6e18",
        "0.062", "5.4e8",
    ];
    let values_hex = &[
        "0x6.0E-31#2",
    ...
    let sample_median = ("1.124999880790710", Some("1.12499988079071222547"));
