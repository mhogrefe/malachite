...
fn test_random_positive_finite_floats() {
    ...
    let values = &[
        ...
        "1.0", "1.8", "2.50", "0.12", "1.0", "0.25", "1.2",
    ];
    let values_hex = &[
    ...
    let values = &[
        "2.8e-37", "7.7e-34", "3.8e-6", "2.8e-45", "2.3e15", "4.7e-10", "1.6e4", "0.078",
        "0.00012", "1.4e14", "2.1e34", "9.1e-13", "0.00012", "8.6e9", "2.3e33", "0.156",
        "0.000031", "4.6e18", "0.062", "6.7e8",
    ];
    let values_hex = &[
        "0x6.0E-31#2",
        "0x4.0E-28#1",
    ...
    let sample_median = (
        "1.452629",
        Some("1.45276652364606716574229638146307985533987727908"),
    );
    let sample_median_hex = (
        "0x1.73df8#18",
