...
fn test_random_nonzero_finite_floats() {
    ...
    let values = &[
        "-8.0", "-1.0", "-0.75", "4.0", "-2.0", "1.0", "-2.0", "-0.75", "-0.95361", "2.0", "32.0",
        "0.50", "-1.0", "-2.0", "0.50", "-1.5", "-0.12", "-1.0", "-0.047", "-1.0",
    ];
    let values_hex = &[
        "-0x8.0#1",
        "-0x1.0#1",
    ...
    let values = &[
        ...
        "-1.246",
        "-0.141",
        "-1.2457223529563683833958588190",
        "-0.039628090206",
        "-1.00110",
    ];
    let values_hex = &[
    ...
    let sample_median = (
        ...
        Some("0.00278913626349731298639154012"),
    );
    ...
    let sample_median = ("1.2e-122", Some("1.2e-122"));
    ...
    let values = &[
        ...
        "-0.03894",
        "-2.17e-34",
        "-701279340572674.76845213817887",
        "-3.2150126295e30",
        "-1.57100e57",
    ];
    let values_hex = &[
