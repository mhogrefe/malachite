...
fn test_primitive_float_hypot() {
    ...
    test::<f32>(-3.0, -4.0, 5.0);
    test::<f32>(1.0, 1.0, 1.4142135);
    test::<f32>(3.1415927, 2.7182817, 4.1543546);
    ...
    test::<f64>(1.0, 1.0, 1.4142135623730951);
    test::<f64>(3.141592653589793, 2.718281828459045, 4.154354402313313);
    test::<f64>(
