...
use malachite_float::float::arithmetic::log_base_2::{
...
use malachite_float::test_util::float::arithmetic::log_base_2::{
...
fn test_log_base_2() {
    ...
    test(
        ...
        "2.2761714318270646273745024223033e-30",
    ...
    test("1.0e323228496", "0x4.0E+268435455#1", "1.1e9", "0x4.0E+7#1");
    test(
        "2.4e-323228497",
        "0x1.0E-268435456#1",
        "-1.1e9",
...
fn test_log_base_2_prec() {
    ...
    test("0.50", "0x0.8#1", 1, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 10, "-1.0000", "-0x1.000#10", Equal);
    test("8.0", "0x8.0#1", 1, "4.0", "0x4.0#1", Greater);
    test("8.0", "0x8.0#1", 2, "3.0", "0x3.0#2", Equal);
    test("123.0", "0x7b.0#7", 1, "8.0", "0x8.0#1", Greater);
    test("123.0", "0x7b.0#7", 10, "6.9453", "0x6.f2#10", Greater);
    ...
    test(
        ...
        35329381651683587265824062346127959",
...
fn test_log_base_2_round() {
    ...
    test("0.50", "0x0.8#1", Floor, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", Ceiling, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", Down, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", Up, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", Nearest, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", Exact, "-1.0", "-0x1.0#1", Equal);
    ...
    test(
        ...
        "0x1.0000000000000000000000002#100",
        Floor,
        "2.2761714318270646273745024223008e-30",
...
fn test_log_base_2_prec_round() {
    ...
    test("0.50", "0x0.8#1", 1, Floor, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 1, Ceiling, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 1, Down, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 1, Up, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 1, Nearest, "-1.0", "-0x1.0#1", Equal);
    test("0.50", "0x0.8#1", 1, Exact, "-1.0", "-0x1.0#1", Equal);
    ...
    test("123.0", "0x7b.0#7", 10, Floor, "6.9375", "0x6.f0#10", Less);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("123.0", "0x7b.0#7", 10, Down, "6.9375", "0x6.f0#10", Less);
    test("123.0", "0x7b.0#7", 10, Up, "6.9453", "0x6.f2#10", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        10,
...
fn log_base_2_prec_round_fail() {
    const THREE: Float = Float::const_from_unsigned(3);
    assert_panic!(Float::ONE.log_base_2_prec_round(0, Floor));
    assert_panic!(Float::ONE.log_base_2_prec_round_ref(0, Floor));
    assert_panic!({
        let mut x = Float::ONE;
...
fn log_base_2_prec_round_properties_helper(x: Float, prec: u64, rm: RoundingMode) {
    let (log_base_2, o) = x.clone().log_base_2_prec_round(prec, rm);
    assert!(log_base_2.is_valid());
    assert_rounding_ordering_consistent(&log_base_2, rm, o);
...
fn test_log_base_2_rational_prec() {
    ...
    test("2", 10, "1.0000", "0x1.000#10", Equal);
    test(
        "2",
        100,
        "1.0000000000000000000000000000000",
    ...
    test("1/2", 10, "-1.0000", "-0x1.000#10", Equal);
    test(
        "1/2",
        100,
        "-1.0000000000000000000000000000000",
    ...
    test("8", 10, "3.0000", "0x3.00#10", Equal);
    test(
        "8",
        100,
    ...
    test("1/8", 10, "-3.0000", "-0x3.00#10", Equal);
    test(
        "1/8",
        100,
        "-3.0000000000000000000000000000000",
    ...
    test("1024", 10, "10.000", "0xa.00#10", Equal);
    test(
        "1024",
        100,
    ...
    test("3/5", 1, "-0.50", "-0x0.8#1", Greater);
    test("3/5", 10, "-0.73730", "-0x0.bcc#10", Less);
    test(
        "3/5",
        100,
        "-0.73696559416620616641658048554156",
        "-0x0.bca9c6f53897a45984a4c9f33#100",
        Greater,
    );
    test("1/3", 1, "-2.0", "-0x2.0#1", Less);
    test("1/3", 10, "-1.5859", "-0x1.960#10", Less);
    test(
        "1/3",
        100,
        "-1.5849625007211561814537389439475",
        "-0x1.95c01a39fbd6879fa00b120a0#100",
        Greater,
    );
    test("22/7", 1, "2.0", "0x2.0#1", Greater);
    test("22/7", 10, "1.6523", "0x1.a70#10", Greater);
    test(
        "22/7",
        100,
        "1.6520766965796931487573937294939",
        "0x1.a6ee7f964b22a0c5d02f629d4#100",
        Less,
    );
    test("355/113", 1, "2.0", "0x2.0#1", Greater);
    test("355/113", 10, "1.6523", "0x1.a70#10", Greater);
    test(
        "355/113",
        100,
        "1.6514962519768567009585211052352",
    ...
    test_big(
        Rational::ONE + Rational::power_of_2(-1000i64),
        100,
        "1.3464147942566833070230367006437e-301",
...
fn test_log_base_2_rational_prec_round() {
    ...
    test("2", 10, Floor, "1.0000", "0x1.000#10", Equal);
    test("2", 10, Ceiling, "1.0000", "0x1.000#10", Equal);
    test("2", 10, Down, "1.0000", "0x1.000#10", Equal);
    test("2", 10, Up, "1.0000", "0x1.000#10", Equal);
    ...
    test("1/2", 10, Down, "-1.0000", "-0x1.000#10", Equal);
    test("1/2", 10, Up, "-1.0000", "-0x1.000#10", Equal);
    ...
    test("8", 10, Floor, "3.0000", "0x3.00#10", Equal);
    test("8", 10, Ceiling, "3.0000", "0x3.00#10", Equal);
    test("8", 10, Down, "3.0000", "0x3.00#10", Equal);
    test("8", 10, Up, "3.0000", "0x3.00#10", Equal);
    test("8", 10, Nearest, "3.0000", "0x3.00#10", Equal);
    test("8", 10, Exact, "3.0000", "0x3.00#10", Equal);
    ...
    test("1/8", 10, Floor, "-3.0000", "-0x3.00#10", Equal);
    test("1/8", 10, Ceiling, "-3.0000", "-0x3.00#10", Equal);
    test("1/8", 10, Down, "-3.0000", "-0x3.00#10", Equal);
    test("1/8", 10, Up, "-3.0000", "-0x3.00#10", Equal);
    test("1/8", 10, Nearest, "-3.0000", "-0x3.00#10", Equal);
    test("1/8", 10, Exact, "-3.0000", "-0x3.00#10", Equal);
    ...
    test("1024", 1, Ceiling, "16.0", "0x1.0E+1#1", Greater);
    test("1024", 1, Down, "8.0", "0x8.0#1", Less);
    test("1024", 1, Up, "16.0", "0x1.0E+1#1", Greater);
    test("1024", 1, Nearest, "8.0", "0x8.0#1", Less);

    test("1024", 10, Floor, "10.000", "0xa.00#10", Equal);
    test("1024", 10, Ceiling, "10.000", "0xa.00#10", Equal);
    test("1024", 10, Down, "10.000", "0xa.00#10", Equal);
    test("1024", 10, Up, "10.000", "0xa.00#10", Equal);
    test("1024", 10, Nearest, "10.000", "0xa.00#10", Equal);
    test("1024", 10, Exact, "10.000", "0xa.00#10", Equal);
    ...
    test("3/5", 1, Down, "-0.50", "-0x0.8#1", Greater);
    test("3/5", 1, Up, "-1.0", "-0x1.0#1", Less);
    test("3/5", 1, Nearest, "-0.50", "-0x0.8#1", Greater);

    test("3/5", 10, Floor, "-0.73730", "-0x0.bcc#10", Less);
    test("3/5", 10, Ceiling, "-0.73633", "-0x0.bc8#10", Greater);
    test("3/5", 10, Down, "-0.73633", "-0x0.bc8#10", Greater);
    test("3/5", 10, Up, "-0.73730", "-0x0.bcc#10", Less);
    test("3/5", 10, Nearest, "-0.73730", "-0x0.bcc#10", Less);

    test(
        "3/5",
        100,
        Floor,
        "-0.73696559416620616641658048554235",
    ...
    test("1/3", 10, Floor, "-1.5859", "-0x1.960#10", Less);
    test("1/3", 10, Ceiling, "-1.5840", "-0x1.958#10", Greater);
    test("1/3", 10, Down, "-1.5840", "-0x1.958#10", Greater);
    test("1/3", 10, Up, "-1.5859", "-0x1.960#10", Less);
    test("1/3", 10, Nearest, "-1.5859", "-0x1.960#10", Less);

    test(
        "1/3",
        100,
        Floor,
        "-1.5849625007211561814537389439491",
    ...
    test("22/7", 10, Floor, "1.6504", "0x1.a68#10", Less);
    test("22/7", 10, Ceiling, "1.6523", "0x1.a70#10", Greater);
    test("22/7", 10, Down, "1.6504", "0x1.a68#10", Less);
    test("22/7", 10, Up, "1.6523", "0x1.a70#10", Greater);
    test("22/7", 10, Nearest, "1.6523", "0x1.a70#10", Greater);
    ...
    test(
        ...
        100,
        Ceiling,
        "1.6520766965796931487573937294955",
    ...
    test("355/113", 10, Floor, "1.6504", "0x1.a68#10", Less);
    test("355/113", 10, Ceiling, "1.6523", "0x1.a70#10", Greater);
    test("355/113", 10, Down, "1.6504", "0x1.a68#10", Less);
    test("355/113", 10, Up, "1.6523", "0x1.a70#10", Greater);
    test("355/113", 10, Nearest, "1.6523", "0x1.a70#10", Greater);

    test(
        "355/113",
        100,
        Floor,
        "1.6514962519768567009585211052336",
    ...
    test_big(
        ...
        100,
        Floor,
        "1.3464147942566833070230367006423e-301",
