...
fn test_power_of_10_x_minus_1() {
    ...
    test("123.0", "0x7b.0#7", "1.002e123", "0x1.84E+102#7");
    test("-123.0", "-0x7b.0#7", "-1.000", "-0x1.00#7");
    test("0.50", "0x0.8#1", "2.0", "0x2.0#1");
    ...
    test(
        ...
        "4.6500335636676877476416618e-28",
...
fn test_power_of_10_x_minus_1_prec() {
    ...
    test("1.0", "0x1.0#1", 10, "9.0000", "0x9.00#10", Equal);
    test(
        "1.0",
        "0x1.0#1",
        53,
    ...
    test("-1.0", "-0x1.0#1", 10, "-0.90039", "-0x0.e68#10", Less);
    test(
        "-1.0",
        "-0x1.0#1",
        53,
    ...
    test("123.0", "0x7b.0#7", 1, "1.3e123", "0x2.0E+102#1", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("0.50", "0x0.8#1", 1, "2.0", "0x2.0#1", Less);
    test("0.50", "0x0.8#1", 10, "2.1641", "0x2.2a#10", Greater);
    test(
        "0.50",
        "0x0.8#1",
        53,
    ...
    test("-0.50", "-0x0.8#1", 10, "-0.68359", "-0x0.af0#10", Greater);
    test(
        "-0.50",
        "-0x0.8#1",
        53,
...
fn test_power_of_10_x_minus_1_round() {
    ...
    test("1.0", "0x1.0#1", Ceiling, "16.0", "0x1.0E+1#1", Greater);
    test("1.0", "0x1.0#1", Down, "8.0", "0x8.0#1", Less);
    test("1.0", "0x1.0#1", Up, "16.0", "0x1.0E+1#1", Greater);
    ...
    test("0.50", "0x0.8#1", Floor, "2.0", "0x2.0#1", Less);
    test("0.50", "0x0.8#1", Ceiling, "4.0", "0x4.0#1", Greater);
    test("0.50", "0x0.8#1", Down, "2.0", "0x2.0#1", Less);
    test("0.50", "0x0.8#1", Up, "4.0", "0x4.0#1", Greater);
    test("0.50", "0x0.8#1", Nearest, "2.0", "0x2.0#1", Less);
    test("-0.50", "-0x0.8#1", Floor, "-1.0", "-0x1.0#1", Less);
    test("-0.50", "-0x0.8#1", Ceiling, "-0.50", "-0x0.8#1", Greater);
    test("-0.50", "-0x0.8#1", Down, "-0.50", "-0x0.8#1", Greater);
    test("-0.50", "-0x0.8#1", Up, "-1.0", "-0x1.0#1", Less);
    ...
    test(
        ...
        "0x1.00000000000000000000E-23#80",
        Floor,
        "4.6500335636676877476416551e-28",
...
fn test_power_of_10_x_minus_1_prec_round() {
    ...
    test("1.0", "0x1.0#1", 1, Ceiling, "16.0", "0x1.0E+1#1", Greater);
    test("1.0", "0x1.0#1", 1, Nearest, "8.0", "0x8.0#1", Less);
    test("1.0", "0x1.0#1", 10, Floor, "9.0000", "0x9.00#10", Equal);
    test("1.0", "0x1.0#1", 10, Ceiling, "9.0000", "0x9.00#10", Equal);
    test("1.0", "0x1.0#1", 10, Nearest, "9.0000", "0x9.00#10", Equal);
    ...
    test("0.50", "0x0.8#1", 1, Nearest, "2.0", "0x2.0#1", Less);
    test("0.50", "0x0.8#1", 10, Floor, "2.1602", "0x2.29#10", Less);
    test(
        "0.50",
        "0x0.8#1",
        10,
    ...
    test("3.0", "0x3.0#2", 10, Exact, "999.00", "0x3e7.0#10", Equal);
    test(
        "6.0",
        "0x6.0#3",
        20,
...
fn test_power_of_10_x_minus_1_rational_prec() {
    ...
    test("1", 10, "9.0000", "0x9.00#10", Equal);
    test("1", 53, "9.0000000000000000", "0x9.0000000000000#53", Equal);
    test("3", 1, "1.0e3", "0x4.0E+2#1", Greater);
    test("3", 10, "999.00", "0x3e7.0#10", Equal);
    test("3", 53, "999.00000000000000", "0x3e7.00000000000#53", Equal);
    test("-1", 1, "-1.0", "-0x1.0#1", Less);
    test("-1", 10, "-0.90039", "-0x0.e68#10", Less);
    test(
        "-1",
        53,
        "-0.90000000000000002",
    ...
    test("-2", 10, "-0.99023", "-0x0.fd8#10", Less);
    test(
        "-2",
        53,
        "-0.98999999999999999",
    ...
    test("1/2", 10, "2.1641", "0x2.2a#10", Greater);
    test(
        "1/2",
        53,
        "2.1622776601683795",
    ...
    test("-1/2", 10, "-0.68359", "-0x0.af0#10", Greater);
    test(
        "-1/2",
        53,
        "-0.68377223398316211",
    ...
    test("1/3", 10, "1.1543", "0x1.278#10", Less);
    test(
        "1/3",
        53,
        "1.1544346900318838",
    ...
    test("-1/3", 10, "-0.53613", "-0x0.894#10", Less);
    test(
        "-1/3",
        53,
        "-0.53584111663872214",
    ...
    test("-22/7", 10, "-0.99902", "-0x0.ffc#10", Greater);
    test(
        "-22/7",
        53,
        "-0.99928031432699882",
    ...
    test(
        "100",
        100,
        "9.9999999999999999999999999999997e99",
...
fn test_power_of_10_x_minus_1_rational_prec_round() {
    ...
    test("1", 10, Floor, "9.0000", "0x9.00#10", Equal);
    test("1", 10, Ceiling, "9.0000", "0x9.00#10", Equal);
    test("1", 10, Nearest, "9.0000", "0x9.00#10", Equal);
    test(
        "1",
        53,
        Floor,
    ...
    test("3", 1, Floor, "5.1e2", "0x2.0E+2#1", Less);
    test("3", 1, Ceiling, "1.0e3", "0x4.0E+2#1", Greater);
    test("3", 1, Nearest, "1.0e3", "0x4.0E+2#1", Greater);
    test("3", 10, Floor, "999.00", "0x3e7.0#10", Equal);
    test("3", 10, Ceiling, "999.00", "0x3e7.0#10", Equal);
    test("3", 10, Nearest, "999.00", "0x3e7.0#10", Equal);
    test("3", 10, Exact, "999.00", "0x3e7.0#10", Equal);
    test(
        "3",
        53,
        Floor,
        "999.00000000000000",
        "0x3e7.00000000000#53",
        Equal,
    );
    test(
        "3",
    ...
    test("-1", 10, Floor, "-0.90039", "-0x0.e68#10", Less);
    test("-1", 10, Ceiling, "-0.89941", "-0x0.e64#10", Greater);
    test("-1", 10, Nearest, "-0.90039", "-0x0.e68#10", Less);
    test(
        "-1",
        53,
        Floor,
    ...
    test("-2", 10, Floor, "-0.99023", "-0x0.fd8#10", Less);
    test("-2", 10, Ceiling, "-0.98926", "-0x0.fd4#10", Greater);
    test("-2", 10, Nearest, "-0.99023", "-0x0.fd8#10", Less);
    test(
        "-2",
        53,
        Floor,
    ...
    test("1/2", 10, Floor, "2.1602", "0x2.29#10", Less);
    test("1/2", 10, Ceiling, "2.1641", "0x2.2a#10", Greater);
    test("1/2", 10, Nearest, "2.1641", "0x2.2a#10", Greater);
    test(
        "1/2",
        53,
        Floor,
    ...
    test("-1/2", 10, Floor, "-0.68457", "-0x0.af4#10", Less);
    test("-1/2", 10, Ceiling, "-0.68359", "-0x0.af0#10", Greater);
    test("-1/2", 10, Nearest, "-0.68359", "-0x0.af0#10", Greater);
    test(
        "-1/2",
        53,
        Floor,
    ...
    test("-1/3", 10, Floor, "-0.53613", "-0x0.894#10", Less);
    test("-1/3", 10, Ceiling, "-0.53516", "-0x0.890#10", Greater);
    test("-1/3", 10, Nearest, "-0.53613", "-0x0.894#10", Less);
    test(
        "-1/3",
        53,
        Floor,
    ...
    test("-22/7", 10, Nearest, "-0.99902", "-0x0.ffc#10", Greater);
    test(
        "-22/7",
        53,
        Floor,
