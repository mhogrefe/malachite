...
fn test_agm() {
    ...
    test(
        "1.772514151428731e-323228490",
        "0x7.184a0f216320E-268435451#48",
        "1.2e-7",
        "0x2.0E-6#2",
        "2.515965395368773e-16",
...
fn test_agm_prec() {
    ...
    // - e1 + e2 <= Float::MAX_EXPONENT in agm_prec_round_ref_ref_normal
    test(
        "2.0985787147572406758056e323228496",
        "0x7.ffffffe3ffffffffeE+268435455#70",
        "3.433637892159661028903397884781724709508014977694310350047592061341493108703264334924730\
        72479852348531202676178449100855692054695e-323228480",
...
fn test_agm_round() {
    ...
    test(
        ...
        "0x6.0000000000000000000000000#100",
        Floor,
        "13.458171481725615420766813156964",
...
fn test_agm_rational_prec() {
    ...
    test("22/7", "22/7", 10, "3.1445", "0x3.25#10", Greater);
    test(
        "22/7",
        "22/7",
        100,
    ...
    test("1", "2", 10, "1.4570", "0x1.750#10", Greater);
    test(
        "1",
        "2",
        100,
        "1.4567910310469068691864323832646",
        "0x1.74f041cb73dca72066c53853e#100",
        Less,
    );

    test("1", "4/3", 1, "1.0", "0x1.0#1", Less);
    test("1", "4/3", 10, "1.1602", "0x1.290#10", Less);
    test(
        "1",
        "4/3",
        100,
        "1.1606758921198568022073209830515",
        "0x1.29220e25e91091bea1ecae6de#100",
        Less,
    );

    test("4/3", "2", 1, "2.0", "0x2.0#1", Greater);
    test("4/3", "2", 10, "1.6504", "0x1.a68#10", Greater);
    test(
        "4/3",
        "2",
        100,
        "1.6497869574908696417377730690617",
        "0x1.a6587023ca668d7d15d42a6a8#100",
        Greater,
    );

    test("4/3", "22/7", 1, "2.0", "0x2.0#1", Less);
    test("4/3", "22/7", 10, "2.1406", "0x2.24#10", Less);
    test(
        "4/3",
        "22/7",
        100,
        "2.1415150879481595356885329917506",
    ...
    test("1", "1/2", 1, "0.50", "0x0.8#1", Less);
    // - x_o != Equal || y_o != Equal in agm_rational_helper
    ...
    test("1", "1/3", 1, "0.50", "0x0.8#1", Less);
    // - x_o != Equal in agm_rational_helper
    // - y_o == Equal in agm_rational_helper
    test("1/3", "1", 1, "0.50", "0x0.8#1", Less);
    // - o_lo != o_hi || agm_lo != agm_hi in agm_rational_helper
    test(
    ...
    // - o_lo == Equal in agm_rational_helper
    test("1/2", "5000001/10000000", 1, "0.50", "0x0.8#1", Less);
    // - o_hi == Equal in agm_rational_helper
    test("1/2", "4999999/10000000", 1, "0.50", "0x0.8#1", Greater);
...
fn test_agm_rational_prec_round() {
    ...
    test("22/7", "22/7", 10, Floor, "3.1406", "0x3.24#10", Less);
    test("22/7", "22/7", 10, Ceiling, "3.1445", "0x3.25#10", Greater);
    test("22/7", "22/7", 10, Down, "3.1406", "0x3.24#10", Less);
    test("22/7", "22/7", 10, Up, "3.1445", "0x3.25#10", Greater);
    test("22/7", "22/7", 10, Nearest, "3.1445", "0x3.25#10", Greater);
    ...
    test("1", "2", 10, Floor, "1.4551", "0x1.748#10", Less);
    test("1", "2", 10, Ceiling, "1.4570", "0x1.750#10", Greater);
    test("1", "2", 10, Down, "1.4551", "0x1.748#10", Less);
    test("1", "2", 10, Up, "1.4570", "0x1.750#10", Greater);
    test("1", "2", 10, Nearest, "1.4570", "0x1.750#10", Greater);
    ...
    test(
        ...
        100,
        Ceiling,
        "1.4567910310469068691864323832662",
    ...
    test("1", "4/3", 10, Floor, "1.1602", "0x1.290#10", Less);
    test("1", "4/3", 10, Ceiling, "1.1621", "0x1.298#10", Greater);
    test("1", "4/3", 10, Down, "1.1602", "0x1.290#10", Less);
    test("1", "4/3", 10, Up, "1.1621", "0x1.298#10", Greater);
    test("1", "4/3", 10, Nearest, "1.1602", "0x1.290#10", Less);
    ...
    test(
        ...
        100,
        Ceiling,
        "1.1606758921198568022073209830531",
    ...
    test("4/3", "2", 10, Floor, "1.6484", "0x1.a60#10", Less);
    test("4/3", "2", 10, Ceiling, "1.6504", "0x1.a68#10", Greater);
    test("4/3", "2", 10, Down, "1.6484", "0x1.a60#10", Less);
    test("4/3", "2", 10, Up, "1.6504", "0x1.a68#10", Greater);
    test("4/3", "2", 10, Nearest, "1.6504", "0x1.a68#10", Greater);
    ...
    test(
        ...
        100,
        Floor,
        "1.6497869574908696417377730690601",
    ...
    test("4/3", "22/7", 10, Floor, "2.1406", "0x2.24#10", Less);
    test("4/3", "22/7", 10, Ceiling, "2.1445", "0x2.25#10", Greater);
    test("4/3", "22/7", 10, Down, "2.1406", "0x2.24#10", Less);
    test("4/3", "22/7", 10, Up, "2.1445", "0x2.25#10", Greater);
    test("4/3", "22/7", 10, Nearest, "2.1406", "0x2.24#10", Less);
    ...
    test(
        ...
        100,
        Floor,
        "2.1415150879481595356885329917475",
