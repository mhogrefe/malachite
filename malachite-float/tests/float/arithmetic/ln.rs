...
fn test_ln() {
    ...
    test("123.0", "0x7b.0#7", "4.812", "0x4.d#7");
    ...
    test(
        ...
        "1.5777218104420236108234571305643e-30",
...
fn test_ln_prec() {
    ...
    test("123.0", "0x7b.0#7", 10, "4.8125", "0x4.d0#10", Greater);
    ...
    test(
        ...
        348287370023138173581890107510396301",
...
fn test_ln_round() {
    ...
    test("123.0", "0x7b.0#7", Floor, "4.750", "0x4.c#7", Less);
    test("123.0", "0x7b.0#7", Ceiling, "4.812", "0x4.d#7", Greater);
    test("123.0", "0x7b.0#7", Down, "4.750", "0x4.c#7", Less);
    test("123.0", "0x7b.0#7", Up, "4.812", "0x4.d#7", Greater);
    test("123.0", "0x7b.0#7", Nearest, "4.812", "0x4.d#7", Greater);
    ...
    test(
        ...
        "0x1.0000000000000000000000002#100",
        Ceiling,
        "1.5777218104420236108234571305656e-30",
...
fn test_ln_prec_round() {
    ...
    test("123.0", "0x7b.0#7", 10, Floor, "4.8047", "0x4.ce#10", Less);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("123.0", "0x7b.0#7", 10, Down, "4.8047", "0x4.ce#10", Less);
    test("123.0", "0x7b.0#7", 10, Up, "4.8125", "0x4.d0#10", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        10,
...
fn ln_prec_round_fail() {
    const THREE: Float = Float::const_from_unsigned(3);
    assert_panic!(Float::ONE.ln_prec_round(0, Floor));
    assert_panic!(Float::ONE.ln_prec_round_ref(0, Floor));
    assert_panic!({
        let mut x = Float::ONE;
...
fn test_ln_rational_prec() {
    ...
    test("1/2", 10, "-0.69336", "-0x0.b18#10", Less);
    test(
        "1/2",
        100,
    ...
    test("1/3", 10, "-1.0977", "-0x1.190#10", Greater);
    test(
        "1/3",
        100,
    ...
    test("22/7", 10, "1.1445", "0x1.250#10", Less);
    test(
        "22/7",
        100,
        "1.1451323043030025483738229559803",
...
fn test_ln_rational_prec_round() {
    ...
    test("1/2", 1, Down, "-0.50", "-0x0.8#1", Greater);
    test("1/2", 1, Up, "-1.0", "-0x1.0#1", Less);
    test("1/2", 1, Nearest, "-0.50", "-0x0.8#1", Greater);

    test("1/2", 10, Floor, "-0.69336", "-0x0.b18#10", Less);
    test("1/2", 10, Ceiling, "-0.69238", "-0x0.b14#10", Greater);
    test("1/2", 10, Down, "-0.69238", "-0x0.b14#10", Greater);
    test("1/2", 10, Up, "-0.69336", "-0x0.b18#10", Less);
    test("1/2", 10, Nearest, "-0.69336", "-0x0.b18#10", Less);
    ...
    test("1/3", 10, Floor, "-1.0996", "-0x1.198#10", Less);
    test("1/3", 10, Ceiling, "-1.0977", "-0x1.190#10", Greater);
    test("1/3", 10, Down, "-1.0977", "-0x1.190#10", Greater);
    test("1/3", 10, Up, "-1.0996", "-0x1.198#10", Less);
    test("1/3", 10, Nearest, "-1.0977", "-0x1.190#10", Greater);
    ...
    test("22/7", 10, Floor, "1.1445", "0x1.250#10", Less);
    test("22/7", 10, Ceiling, "1.1465", "0x1.258#10", Greater);
    test("22/7", 10, Down, "1.1445", "0x1.250#10", Less);
    test("22/7", 10, Up, "1.1465", "0x1.258#10", Greater);
    test("22/7", 10, Nearest, "1.1445", "0x1.250#10", Less);

    test(
        "22/7",
        100,
        Floor,
        "1.1451323043030025483738229559788",
...
fn test_ln_unsigned_prec_round() {
    ...
    test(2, 20, Floor, "0.69314671", "0x0.b1721#20", Less);
    test(2, 20, Ceiling, "0.69314766", "0x0.b1722#20", Greater);
    test(2, 20, Nearest, "0.69314671", "0x0.b1721#20", Less);
    // General n >= 3.
    test(3, 20, Floor, "1.0986118", "0x1.193ea#20", Less);
    test(3, 20, Ceiling, "1.0986137", "0x1.193ec#20", Greater);
    test(3, 1, Nearest, "1.0", "0x1.0#1", Less);
    test(5, 20, Nearest, "1.6094379", "0x1.9c042#20", Greater);
    test(10, 30, Floor, "2.3025850914", "0x2.4d76377#30", Less);
    test(
        100,
        40,
        Ceiling,
    ...
    test(4, 20, Floor, "1.3862934", "0x1.62e42#20", Less);
    test(4, 20, Ceiling, "1.3862953", "0x1.62e44#20", Greater);
    test(16, 10, Floor, "2.7695", "0x2.c5#10", Less);
    ...
    test(
        ...
        100,
        Nearest,
        "43.262807267168390111253400427777",
    ...
    test(
        ...
        200,
        Nearest,
        "13.815510557964274104107948728106185245606608931772637856199971",
