...
fn test_exp_x_minus_1() {
    ...
    test(
        ...
        "1.7182818284590452353602874713528",
    ...
    test("123.0", "0x7b.0#7", "2.634e53", "0x2.c0E+44#7");
...
fn test_exp_x_minus_1_prec() {
    ...
    test("1.0", "0x1.0#1", 10, "1.7188", "0x1.b80#10", Greater);
    test(
        "1.0",
        "0x1.0#1",
        53,
    ...
    test("-1.0", "-0x1.0#1", 1, "-0.50", "-0x0.8#1", Greater);
    test("-1.0", "-0x1.0#1", 10, "-0.63184", "-0x0.a1c#10", Greater);
    test(
        "-1.0",
        "-0x1.0#1",
        53,
    ...
    test("123.0", "0x7b.0#7", 1, "1.9e53", "0x2.0E+44#1", Less);
    test("123.0", "0x7b.0#7", 10, "2.6190e53", "0x2.bcE+44#10", Less);
    test(
        "123.0",
        "0x7b.0#7",
        53,
    ...
    test("0.50", "0x0.8#1", 1, "0.50", "0x0.8#1", Less);
    test("0.50", "0x0.8#1", 10, "0.64844", "0x0.a60#10", Less);
    test(
        "0.50",
        "0x0.8#1",
        53,
    ...
    test("-0.50", "-0x0.8#1", 1, "-0.50", "-0x0.8#1", Less);
    test("-0.50", "-0x0.8#1", 10, "-0.39355", "-0x0.64c#10", Less);
    test(
        "-0.50",
        "-0x0.8#1",
        53,
...
fn test_exp_x_minus_1_round() {
    ...
    test("-1.0", "-0x1.0#1", Floor, "-1.0", "-0x1.0#1", Less);
    test("-1.0", "-0x1.0#1", Ceiling, "-0.50", "-0x0.8#1", Greater);
    test("-1.0", "-0x1.0#1", Down, "-0.50", "-0x0.8#1", Greater);
    test("-1.0", "-0x1.0#1", Up, "-1.0", "-0x1.0#1", Less);
    test("-1.0", "-0x1.0#1", Nearest, "-0.50", "-0x0.8#1", Greater);
    test(
        "1.0000000000000000000000000000000",
        "0x1.0000000000000000000000000#100",
        Floor,
        "1.7182818284590452353602874713512",
    ...
    test("123.0", "0x7b.0#7", Floor, "2.604e53", "0x2.b8E+44#7", Less);
    test(
        "123.0",
        "0x7b.0#7",
        Ceiling,
    ...
    test("123.0", "0x7b.0#7", Down, "2.604e53", "0x2.b8E+44#7", Less);
    test("123.0", "0x7b.0#7", Up, "2.634e53", "0x2.c0E+44#7", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        Nearest,
    ...
    test("0.50", "0x0.8#1", Ceiling, "1.0", "0x1.0#1", Greater);
    test("0.50", "0x0.8#1", Down, "0.50", "0x0.8#1", Less);
    test("0.50", "0x0.8#1", Up, "1.0", "0x1.0#1", Greater);
    test("0.50", "0x0.8#1", Nearest, "0.50", "0x0.8#1", Less);
    test("-0.50", "-0x0.8#1", Floor, "-0.50", "-0x0.8#1", Less);
    ...
    test(
        ...
        "0x1.00000000000000000000E-23#80",
        Ceiling,
        "2.0194839173657902218540285e-28",
    ...
    test(
        ...
        "-0x1.00000000000000000000E-23#80",
        Ceiling,
        "-2.0194839173657902218540235e-28",
...
fn test_exp_x_minus_1_prec_round() {
    ...
    test("1.0", "0x1.0#1", 10, Floor, "1.7168", "0x1.b78#10", Less);
    test(
        "1.0",
        "0x1.0#1",
        10,
    ...
    test("-1.0", "-0x1.0#1", 1, Nearest, "-0.50", "-0x0.8#1", Greater);
    test(
        "-1.0",
        "-0x1.0#1",
        10,
    ...
    test("123.0", "0x7b.0#7", 1, Floor, "1.9e53", "0x2.0E+44#1", Less);
    test(
        "123.0",
        "0x7b.0#7",
        1,
    ...
    test("0.50", "0x0.8#1", 10, Floor, "0.64844", "0x0.a60#10", Less);
    test(
        "0.50",
        "0x0.8#1",
        10,
    ...
    test(
        ...
        200,
        Nearest,
        "-0.99999999999999999999999999999999999999999996279924023979164067",
...
fn test_exp_x_minus_1_rational_prec() {
    ...
    test("1", 10, "1.7188", "0x1.b80#10", Greater);
    test(
        "1",
        53,
        "1.7182818284590453",
    ...
    test("-1", 1, "-0.50", "-0x0.8#1", Greater);
    test("-1", 10, "-0.63184", "-0x0.a1c#10", Greater);
    test(
        "-1",
        53,
        "-0.63212055882855767",
    ...
    test("1/2", 10, "0.64844", "0x0.a60#10", Less);
    test(
        "1/2",
        53,
        "0.64872127070012819",
    ...
    test("-1/2", 1, "-0.50", "-0x0.8#1", Less);
    test("-1/2", 10, "-0.39355", "-0x0.64c#10", Less);
    test(
        "-1/2",
        53,
        "-0.39346934028736658",
    ...
    test("1/3", 1, "0.50", "0x0.8#1", Greater);
    test("1/3", 10, "0.39551", "0x0.654#10", Less);
    test(
        "1/3",
        53,
        "0.39561242508608951",
    ...
    test("-1/3", 10, "-0.28369", "-0x0.48a#10", Less);
    test(
        "-1/3",
        53,
        "-0.28346868942621073",
    ...
    test("22/7", 10, "22.156", "0x16.28#10", Less);
    test(
        "22/7",
        53,
        "22.169972298262479",
    ...
    test("-22/7", 10, "-0.95703", "-0x0.f50#10", Less);
    test(
        "-22/7",
        53,
        "-0.95684069073854738",
    ...
    test("2", 10, "6.3906", "0x6.64#10", Greater);
    test(
        "2",
        53,
        "6.3890560989306504",
    ...
    test("-2", 10, "-0.86426", "-0x0.dd4#10", Greater);
    test(
        "-2",
        53,
        "-0.86466471676338730",
...
fn test_exp_x_minus_1_rational_prec_round() {
    ...
    test("1", 10, Floor, "1.7168", "0x1.b78#10", Less);
    test("1", 10, Ceiling, "1.7188", "0x1.b80#10", Greater);
    test("1", 10, Nearest, "1.7188", "0x1.b80#10", Greater);
    test(
        "1",
        53,
        Floor,
    ...
    test("-1", 10, Floor, "-0.63281", "-0x0.a20#10", Less);
    test("-1", 10, Ceiling, "-0.63184", "-0x0.a1c#10", Greater);
    test("-1", 10, Nearest, "-0.63184", "-0x0.a1c#10", Greater);
    test(
        "-1",
        53,
        Floor,
    ...
    test("1/2", 10, Floor, "0.64844", "0x0.a60#10", Less);
    test("1/2", 10, Ceiling, "0.64941", "0x0.a64#10", Greater);
    test("1/2", 10, Nearest, "0.64844", "0x0.a60#10", Less);
    test(
        "1/2",
        53,
        Floor,
    ...
    test("-1/2", 1, Nearest, "-0.50", "-0x0.8#1", Less);
    test("-1/2", 10, Floor, "-0.39355", "-0x0.64c#10", Less);
    test("-1/2", 10, Ceiling, "-0.39307", "-0x0.64a#10", Greater);
    test("-1/2", 10, Nearest, "-0.39355", "-0x0.64c#10", Less);
    test(
        "-1/2",
        53,
        Floor,
    ...
    test("1/3", 1, Nearest, "0.50", "0x0.8#1", Greater);
    test("1/3", 10, Floor, "0.39551", "0x0.654#10", Less);
    test("1/3", 10, Ceiling, "0.39600", "0x0.656#10", Greater);
    test("1/3", 10, Nearest, "0.39551", "0x0.654#10", Less);
    test(
        "1/3",
        53,
        Floor,
    ...
    test("-1/3", 10, Floor, "-0.28369", "-0x0.48a#10", Less);
    test("-1/3", 10, Ceiling, "-0.28320", "-0x0.488#10", Greater);
    test("-1/3", 10, Nearest, "-0.28369", "-0x0.48a#10", Less);
    test(
        "-1/3",
        53,
        Floor,
    ...
    test("22/7", 10, Floor, "22.156", "0x16.28#10", Less);
    test("22/7", 10, Ceiling, "22.188", "0x16.30#10", Greater);
    test("22/7", 10, Nearest, "22.156", "0x16.28#10", Less);
    test(
        "22/7",
        53,
        Floor,
    ...
    test("-22/7", 10, Floor, "-0.95703", "-0x0.f50#10", Less);
    test("-22/7", 10, Ceiling, "-0.95605", "-0x0.f4c#10", Greater);
    test("-22/7", 10, Nearest, "-0.95703", "-0x0.f50#10", Less);
    test(
        "-22/7",
        53,
        Floor,
    ...
    test("2", 10, Floor, "6.3828", "0x6.62#10", Less);
    test("2", 10, Ceiling, "6.3906", "0x6.64#10", Greater);
    test("2", 10, Nearest, "6.3906", "0x6.64#10", Greater);
    test(
        "2",
        53,
        Floor,
    ...
    test("-2", 10, Floor, "-0.86523", "-0x0.dd8#10", Less);
    test("-2", 10, Ceiling, "-0.86426", "-0x0.dd4#10", Greater);
    test("-2", 10, Nearest, "-0.86426", "-0x0.dd4#10", Greater);
    test(
        "-2",
        53,
        Floor,
    ...
    test("262144/63", 2, Nearest, "1.2e1807", "0x8.0E+1500#2", Less);
