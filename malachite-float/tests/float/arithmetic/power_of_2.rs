...
use malachite_float::test_util::float::arithmetic::shl_round::rug_shl_prec_round_signed;
...
fn test_power_of_2_prec_round() {
    ...
    test(100, 1, Down, "1.3e30", "0x1.0E+25#1", Equal);
    test(100, 1, Up, "1.3e30", "0x1.0E+25#1", Equal);
    test(100, 1, Nearest, "1.3e30", "0x1.0E+25#1", Equal);
    test(100, 1, Exact, "1.3e30", "0x1.0E+25#1", Equal);
    ...
    test(
        ...
        100,
        Floor,
        "1.0492893582336938462021790584419e323228496",
    ...
    test(-1, 1, Down, "0.50", "0x0.8#1", Equal);
    test(-1, 1, Up, "0.50", "0x0.8#1", Equal);
    ...
    test(-100, 1, Down, "7.9e-31", "0x1.0E-25#1", Equal);
    test(-100, 1, Up, "7.9e-31", "0x1.0E-25#1", Equal);
    test(-100, 1, Nearest, "7.9e-31", "0x1.0E-25#1", Equal);
    test(-100, 1, Exact, "7.9e-31", "0x1.0E-25#1", Equal);
...
fn test_power_of_2_prec() {
    ...
    test(1073741822, 1, "1.0e323228496", "0x4.0E+268435455#1", Equal);
...
fn test_power_of_2() {
    ...
    test(2, "4.0", "0x4.0#1");
    test(3, "8.0", "0x8.0#1");
    test(1073741822, "1.0e323228496", "0x4.0E+268435455#1");
    test(1073741823, "Infinity", "Infinity");

    test(-1, "0.50", "0x0.8#1");
    test(-2, "0.25", "0x0.4#1");
    test(-3, "0.12", "0x0.2#1");
    test(-100, "7.9e-31", "0x1.0E-25#1");
    test(-1073741824, "2.4e-323228497", "0x1.0E-268435456#1");
