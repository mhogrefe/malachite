...
use malachite_float::test_util::float::arithmetic::log_base_rational_float_base::{
...
#[test]
fn log_base_rational_float_base_exact_extreme() {
    ...
    let (v, o) = Float::log_base_rational_float_base_prec_round_ref(
        &Rational::from(3u32),
        &base,
        1,
        Nearest,
