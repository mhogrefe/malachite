...
fn test_sign() {
    ...
    test("1.0e323228496", "0x4.0E+268435455#1", Greater);
    test("2.4e-323228497", "0x1.0E-268435456#1", Greater);

    test("-1.0", "-0x1.0#1", Less);
    test("-2.0", "-0x2.0#1", Less);
    test("-0.50", "-0x0.8#1", Less);
    ...
    test("-1.0e323228496", "-0x4.0E+268435455#1", Less);
    test("-2.4e-323228497", "-0x1.0E-268435456#1", Less);
}
