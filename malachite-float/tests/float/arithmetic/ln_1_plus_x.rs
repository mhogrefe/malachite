...
fn test_ln_1_plus_x() {
    ...
    test(
        ...
        "0.6931471805599453094172321214580",
...
fn test_ln_1_plus_x_prec() {
    ...
    test("-0.0", "-0x0.0", 1, "-0.0", "-0x0.0", Equal);
    test("1.0", "0x1.0#1", 1, "0.50", "0x0.8#1", Less);
    test("1.0", "0x1.0#1", 10, "0.69336", "0x0.b18#10", Greater);
    ...
    test("123.0", "0x7b.0#7", 10, "4.8203", "0x4.d2#10", Greater);
    ...
    test(
        ...
        32395755512381469195593605349485177",
    ...
    test("0.9999981", "0x0.ffffe#19", 5, "0.688", "0x0.b0#5", Less);
    test(
        "-2.95743180400093333358289490283877742117288231437356919548037901224267659757579198067534\
        853744487777959630293358133344498497948374362420688651916223348101097330006067468348405744\
        798418856719110103444687889001023465258101302374308317446896267015636676599715135536816552\
        1987252397717902601737261358444741630877182079463887802622594575682704496936273799624e-94",
        "-0x2.77b41f156076e3dc62be2ba8843a784d62aa61a62934cd428dd0fbff8909abd43acc2993acbee706b7aa\
        575810e80186799e69118298d1b03ab761dd712a6fd84149db7cd92fc3416cdc078c5a9d72547e6ca8335eddee\
        102dfa177ea2449b356b1f7ed97500d2e71761cc4669405092845aded0d148a93463dfe59f77fec1f64f4ce04f\
        6988fb2292ba57569896fd94650E-78#1163",
        343,
        "-2.95743180400093333358289490283877742117288231437356919548037901224267659757579198067534\
        853744531509973997e-94",
        "-0x2.77b41f156076e3dc62be2ba8843a784d62aa61a62934cd428dd0fbff8909abd43acc2993acbeea121c62\
        50E-78#343",
        Greater,
    );
}
...
fn test_ln_1_plus_x_round() {
    ...
    test("1.0", "0x1.0#1", Floor, "0.50", "0x0.8#1", Less);
    test("1.0", "0x1.0#1", Ceiling, "1.0", "0x1.0#1", Greater);
    test("1.0", "0x1.0#1", Down, "0.50", "0x0.8#1", Less);
    test("1.0", "0x1.0#1", Up, "1.0", "0x1.0#1", Greater);
    test("1.0", "0x1.0#1", Nearest, "0.50", "0x0.8#1", Less);
    ...
    test("123.0", "0x7b.0#7", Floor, "4.812", "0x4.d#7", Less);
    test("123.0", "0x7b.0#7", Ceiling, "4.875", "0x4.e#7", Greater);
    test("123.0", "0x7b.0#7", Down, "4.812", "0x4.d#7", Less);
    test("123.0", "0x7b.0#7", Up, "4.875", "0x4.e#7", Greater);
    test("123.0", "0x7b.0#7", Nearest, "4.812", "0x4.d#7", Less);
    ...
    test(
        ...
        "0x1.0000000000000000000000002#100",
        Ceiling,
        "0.69314718055994530941723212145956",
    ...
    test(
        ...
        "0x0.ffffffffffffffffffffffffe#99",
        Floor,
        "0.6931471805599453094172321214564",
...
fn test_ln_1_plus_x_prec_round() {
    ...
    test("1.0", "0x1.0#1", 10, Floor, "0.69238", "0x0.b14#10", Less);
    test(
        "1.0",
        "0x1.0#1",
        10,
    ...
    test("1.0", "0x1.0#1", 10, Down, "0.69238", "0x0.b14#10", Less);
    test("1.0", "0x1.0#1", 10, Up, "0.69336", "0x0.b18#10", Greater);
    test(
        "1.0",
        "0x1.0#1",
        10,
    ...
    test("123.0", "0x7b.0#7", 10, Floor, "4.8125", "0x4.d0#10", Less);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("123.0", "0x7b.0#7", 10, Down, "4.8125", "0x4.d0#10", Less);
    test("123.0", "0x7b.0#7", 10, Up, "4.8203", "0x4.d2#10", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("-0.094", "-0x0.18#2", 1, Nearest, "-0.12", "-0x0.2#1", Less);
    // - round_near_x halfway case, error toward zero
    test("0.047", "0x0.0c#2", 1, Nearest, "0.031", "0x0.08#1", Less);
    // - 1 + x overflows to infinity, ln(x) used instead
    test(
        "2.0985787145e323228496",
    ...
    test("-0.062", "-0x0.1#1", 1, Up, "-0.12", "-0x0.2#1", Less);
    // - round_near_x exact-copy case, rounding toward zero steps the result
    test("0.031", "0x0.08#1", 1, Down, "0.016", "0x0.04#1", Less);
    // - round_near_x exact-copy case, error away from zero, no step needed
    test(
        "-0.062", "-0x0.1#1", 1, Nearest, "-0.062", "-0x0.1#1", Greater,
    );
