...
use malachite_float::float::arithmetic::power_of_2_x_minus_1::{
...
use malachite_float::test_util::float::arithmetic::power_of_2_x_minus_1::{
...
fn test_power_of_2_x_minus_1() {
    ...
    test("123.0", "0x7b.0#7", "1.063e37", "0x8.0E+30#7");
    test("-123.0", "-0x7b.0#7", "-1.000", "-0x1.00#7");
    test("0.50", "0x0.8#1", "0.50", "0x0.8#1");
    test("-0.50", "-0x0.8#1", "-0.25", "-0x0.4#1");
    test("-100.0", "-0x64.0#7", "-1.000", "-0x1.00#7");
    test("-1000.0", "-0x3e8.0#10", "-1.0000", "-0x1.000#10");
    test(
        "2.0194839173657902218540251e-28",
        "0x1.00000000000000000000E-23#80",
        "1.3997995835082510677222038e-28",
...
fn test_power_of_2_x_minus_1_prec() {
    ...
    test("-1.0", "-0x1.0#1", 1, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", 10, "-0.50000", "-0x0.800#10", Equal);
    test(
        "-1.0",
        "-0x1.0#1",
        53,
    ...
    test("123.0", "0x7b.0#7", 1, "1.1e37", "0x8.0E+30#1", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        10,
    ...
    test("-123.0", "-0x7b.0#7", 10, "-1.0000", "-0x1.000#10", Less);
    test(
        "-123.0",
        "-0x7b.0#7",
        53,
    ...
    test("0.50", "0x0.8#1", 1, "0.50", "0x0.8#1", Greater);
    test("0.50", "0x0.8#1", 10, "0.41406", "0x0.6a0#10", Less);
    test(
        "0.50",
        "0x0.8#1",
        53,
    ...
    test("-0.50", "-0x0.8#1", 1, "-0.25", "-0x0.4#1", Greater);
    test("-0.50", "-0x0.8#1", 10, "-0.29297", "-0x0.4b0#10", Less);
    test(
        "-0.50",
        "-0x0.8#1",
        53,
    ...
    test("-100.0", "-0x64.0#7", 10, "-1.0000", "-0x1.000#10", Less);
    test(
        "-100.0",
        "-0x64.0#7",
        53,
    ...
    test("-1000.0", "-0x3e8.0#10", 10, "-1.0000", "-0x1.000#10", Less);
    test(
        "-1000.0",
        "-0x3e8.0#10",
        53,
...
fn test_power_of_2_x_minus_1_round() {
    ...
    test("-1.0", "-0x1.0#1", Floor, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", Ceiling, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", Down, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", Up, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", Nearest, "-0.50", "-0x0.8#1", Equal);
    test(
        "1.0000000000000000000000000000000",
        "0x1.0000000000000000000000000#100",
        Floor,
    ...
    test("123.0", "0x7b.0#7", Up, "1.063e37", "0x8.0E+30#7", Greater);
    test(
        "123.0",
        "0x7b.0#7",
        Nearest,
    ...
    test("-123.0", "-0x7b.0#7", Floor, "-1.000", "-0x1.00#7", Less);
    test(
        "-123.0",
        "-0x7b.0#7",
        Ceiling,
    ...
    test("-123.0", "-0x7b.0#7", Down, "-0.9922", "-0x0.fe#7", Greater);
    test("-123.0", "-0x7b.0#7", Up, "-1.000", "-0x1.00#7", Less);
    test("-123.0", "-0x7b.0#7", Nearest, "-1.000", "-0x1.00#7", Less);
    test("0.50", "0x0.8#1", Floor, "0.25", "0x0.4#1", Less);
    test("0.50", "0x0.8#1", Ceiling, "0.50", "0x0.8#1", Greater);
    test("0.50", "0x0.8#1", Down, "0.25", "0x0.4#1", Less);
    test("0.50", "0x0.8#1", Up, "0.50", "0x0.8#1", Greater);
    test("0.50", "0x0.8#1", Nearest, "0.50", "0x0.8#1", Greater);
    test("-0.50", "-0x0.8#1", Floor, "-0.50", "-0x0.8#1", Less);
    test("-0.50", "-0x0.8#1", Ceiling, "-0.25", "-0x0.4#1", Greater);
    test("-0.50", "-0x0.8#1", Down, "-0.25", "-0x0.4#1", Greater);
    test("-0.50", "-0x0.8#1", Up, "-0.50", "-0x0.8#1", Less);
    test("-0.50", "-0x0.8#1", Nearest, "-0.25", "-0x0.4#1", Greater);
    test("-100.0", "-0x64.0#7", Floor, "-1.000", "-0x1.00#7", Less);
    test(
        "-100.0",
        "-0x64.0#7",
        Ceiling,
    ...
    test("-100.0", "-0x64.0#7", Down, "-0.9922", "-0x0.fe#7", Greater);
    test("-100.0", "-0x64.0#7", Up, "-1.000", "-0x1.00#7", Less);
    test("-100.0", "-0x64.0#7", Nearest, "-1.000", "-0x1.00#7", Less);
    test(
        "-1000.0",
        "-0x3e8.0#10",
        Floor,
    ...
    test("-1000.0", "-0x3e8.0#10", Up, "-1.0000", "-0x1.000#10", Less);
    test(
        "-1000.0",
        "-0x3e8.0#10",
        Nearest,
    ...
    test(
        ...
        "0x1.00000000000000000000E-23#80",
        Floor,
        "1.3997995835082510677222021e-28",
...
fn test_power_of_2_x_minus_1_prec_round() {
    ...
    test("-1.0", "-0x1.0#1", 1, Floor, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", 1, Ceiling, "-0.50", "-0x0.8#1", Equal);
    test("-1.0", "-0x1.0#1", 1, Nearest, "-0.50", "-0x0.8#1", Equal);
    test(
        "-1.0",
        "-0x1.0#1",
        10,
    ...
    test("123.0", "0x7b.0#7", 1, Floor, "5.3e36", "0x4.0E+30#1", Less);
    test(
        "123.0",
        "0x7b.0#7",
        1,
    ...
    test("0.50", "0x0.8#1", 1, Floor, "0.25", "0x0.4#1", Less);
    test("0.50", "0x0.8#1", 1, Ceiling, "0.50", "0x0.8#1", Greater);
    test("0.50", "0x0.8#1", 1, Nearest, "0.50", "0x0.8#1", Greater);
    test("0.50", "0x0.8#1", 10, Floor, "0.41406", "0x0.6a0#10", Less);
    test(
        "0.50",
        "0x0.8#1",
        10,
    ...
    test(
        "-0.50", "-0x0.8#1", 1, Ceiling, "-0.25", "-0x0.4#1", Greater,
    );
    test(
        "-0.50", "-0x0.8#1", 1, Nearest, "-0.25", "-0x0.4#1", Greater,
    );
    test(
        "-0.50",
        "-0x0.8#1",
    ...
    test(
        ...
        200,
        Nearest,
        "-0.99999999999999999999999999999921113909477898819458827143471721",
    ...
    test("3.0", "0x3.0#2", 10, Exact, "7.0000", "0x7.00#10", Equal);
    test(
        "6.0",
        "0x6.0#3",
        20,
...
fn power_of_2_x_minus_1_prec_round_properties_helper(x: Float, prec: u64, rm: RoundingMode) {
    let (power_of_2_x_minus_1, o) = x.clone().power_of_2_x_minus_1_prec_round(prec, rm);
    assert!(power_of_2_x_minus_1.is_valid());
    assert_rounding_ordering_consistent(&power_of_2_x_minus_1, rm, o);
...
fn test_power_of_2_x_minus_1_rational_prec() {
    ...
    test("1", 53, "1.0000000000000000", "0x1.0000000000000#53", Equal);
    test("3", 1, "8.0", "0x8.0#1", Greater);
    test("3", 10, "7.0000", "0x7.00#10", Equal);
    test("3", 53, "7.0000000000000000", "0x7.0000000000000#53", Equal);
    ...
    test("-1/2", 1, "-0.25", "-0x0.4#1", Greater);
    test("-1/2", 10, "-0.29297", "-0x0.4b0#10", Less);
    test(
        "-1/2",
        53,
        "-0.29289321881345248",
    ...
    test("1/3", 10, "0.25977", "0x0.428#10", Less);
    test(
        "1/3",
        53,
        "0.25992104989487319",
    ...
    test("-1/3", 1, "-0.25", "-0x0.4#1", Less);
    test("-1/3", 10, "-0.20630", "-0x0.34d#10", Greater);
    test(
        "-1/3",
        53,
        "-0.20629947401590026",
    ...
    test("22/7", 10, "7.8359", "0x7.d6#10", Greater);
    test(
        "22/7",
        53,
        "7.8327161093904989",
    ...
    test("-22/7", 10, "-0.88672", "-0x0.e30#10", Greater);
    test(
        "-22/7",
        53,
        "-0.88678454196701162",
    ...
    test("100", 1, "1.3e30", "0x1.0E+25#1", Greater);
    test("100", 10, "1.2677e30", "0x1.000E+25#10", Greater);
    test(
        "100",
        53,
    ...
    test("-100", 10, "-1.0000", "-0x1.000#10", Less);
    test(
        "-100",
        53,
        "-1.0000000000000000",
...
fn test_power_of_2_x_minus_1_rational_prec_round() {
    ...
    test("3", 10, Floor, "7.0000", "0x7.00#10", Equal);
    test("3", 10, Ceiling, "7.0000", "0x7.00#10", Equal);
    test("3", 10, Nearest, "7.0000", "0x7.00#10", Equal);
    test("3", 10, Exact, "7.0000", "0x7.00#10", Equal);
    test(
        "3",
        53,
        Floor,
        "7.0000000000000000",
        "0x7.0000000000000#53",
        Equal,
    );
    test(
        "3",
    ...
    test("-2", 10, Floor, "-0.75000", "-0x0.c00#10", Equal);
    test("-2", 10, Ceiling, "-0.75000", "-0x0.c00#10", Equal);
    test("-2", 10, Nearest, "-0.75000", "-0x0.c00#10", Equal);
    test("-2", 10, Exact, "-0.75000", "-0x0.c00#10", Equal);
    test(
        "-2",
        53,
        Floor,
    ...
    test("1/2", 10, Floor, "0.41406", "0x0.6a0#10", Less);
    test("1/2", 10, Ceiling, "0.41455", "0x0.6a2#10", Greater);
    test("1/2", 10, Nearest, "0.41406", "0x0.6a0#10", Less);
    test(
        "1/2",
        53,
        Floor,
    ...
    test("-1/2", 1, Nearest, "-0.25", "-0x0.4#1", Greater);
    test("-1/2", 10, Floor, "-0.29297", "-0x0.4b0#10", Less);
    test("-1/2", 10, Ceiling, "-0.29248", "-0x0.4ae#10", Greater);
    test("-1/2", 10, Nearest, "-0.29297", "-0x0.4b0#10", Less);
    test(
        "-1/2",
        53,
        Floor,
    ...
    test("1/3", 10, Floor, "0.25977", "0x0.428#10", Less);
    test("1/3", 10, Ceiling, "0.26025", "0x0.42a#10", Greater);
    test("1/3", 10, Nearest, "0.25977", "0x0.428#10", Less);
    test(
        "1/3",
        53,
        Floor,
    ...
    test("-1/3", 1, Nearest, "-0.25", "-0x0.4#1", Less);
    test("-1/3", 10, Floor, "-0.20654", "-0x0.34e#10", Less);
    test("-1/3", 10, Ceiling, "-0.20630", "-0x0.34d#10", Greater);
    test("-1/3", 10, Nearest, "-0.20630", "-0x0.34d#10", Greater);
    test(
        "-1/3",
        53,
        Floor,
    ...
    test("22/7", 10, Floor, "7.8281", "0x7.d4#10", Less);
    test("22/7", 10, Ceiling, "7.8359", "0x7.d6#10", Greater);
    test("22/7", 10, Nearest, "7.8359", "0x7.d6#10", Greater);
    test(
        "22/7",
        53,
        Floor,
    ...
    test("-22/7", 10, Floor, "-0.88770", "-0x0.e34#10", Less);
    test("-22/7", 10, Ceiling, "-0.88672", "-0x0.e30#10", Greater);
    test("-22/7", 10, Nearest, "-0.88672", "-0x0.e30#10", Greater);
    test(
        "-22/7",
        53,
        Floor,
    ...
    test("100", 1, Floor, "6.3e29", "0x8.0E+24#1", Less);
    test("100", 1, Ceiling, "1.3e30", "0x1.0E+25#1", Greater);
    test("100", 1, Nearest, "1.3e30", "0x1.0E+25#1", Greater);
    test("100", 10, Floor, "1.2664e30", "0xf.fcE+24#10", Less);
    test("100", 10, Ceiling, "1.2677e30", "0x1.000E+25#10", Greater);
    test("100", 10, Nearest, "1.2677e30", "0x1.000E+25#10", Greater);
    test(
        "100",
        53,
        Floor,
