...
use malachite_float::test_util::float::constants::one_over_pi::one_over_pi_prec_round_simple;
...
fn one_over_pi_prec_properties() {
    unsigned_gen_var_11().test_properties(|prec| {
        ...
        assert_rounding_ordering_consistent(&one_over_pi, Nearest, o);
...
fn one_over_pi_prec_round_properties() {
    unsigned_rounding_mode_pair_gen_var_4().test_properties(|(prec, rm)| {
        ...
        assert!(one_over_pi.is_valid());
        assert_rounding_ordering_consistent(&one_over_pi, rm, o);
        assert_eq!(one_over_pi.get_prec(), Some(prec));
        assert_eq!(
