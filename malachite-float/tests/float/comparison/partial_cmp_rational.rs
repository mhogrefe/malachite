...
use malachite_float::test_util::float::comparison::partial_cmp_rational::*;
...
fn test_partial_cmp_rational() {
    ...
    test("0.50", "0x0.8#1", "1/2", Some(Equal));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "1/2",
    ...
    test("2.6e120", "0x1.0E+100#1", "1/2", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "1/2", Some(Less));
    test("-1.0", "-0x1.0#1", "1/2", Some(Less));
    test("-2.0", "-0x2.0#1", "1/2", Some(Less));
    test("-0.50", "-0x0.8#1", "1/2", Some(Less));
    test(
        "-0.33333333333333331",
        "-0x0.55555555555554#53",
        "1/2",
    ...
    test("-2.6e120", "-0x1.0E+100#1", "1/2", Some(Less));
    test("-3.9e-121", "-0x1.0E-100#1", "1/2", Some(Less));
    ...
    test("0.50", "0x0.8#1", "1/3", Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "1/3",
    ...
    test("2.6e120", "0x1.0E+100#1", "1/3", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "1/3", Some(Less));
    test("-1.0", "-0x1.0#1", "1/3", Some(Less));
    test("-2.0", "-0x2.0#1", "1/3", Some(Less));
    test("-0.50", "-0x0.8#1", "1/3", Some(Less));
    test(
        "-0.33333333333333331",
        "-0x0.55555555555554#53",
        "1/3",
    ...
    test("-2.6e120", "-0x1.0E+100#1", "1/3", Some(Less));
    test("-3.9e-121", "-0x1.0E-100#1", "1/3", Some(Less));
    ...
    test("0.50", "0x0.8#1", "22/7", Some(Less));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "22/7",
    ...
    test("2.6e120", "0x1.0E+100#1", "22/7", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "22/7", Some(Less));
    test("-1.0", "-0x1.0#1", "22/7", Some(Less));
    test("-2.0", "-0x2.0#1", "22/7", Some(Less));
    test("-0.50", "-0x0.8#1", "22/7", Some(Less));
    test(
    ...
    test("-2.6e120", "-0x1.0E+100#1", "22/7", Some(Less));
    test("-3.9e-121", "-0x1.0E-100#1", "22/7", Some(Less));
    ...
    test("2.0", "0x2.0#1", "-1", Some(Greater));
    test("0.50", "0x0.8#1", "-1", Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "-1",
    ...
    test("2.6e120", "0x1.0E+100#1", "-1", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "-1", Some(Greater));
    test("-1.0", "-0x1.0#1", "-1", Some(Equal));
    test("-2.0", "-0x2.0#1", "-1", Some(Less));
    test("-0.50", "-0x0.8#1", "-1", Some(Greater));
    test(
    ...
    test("0.50", "0x0.8#1", "-100", Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "-100",
    ...
    test("2.6e120", "0x1.0E+100#1", "-100", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "-100", Some(Greater));
    test("-1.0", "-0x1.0#1", "-100", Some(Greater));
    test("-2.0", "-0x2.0#1", "-100", Some(Greater));
    test("-0.50", "-0x0.8#1", "-100", Some(Greater));
    test(
    ...
    test("0.50", "0x0.8#1", s, Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        s,
    ...
    test("2.6e120", "0x1.0E+100#1", s, Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", s, Some(Greater));
    test("-1.0", "-0x1.0#1", s, Some(Greater));
    test("-2.0", "-0x2.0#1", s, Some(Greater));
    test("-0.50", "-0x0.8#1", s, Some(Greater));
    test(
    ...
    test("1.0", "0x1.0#1", "-1/2", Some(Greater));
    test("2.0", "0x2.0#1", "-1/2", Some(Greater));
    test("0.50", "0x0.8#1", "-1/2", Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "-1/2",
    ...
    test("2.6e120", "0x1.0E+100#1", "-1/2", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "-1/2", Some(Greater));
    test("-1.0", "-0x1.0#1", "-1/2", Some(Less));
    test("-2.0", "-0x2.0#1", "-1/2", Some(Less));
    test("-0.50", "-0x0.8#1", "-1/2", Some(Equal));
    test(
    ...
    test("2.6e120", "0x1.0E+100#1", "-1/3", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "-1/3", Some(Greater));
    test("-1.0", "-0x1.0#1", "-1/3", Some(Less));
    test("-2.0", "-0x2.0#1", "-1/3", Some(Less));
    test("-0.50", "-0x0.8#1", "-1/3", Some(Less));
    test(
    ...
    test("0.50", "0x0.8#1", "-22/7", Some(Greater));
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "-22/7",
    ...
    test("2.6e120", "0x1.0E+100#1", "-22/7", Some(Greater));
    test("3.9e-121", "0x1.0E-100#1", "-22/7", Some(Greater));
    test("-1.0", "-0x1.0#1", "-22/7", Some(Greater));
    test("-2.0", "-0x2.0#1", "-22/7", Some(Greater));
    test("-0.50", "-0x0.8#1", "-22/7", Some(Greater));
    test(
