...
fn test_partial_eq_rational() {
    ...
    test("2.6e120", "0x1.0E+100#1", "0", false);
    test("3.9e-121", "0x1.0E-100#1", "0", false);
    test("-1.0", "-0x1.0#1", "0", false);
    test("-2.0", "-0x2.0#1", "0", false);
    test("-0.50", "-0x0.8#1", "0", false);
    test("-0.33333333333333331", "-0x0.55555555555554#53", "0", false);
    ...
    test("2.6e120", "0x1.0E+100#1", "1", false);
    test("3.9e-121", "0x1.0E-100#1", "1", false);
    ...
    test("2.6e120", "0x1.0E+100#1", "100", false);
    test("3.9e-121", "0x1.0E-100#1", "100", false);
    test("-1.0", "-0x1.0#1", "100", false);
    test("-2.0", "-0x2.0#1", "100", false);
    test("-0.50", "-0x0.8#1", "100", false);
    test(
    ...
    test("2.6e120", "0x1.0E+100#1", s, true);
    test("3.9e-121", "0x1.0E-100#1", s, false);
    test("-1.0", "-0x1.0#1", s, false);
    test("-2.0", "-0x2.0#1", s, false);
    test("-0.50", "-0x0.8#1", s, false);
    test("-0.33333333333333331", "-0x0.55555555555554#53", s, false);
    test("-1.4142135623730951", "-0x1.6a09e667f3bcd#53", s, false);
    test("-3.1415926535897931", "-0x3.243f6a8885a30#53", s, false);
    test("-2.6e120", "-0x1.0E+100#1", s, false);
    test("-3.9e-121", "-0x1.0E-100#1", s, false);
    ...
    test("2.6e120", "0x1.0E+100#1", "1/2", false);
    test("3.9e-121", "0x1.0E-100#1", "1/2", false);
    test("-1.0", "-0x1.0#1", "1/2", false);
    test("-2.0", "-0x2.0#1", "1/2", false);
    test("-0.50", "-0x0.8#1", "1/2", false);
    test(
        "-0.33333333333333331",
        "-0x0.55555555555554#53",
        "1/2",
    ...
    test("2.6e120", "0x1.0E+100#1", "1/3", false);
    test("3.9e-121", "0x1.0E-100#1", "1/3", false);
    test("-1.0", "-0x1.0#1", "1/3", false);
    test("-2.0", "-0x2.0#1", "1/3", false);
    test("-0.50", "-0x0.8#1", "1/3", false);
    test(
    ...
    test("2.6e120", "0x1.0E+100#1", "22/7", false);
    test("3.9e-121", "0x1.0E-100#1", "22/7", false);
    test("-1.0", "-0x1.0#1", "22/7", false);
    test("-2.0", "-0x2.0#1", "22/7", false);
    test("-0.50", "-0x0.8#1", "22/7", false);
    test(
