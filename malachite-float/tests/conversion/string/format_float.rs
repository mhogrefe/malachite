...
fn test_format_float() {
    ...
    test("-0.2", "-0x0.4#1", b'b', -1, 0, Nearest, "-1p-2");
    // specials
    ...
    test("0.5", "0x0.8#1", b'f', 1, 0, Exact, "0.5");
...
fn test_format_float_coverage() {
    ...
    t("-4.928e-6", "-0x0.000052ac#13", "%#0 '.3RYf", "-0.001");
    // covers: fg_norm_none
    t(
        "-0.004634709256163010258486857901782625",
    ...
    t(
        "-1.186240692198059556156521169090488629720179655055e-18",
    ...
    // covers: ab_p0_b2
    t("-35204969.28", "-0x2192f69.48#33", "%#'1.0RZb", "-1.p+25");
    // covers: ab_p0_npb nbp_away
    t(
        "-1.3223487942613547710040294289413868633204315585992132869865967e-14",
    ...
    // covers: pn_g_thresh1
    t(
        "-8.05470337130347150798086293427e-11",
    ...
    t("8.829e30", "0x6.f70E+25#13", "%0+ 1.4RNg", "+8.829e+30");
    // covers: fg_ge1_alt
    t(
    ...
    t("9.5", "0x9.8#5", "%.0RUf", "10");
    // covers: bs_rgt
    t("9.5", "0x9.8#5", "%'.0RUf", "10");
    // covers: bs_last
    t("9999.5", "0x270f.8#16", "%'.0RUf", "10,000");
    // covers: eg_addtz
    t(
        "8.0e-6",
        "0x0.00008#1",
