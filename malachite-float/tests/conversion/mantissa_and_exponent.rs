...
fn test_sci_mantissa_and_exponent_round() {
    ...
    test::<f32>("3.1415926535897931", "0x3.243f6a8885a3#50", Exact, "None");
...
fn test_raw_mantissa_and_exponent() {
    ...
    test("0.50", "0x0.8#1", "9223372036854775808", 0);
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
...
fn test_from_raw_mantissa_and_exponent() {
    ...
    test("9223372036854775808", 0, "0.50", "0x0.8#1");
    test(
        "12297829382473033728",
        -1,
        "0.33333333333333331",
...
fn test_integer_mantissa_and_exponent() {
    ...
    test("1.0e323228496", "0x4.0E+268435455#1", "1", 1073741822);
    test("2.4e-323228497", "0x1.0E-268435456#1", "1", -1073741824);
    test(
        "2.382564914e-323228497",
...
fn test_from_integer_mantissa_and_exponent() {
    ...
    test("1", -1, Some("0.50"), Some("0x0.8#1"));
    test("2", -1, Some("1.0"), Some("0x1.0#1"));
    test("2", 0, Some("2.0"), Some("0x2.0#1"));
    test("2", -2, Some("0.50"), Some("0x0.8#1"));
    test(
        "6004799503160661",
        -54,
...
fn test_sci_mantissa_and_exponent_float() {
    ...
    test("0.50", "0x0.8#1", "1.0", "0x1.0#1", -1);
    test(
        "0.33333333333333331",
        "0x0.55555555555554#53",
        "1.3333333333333333",
    ...
    test("123.0", "0x7b.0#7", "1.922", "0x1.ec#7", 6);
    test(
        "1000000000000.0",
        "0xe8d4a51000.0#40",
        "1.8189894035459",
...
fn test_from_sci_mantissa_and_exponent_float() {
    ...
    test("1.0", "0x1.0#1", -1, Some("0.50"), Some("0x0.8#1"));
    test(
        "1.3333333333333333",
        "0x1.5555555555555#53",
        -2,
    ...
    test("1.922", "0x1.ec#7", 6, Some("123.0"), Some("0x7b.0#7"));
    test(
        "1.8189894035459",
        "0x1.d1a94a2000#40",
        39,
...
fn test_sci_mantissa_and_exponent_primitive_float() {
    ...
    test::<f32>("3.1415926535897931", "0x3.243f6a8885a3#50", "1.5707964", 1);
    ...
    test::<f32>("1.0e323228496", "0x4.0E+268435455#1", "1.0", 1073741822);
    test::<f32>("2.4e-323228497", "0x1.0E-268435456#1", "1.0", -1073741824);
...
fn test_from_sci_mantissa_and_exponent_primitive_float() {
    ...
    test::<f32>(1.0, -1, Some("0.50"), Some("0x0.8#1"));
    test::<f32>(1.3333334, -2, Some("0.333333343"), Some("0x0.5555558#24"));
    test::<f32>(1.921875, 6, Some("123.0"), Some("0x7b.0#7"));
    test::<f32>(
        1.8189894,
        39,
        Some("9.99999996e11"),
        Some("0xe.8d4a5E+9#24"),
    );
    test::<f32>(
    ...
    test::<f32>(1.5707964, 1, Some("3.14159274"), Some("0x3.243f6c#24"));
    test::<f32>(1.3591409, 1, Some("2.7182817"), Some("0x2.b7e15#22"));
    test::<f32>(
        1.6543612,
        79,
        Some("1.0000000e24"),
        Some("0xd.3c21cE+19#22"),
    );
    test(
        1.0,
        1073741822,
    ...
    test::<f64>(1.0, -1, Some("0.50"), Some("0x0.8#1"));
    test::<f64>(
        1.3333333333333333,
        -2,
        Some("0.33333333333333331"),
