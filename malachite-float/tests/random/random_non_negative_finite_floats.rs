...
fn test_random_non_negative_finite_floats() {
    ...
    let values = &[
        "4.0", "0.5", "0.4", "0.0", "2.0", "1.0", "0.5", "1.0", "0.4", "0.4768", "1.0", "2.0e1",
        "0.2", "0.0", "0.5", "1.0", "0.2", "0.0", "0.8", "0.06",
    ];
    let values_hex = &[
        "0x4.0#1",
        "0x0.8#1",
    ...
    let values = &[
        "4.144308077744403550616141150370317468621115137736547973628030646292333656063846976762609\
        516719551",
        "0.5",
        "0.3325796124",
        "0.0",
    ...
    let sample_median = (
        "0.656335890592859991893",
        Some("0.65634095145149450716439926007140230894810329586001204"),
    );
    let sample_median_hex = (
        "0x0.a805a1014990ee3f6#67",
        Some("0x0.a805f5e9827b377dc6bd240f77b2cd68b8ac0f0a6f54#175"),
    );
    let sample_moment_stats = MomentStats {
    ...
    let values = &[
        "5.0e8", "1.0e-6", "1.0e1", "0.0", "2.0e-7", "0.03", "4.0e22", "4.0e19", "0.023", "3.2e7",
        "9.0e37", "4.0e-9", "1.0e15", "0.0", "1.0e11", "7.0e-9", "3.0e14", "0.0", "0.023",
        "1.0e-34",
    ];
    let values_hex = &[
        "0x2.0E+7#1",
    ...
    let sample_median_hex = ("0x0.00c#3", Some("0x0.00c#4"));
    let sample_moment_stats = MomentStats {
    ...
    let values = &[
        "556239614.3269012092788314653300103692770373666134065315833581904597286471348229641607462\
        4468527615",
        "1.0e-6",
        "10.642547596",
        "0.0",
    ...
    let sample_median = ("0.003723741", Some("0.0037239916472"));
    let sample_median_hex = ("0x0.00f40a00#21", Some("0x0.00f40e3655e#35"));
    let sample_moment_stats = MomentStats {
