...
fn test_random_positive_finite_floats() {
    ...
    let values = &[
        "0.8", "0.5", "1.0", "0.5", "0.5", "1.0", "1.0", "0.6", "1.0", "0.5", "1.0", "1.0", "2.0",
        "0.5", "0.9", "1.2", "0.06", "0.5", "0.1", "0.6",
    ];
    let values_hex = &[
        "0x0.c#2", "0x0.8#1", "0x1.0#2", "0x0.8#2", "0x0.8#1", "0x1.0#1", "0x1.0#1", "0x0.a#3",
        "0x1.0#1", "0x0.8#1", "0x1.0#1", "0x1.0#1", "0x2.0#1", "0x0.8#1", "0x0.e#3", "0x1.4#4",
        "0x0.1#1", "0x0.8#1", "0x0.2#1", "0x0.a#3",
    ];
    let common_values = &[
        ("0.5", 166114),
        ("0.2", 83464),
    ...
    let sample_median = (
        "0.746023112757506482497266106928906360272421050588543420130087",
        Some("0.746024386480478"),
    );
    let sample_median_hex = (
        "0x0.befb5ee75a863b717ef7486b94b7d4da51661d718ae7467808#199",
        Some("0x0.befb7445f3be0#49"),
    );
    let sample_moment_stats = MomentStats {
    ...
    let values = &[
        "1.0e-37", "4.0e-34", "2.0e-6", "1.0e-45", "1.0e15", "2.0e-10", "8.0e3", "0.04", "0.00006",
        "7.0e13", "1.0e34", "5.0e-13", "0.00006", "4.0e9", "1.1e33", "0.08", "0.00002", "2.0e18",
        "0.03", "3.4e8",
    ];
    let values_hex = &[
        "0x3.0E-31#2",
    ...
    let sample_median = (
        "0.726315",
        Some("0.72638326182303358287114819073153992766993863954"),
    );
    let sample_median_hex = (
        "0x0.b9efc#18",
        Some("0x0.b9f440e1e448b7a0f85e7d4da4ac517428596d0#154"),
    );
    let sample_moment_stats = MomentStats {
