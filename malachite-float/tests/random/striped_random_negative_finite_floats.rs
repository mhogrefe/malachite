...
fn test_striped_random_negative_finite_floats() {
    ...
    let values = &[
        "-0.8", "-0.5", "-1.0", "-0.5", "-0.5", "-1.0", "-1.0", "-0.9", "-1.0", "-0.5", "-1.0",
        "-1.0", "-2.0", "-0.5", "-0.5", "-1.0", "-0.06", "-0.5", "-0.1", "-0.5",
    ];
    let values_hex = &[
        "-0x0.c#2", "-0x0.8#1", "-0x1.0#2", "-0x0.8#2", "-0x0.8#1", "-0x1.0#1", "-0x1.0#1",
        "-0x0.e#3", "-0x1.0#1", "-0x0.8#1", "-0x1.0#1", "-0x1.0#1", "-0x2.0#1", "-0x0.8#1",
        "-0x0.8#3", "-0x1.0#4", "-0x0.1#1", "-0x0.8#1", "-0x0.2#1", "-0x0.8#3",
    ];
    let common_values = &[
        ("-0.5", 166114),
        ("-0.2", 83464),
    ...
    let sample_median_hex = ("-0x0.bffffe000#33", Some("-0x0.bffffe00#32"));
    let sample_moment_stats = MomentStats {
    ...
    let values = &[
        ...
        "-0.00006", "-7.0e13", "-1.0e34", "-5.0e-13", "-0.00006", "-4.0e9", "-6.0e32", "-0.06",
        "-0.00002", "-2.0e18", "-0.03", "-2.7e8",
    ];
    let values_hex = &[
        "-0x3.0E-31#2",
        "-0x2.0E-28#1",
    ...
    let sample_median = ("-0.56249994039535611273", Some("-0.562499940395355"));
    let sample_median_hex = ("-0x0.8fffff0000003fff#64", Some("-0x0.8fffff0000000#49"));
    let sample_moment_stats = MomentStats {
