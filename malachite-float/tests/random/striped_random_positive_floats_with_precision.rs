...
fn test_striped_random_positive_floats_with_precision() {
    ...
    let values = &[
        "1.9980", "1.0000", "3.9961", "1.1230", "1.0000", "3.9961", "2.0000", "1.9707", "3.9961",
        "1.9980", "3.9961", "3.9961", "7.9922", "1.0000", "1.9980", "2.0000", "0.24976", "1.9980",
        "0.25049", "1.0000",
    ];
    let values_hex = &[
        "0x1.ff8#10",
    ...
    let values = &[
        "1.99999999254941940340",
        "1.24999999999999999989",
        "3.99999999254941940308",
        "1.00000000000181898930",
        "1.00006103515624822364",
        "3.99993896484375266454",
        "2.00000000000000000000",
        "1.98437500011641526632",
        "3.87500047683693082945",
        "1.99999237066367285820",
        "3.99999999999994315658",
        "3.99609375046565418188",
        "7.99999999999988631316",
        "1.00003051757812488887",
        "1.99999999999909050530",
        "2.00000000011641532161",
        "0.249999999068691636226",
        "1.99905395507811792222",
        "0.250000000000000000000",
        "1.00000000000011367990",
    ];
    let values_hex = &[
    ...
    let sample_median = ("1.50000000000000000000", None);
    ...
    let sample_median = ("1.1270", Some("1.1875"));
    ...
    // mean |sci_exponent| 64, precision 64
    let values = &[
        "3.76158190861833538286e-37",
        "9.62964972193617926444e-34",
        "7.62939451703914528480e-6",
        "2.80259692865473203566e-45",
        "2251937252638716.00000",
        "9.31308363760763934007e-10",
        "16384.0000000000000000",
        "0.124023437507275954145",
        "0.000236511259572566578946",
        "281473902977023.500000",
        "4.15383748682780307324e34",
        "1.81721304691821123100e-12",
        "0.000244140624999996530553",
        "8590196735.99999904539",
        "2.59614842926623322264e33",
        "0.125000000007275957601",
        "0.0000610351560226297940004",
        "9219009174715727999.50",
        "0.0625000000000000000000",
        "536870912.000061031431",
    ];
    let values_hex = &[
    ...
    let sample_median = ("1.24902343750000000000", Some("1.24902344495058059682"));
