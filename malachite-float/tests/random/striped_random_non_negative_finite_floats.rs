...
fn test_striped_random_non_negative_finite_floats() {
    ...
    let values = &[
        "4.0", "0.5", "0.4", "0.0", "2.0", "1.8", "0.5", "1.0", "0.2", "0.25", "1.0", "2.0e1",
        "0.2", "0.0", "0.5", "1.5", "0.2", "0.0", "0.5", "0.06",
    ];
    let values_hex = &[
        "0x4.0#1",
        "0x0.8#1",
    ...
    let values = &[
        "7.999984741210937500013550872794843702379008944089524220035401213875142460868807248742637\
        5172310289",
        "0.5",
        "0.4999980928",
        "0.0",
    ...
    let values_hex = &[
        "0x7.ffff0000000000003ffe0000000003ffffffc001ff00000000000001fff8001ffffffffc7f8000000#324",
        "0x0.8#1",
        "0x0.7fffe0008#32",
        "0x0.0",
    ...
    let sample_median = (
        "0.500003814697265624996823626346822177860204279529750086286",
        Some("0.500003814697265624998"),
    );
    let sample_median_hex = (
        "0x0.80003ffffffffffff0fffff8000000000000000000000000#189",
        Some("0x0.80003ffffffffffff8#69"),
    );
    let sample_moment_stats = MomentStats {
    ...
    let values = &[
        ...
        "1.678e7", "9.0e37", "4.0e-9", "1.0e15", "0.0", "1.0e11", "1.1e-8", "3.0e14", "0.0",
        "0.016", "1.0e-34",
    ];
    let values_hex = &[
        "0x2.0E+7#1",
    ...
    let values = &[
        "1073739776.000000000001818767358940931848418775367374969414123630494763696774140214996167\
        66429030955",
        "1.0e-6",
        "15.999938969",
        "0.0",
    ...
    let values_hex = &[
        "0x3ffff800.0000000001fff0000000001ffffffe000ff80000000000000fffc000ffffffffe3fc000000#324",
        "0x0.00001#1",
        "0xf.fffc001#32",
        "0x0.0",
    ...
    let sample_median = (
        "0.0039062499999857908796",
        Some("0.003906249999985790879585158165071727505"),
    );
    let sample_median_hex = (
        "0x0.00fffffffffc001ffe#63",
        Some("0x0.00fffffffffc001ffe007c000000007f8#121"),
    );
    let sample_moment_stats = MomentStats {
