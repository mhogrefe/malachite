...
fn test_to_significand() {
    ...
    test("0.50", "0x0.8#1", "Some(9223372036854775808)");
    test(
        "0.33333333333333331",
    ...
    test("2.6e120", "0x1.0E+100#1", "Some(9223372036854775808)");
    test("3.9e-121", "0x1.0E-100#1", "Some(9223372036854775808)");
    test(
        "2.5822498780869085896559191720030118743297057928292235128306594e120",
    ...
    test(
        "3.8725919148493182728180306332863518475702191920487908654877629e-121",
        "0x1.00000000000000000000000000000000000000000000000000E-100#200",
        "Some(57896044618658097711785492504343953926634992332820282019728792003956564819968)",
    );
    test("1.0e323228496", "0x4.0E+268435455#1", "Some(9223372036854775808)");
    test(
        "2.4e-323228497",
        "0x1.0E-268435456#1",
...
fn test_get_exponent() {
    ...
    test("2.6e120", "0x1.0E+100#1", Some(401));
    test("3.9e-121", "0x1.0E-100#1", Some(-399));
    test(
        "2.5822498780869085896559191720030118743297057928292235128306594e120",
        "0x1.00000000000000000000000000000000000000000000000000E+100#200",
        Some(401),
    ...
    test("1.0e323228496", "0x4.0E+268435455#1", Some(1073741823));
    test("2.4e-323228497", "0x1.0E-268435456#1", Some(-1073741823));
...
fn test_get_prec() {
    ...
    test("2.6e120", "0x1.0E+100#1", Some(1));
    test("3.9e-121", "0x1.0E-100#1", Some(1));
    test(
        "2.5822498780869085896559191720030118743297057928292235128306594e120",
        "0x1.00000000000000000000000000000000000000000000000000E+100#200",
        Some(200),
    ...
    test("1.0e323228496", "0x4.0E+268435455#1", Some(1));
    test("2.4e-323228497", "0x1.0E-268435456#1", Some(1));
