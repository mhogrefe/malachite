...
\author{Mikhail Hogrefe\thanks{M.H.\ posed the questions: the moments of Malachite's striped
random generators, and the conjectured special case revisited within.}
\and Claude\thanks{Claude (Anthropic) worked out the mathematics and wrote the note. Any
errors are the second author's.}}
\date{August 2026}
