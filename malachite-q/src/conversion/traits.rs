...
// Returns the continued fraction of `self`.
//
...
// Returns the convergents of `self`, as an iterator of `Rational`s.
//
// The convergents of a real number are the numbers whose continued fractions are prefixes of the
// original number's continued fraction.
