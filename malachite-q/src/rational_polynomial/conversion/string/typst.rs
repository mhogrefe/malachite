...
impl ToTypst for RationalPolynomial {
    /// Writes an [`RationalPolynomial`] as a Typst math-mode fragment.
    ///
    /// The variable is called `x`.
    /// [`to_typst_string_with`](RationalPolynomial::to_typst_string_with) is the way to call it
    /// something else.
    ///
    ...
    /// );
    /// assert_eq!(
    ///     RationalPolynomial::from_str("0").unwrap().to_typst_string(),
    ///     "0"
    /// );
    /// assert_eq!(
    ///     RationalPolynomial::from_str("5").unwrap().to_typst_string(),
    ///     "5"
    /// );
    /// assert_eq!(
    ///     RationalPolynomial::from_str("x").unwrap().to_typst_string(),
    ///     "x"
    /// );
    /// assert_eq!(
