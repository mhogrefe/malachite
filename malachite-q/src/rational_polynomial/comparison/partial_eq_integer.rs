...
impl PartialEq<Integer> for RationalPolynomial {
    /// Determines whether a [`RationalPolynomial`] is equal to an [`Integer`].
    ///
    ...
    /// non-integer coefficient, or of positive degree, is equal to any [`Integer`].
    ///
...
impl PartialEq<RationalPolynomial> for Integer {
    /// Determines whether an [`Integer`] is equal to a [`RationalPolynomial`].
    ///
