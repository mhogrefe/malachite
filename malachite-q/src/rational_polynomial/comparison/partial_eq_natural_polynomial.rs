...
impl PartialEq<NaturalPolynomial> for RationalPolynomial {
    /// Determines whether a [`RationalPolynomial`] is equal to a [`NaturalPolynomial`].
    ///
    /// The two are equal when they have the same coefficients, so the zero polynomials are equal
    /// and a [`RationalPolynomial`] with a non-integer or negative coefficient is equal to no
    /// [`NaturalPolynomial`].
    ///
...
impl PartialEq<RationalPolynomial> for NaturalPolynomial {
    /// Determines whether a [`NaturalPolynomial`] is equal to a [`RationalPolynomial`].
    ///
    /// The two are equal when they have the same coefficients, so the zero polynomials are equal.
    ///
    /// # Worst-case complexity
