...
pub(crate) fn register(runner: &mut Runner) {
    ...
    register_demo!(
        runner,
        demo_natural_polynomial_try_from_rational_polynomial_ref
    );
    register_bench!(
        runner,
        benchmark_natural_polynomial_try_from_rational_polynomial_evaluation_strategy
    );
}

fn demo_natural_polynomial_try_from_rational_polynomial(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
) {
...
fn demo_natural_polynomial_try_from_rational_polynomial_ref(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
) {
...
fn benchmark_natural_polynomial_try_from_rational_polynomial_evaluation_strategy(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "NaturalPolynomial::try_from(RationalPolynomial)",
