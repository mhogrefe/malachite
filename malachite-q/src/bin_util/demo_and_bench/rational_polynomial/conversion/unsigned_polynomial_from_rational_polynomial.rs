...
pub(crate) fn register(runner: &mut Runner) {
    register_unsigned_demos!(
        runner,
        demo_unsigned_polynomial_convertible_from_rational_polynomial
    );
    register_unsigned_benches!(
        runner,
        benchmark_unsigned_polynomial_convertible_from_rational_polynomial_algorithms
    );
    register_unsigned_demos!(
        runner,
...
fn demo_unsigned_polynomial_convertible_from_rational_polynomial<
...
fn benchmark_unsigned_polynomial_convertible_from_rational_polynomial_algorithms<
    T: PrimitiveUnsigned + for<'a> ConvertibleFrom<&'a Integer> + for<'a> TryFrom<&'a Integer>,
>(
    gm: GenMode,
    config: &GenConfig,
    ...
    run_benchmark(
        &format!(
            "UnsignedPolynomial::<{}>::convertible_from(&RationalPolynomial)",
            T::NAME
        ),
