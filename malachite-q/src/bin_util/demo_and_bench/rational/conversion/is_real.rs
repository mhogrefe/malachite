...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_rational_is_real);
    register_bench!(runner, benchmark_rational_is_real);
}

fn demo_rational_is_real(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_rational_is_real(gm: GenMode, config: &GenConfig, limit: usize, file_name: &str) {
    run_benchmark(
        "Rational.is_real()",
