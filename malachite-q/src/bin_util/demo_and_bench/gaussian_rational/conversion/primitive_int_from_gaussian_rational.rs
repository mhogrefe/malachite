...
pub(crate) fn register(runner: &mut Runner) {
    register_primitive_int_demos!(runner, demo_primitive_int_try_from_gaussian_rational);
    register_primitive_int_demos!(
        runner,
        demo_primitive_int_convertible_from_gaussian_rational
    );

    register_primitive_int_benches!(runner, benchmark_primitive_int_try_from_gaussian_rational);
    register_primitive_int_benches!(
        runner,
        benchmark_primitive_int_convertible_from_gaussian_rational
    );
}

fn demo_primitive_int_try_from_gaussian_rational<
    T: for<'a> TryFrom<&'a GaussianRational> + PrimitiveInt,
>(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
...
fn demo_primitive_int_convertible_from_gaussian_rational<
    T: for<'a> ConvertibleFrom<&'a GaussianRational> + PrimitiveInt,
>(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
...
fn benchmark_primitive_int_try_from_gaussian_rational<
    T: for<'a> TryFrom<&'a GaussianRational> + PrimitiveInt,
>(
    gm: GenMode,
    config: &GenConfig,
...
fn benchmark_primitive_int_convertible_from_gaussian_rational<
    T: for<'a> ConvertibleFrom<&'a GaussianRational> + PrimitiveInt,
>(
    gm: GenMode,
    config: &GenConfig,
