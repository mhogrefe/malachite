...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_gaussian_rational_is_real);
    register_bench!(runner, benchmark_gaussian_rational_is_real);
}

fn demo_gaussian_rational_is_real(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_gaussian_rational_is_real(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
