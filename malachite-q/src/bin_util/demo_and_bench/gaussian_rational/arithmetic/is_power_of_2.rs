...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_gaussian_rational_is_power_of_2);
    register_bench!(runner, benchmark_gaussian_rational_is_power_of_2);
}

fn demo_gaussian_rational_is_power_of_2(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_gaussian_rational_is_power_of_2(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "GaussianRational.is_power_of_2()",
