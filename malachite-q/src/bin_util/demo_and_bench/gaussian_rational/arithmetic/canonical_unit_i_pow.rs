...
pub(crate) fn register(runner: &mut Runner) {
    register_demo!(runner, demo_gaussian_rational_canonical_unit_i_pow);
    register_bench!(runner, benchmark_gaussian_rational_canonical_unit_i_pow);
}

fn demo_gaussian_rational_canonical_unit_i_pow(gm: GenMode, config: &GenConfig, limit: usize) {
...
fn benchmark_gaussian_rational_canonical_unit_i_pow(
    gm: GenMode,
    config: &GenConfig,
    limit: usize,
    file_name: &str,
    ...
    run_benchmark(
        "GaussianRational.canonical_unit_i_pow()",
