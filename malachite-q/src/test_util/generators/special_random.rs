...
pub fn special_random_gaussian_rational_pair_gen(
    config: &GenConfig,
) -> It<(GaussianRational, GaussianRational)> {
    Box::new(random_pairs_from_single(striped_random_gaussian_rationals(
        EXAMPLE_SEED,
        config.get_or("mean_stripe_n", 32),
        config.get_or("mean_stripe_d", 1),
        config.get_or("mean_bits_n", 64),
...
pub fn special_random_gaussian_rational_pair_gen_var_1(
    config: &GenConfig,
) -> It<(GaussianRational, GaussianRational)> {
...
pub fn special_random_gaussian_rational_triple_gen(
    config: &GenConfig,
...
pub fn special_random_gaussian_rational_gen_var_4(config: &GenConfig) -> It<GaussianRational> {
    Box::new(
        striped_random_gaussian_rationals(
            EXAMPLE_SEED,
            config.get_or("mean_stripe_n", 32),
...
// -- (GaussianRational, PrimitiveSigned) (small shift amounts) --

pub fn special_random_gaussian_rational_signed_pair_gen_var_1<T: PrimitiveSigned>(
    config: &GenConfig,
) -> It<(GaussianRational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
// -- (GaussianRational, PrimitiveUnsigned) (small shift amounts) --

pub fn special_random_gaussian_rational_unsigned_pair_gen_var_1<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianRational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_gaussian_rational_unsigned_pair_gen_var_2<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianRational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn special_random_rational_natural_pair_gen_var_5(
    config: &GenConfig,
) -> It<(Rational, Natural)> {
    Box::new(
        random_pairs(
...
pub fn special_random_rational_unsigned_pair_gen_var_7<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(Rational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
// string.
pub fn special_random_rational_string_pair_gen_var_1(config: &GenConfig) -> It<(Rational, String)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
        &|seed| {
            striped_random_rationals(
...
pub fn special_random_rational_polynomial_unsigned_polynomial_pair_gen<T: PrimitiveUnsigned>(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_natural_polynomial_pair_gen(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_gaussian_rational_pair_gen(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_gaussian_integer_pair_gen(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_rational_pair_gen(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_natural_pair_gen(
    config: &GenConfig,
...
pub fn special_random_rational_polynomial_signed_pair_gen<T: PrimitiveSigned>(
    config: &GenConfig,
) -> It<(RationalPolynomial, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
