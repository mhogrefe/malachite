...
pub fn exhaustive_gaussian_rational_pair_gen_var_1() -> It<(GaussianRational, GaussianRational)> {
    Box::new(exhaustive_pairs(
        exhaustive_gaussian_rationals(),
        exhaustive_gaussian_rationals().filter(|x| x.real != 0u32 || x.imaginary != 0u32),
    ))
}
...
pub fn exhaustive_gaussian_rational_signed_pair_gen_var_1<T: PrimitiveSigned>()
-> It<(GaussianRational, T)> {
...
pub fn exhaustive_gaussian_rational_unsigned_pair_gen_var_1<T: PrimitiveUnsigned>()
-> It<(GaussianRational, T)> {
    Box::new(exhaustive_pairs_big_tiny(
        exhaustive_gaussian_rationals(),
        exhaustive_unsigneds(),
...
pub fn exhaustive_rational_unsigned_pair_gen_var_8() -> It<(Rational, u8)> {
    Box::new(exhaustive_pairs_big_tiny(
        exhaustive_rationals(),
        primitive_int_increasing_inclusive_range(2, 62),
    ))
}
