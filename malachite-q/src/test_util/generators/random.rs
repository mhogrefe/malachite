...
pub fn random_gaussian_rational_gen_var_4(config: &GenConfig) -> It<GaussianRational> {
    Box::new(
        random_gaussian_rationals(
            EXAMPLE_SEED,
            config.get_or("mean_bits_n", 64),
...
pub fn random_gaussian_rational_signed_pair_gen_var_1<T: PrimitiveSigned>(
    config: &GenConfig,
) -> It<(GaussianRational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_gaussian_rational_unsigned_pair_gen_var_1<T: PrimitiveUnsigned>(
    config: &GenConfig,
) -> It<(GaussianRational, T)> {
    Box::new(random_pairs(
        EXAMPLE_SEED,
...
pub fn random_rational_signed_unsigned_triple_gen_var_2<
    T: PrimitiveSigned,
    U: PrimitiveUnsigned,
>(
    config: &GenConfig,
...
pub fn random_rational_pair_gen_var_9(config: &GenConfig) -> It<(Rational, Rational)> {
    Box::new(
        random_rationals(
            EXAMPLE_SEED,
...
pub fn random_gaussian_rational_vec_gen(config: &GenConfig) -> It<Vec<GaussianRational>> {
    Box::new(random_vecs(
        EXAMPLE_SEED,
        &|seed| {
            random_gaussian_rationals(
...
pub fn random_rational_polynomial_pair_gen(
    config: &GenConfig,
) -> It<(RationalPolynomial, RationalPolynomial)> {
    Box::new(random_pairs_from_single(random_rational_polynomials(
        EXAMPLE_SEED,
        config.get_or("mean_bits_n", 64),
        config.get_or("mean_bits_d", 1),
        config.get_or("mean_length_n", 4),
...
pub fn random_rational_polynomial_triple_gen(
    config: &GenConfig,
) -> It<(RationalPolynomial, RationalPolynomial, RationalPolynomial)> {
    Box::new(random_triples_from_single(random_rational_polynomials(
        EXAMPLE_SEED,
        config.get_or("mean_bits_n", 64),
        config.get_or("mean_bits_d", 1),
        config.get_or("mean_length_n", 4),
