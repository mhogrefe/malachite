...
impl PartialOrdAbs for GaussianRational {
    /// Compares the absolute values of two [`GaussianRational`]s.
    ///
...
impl OrdAbs for GaussianRational {
    /// Compares the absolute values of two [`GaussianRational`]s.
    ///
    ...
    /// [`Rational`](crate::Rational) parts componentwise, either directly or crosswise, often
