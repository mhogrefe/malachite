...
impl Conjugate for GaussianRational {
    type Output = Self;

    /// Computes the complex conjugate of a [`GaussianRational`], taking it by value. The sign of
...
impl Conjugate for &GaussianRational {
    ...
    /// Computes the complex conjugate of a [`GaussianRational`], taking it by reference. The sign
    /// of the imaginary part is flipped.
    ///
    /// $$
    /// f(x) = \overline{x} = \Re(x) - \Im(x) i.
    /// $$
    ...
    /// ```
    fn conjugate(self) -> GaussianRational {
        GaussianRational {
...
impl ConjugateAssign for GaussianRational {
    /// Replaces a [`GaussianRational`] with its complex conjugate. The sign of the imaginary part
    /// is flipped.
    ///
    /// $$
