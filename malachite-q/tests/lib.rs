...
pub mod gaussian_rational {
    ...
    pub mod exhaustive {
        pub mod exhaustive_gaussian_rationals;
    ...
    pub mod random {
        ...
        pub mod random_real_gaussian_rationals;
        pub mod striped_random_gaussian_rationals;
        pub mod striped_random_imaginary_gaussian_rationals;
        pub mod striped_random_real_gaussian_rationals;
    }
}
