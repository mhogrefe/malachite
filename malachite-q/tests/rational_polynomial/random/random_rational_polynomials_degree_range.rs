...
fn random_rational_polynomials_degree_range_helper(
    a: u64,
    b: u64,
    ...
    assert_eq!(
        random_rational_polynomials_degree_range(
            EXAMPLE_SEED,
            a,
            b,
            mean_bits_numerator,
...
#[test]
fn test_random_rational_polynomials_degree_range() {
    // degrees in [0, 2), mean bits = 65/64
    random_rational_polynomials_degree_range_helper(
        0,
        2,
        65,
        64,
...
#[test]
#[should_panic]
fn random_rational_polynomials_degree_range_fail_1() {
    let _ = random_rational_polynomials_degree_range(EXAMPLE_SEED, 3, 3, 2, 1);
}
