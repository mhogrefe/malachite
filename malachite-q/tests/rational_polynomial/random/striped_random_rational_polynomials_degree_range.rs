...
fn striped_random_rational_polynomials_degree_range_helper(
    a: u64,
    b: u64,
    ...
    assert_eq!(
        striped_random_rational_polynomials_degree_range(
            EXAMPLE_SEED,
            a,
            b,
...
#[test]
fn test_striped_random_rational_polynomials_degree_range() {
    // degrees in [0, 2), mean stripe = 16, mean bits = 2
    striped_random_rational_polynomials_degree_range_helper(
        0,
        2,
        16,
        1,
...
#[test]
#[should_panic]
fn striped_random_rational_polynomials_degree_range_fail_1() {
    let _ = striped_random_rational_polynomials_degree_range(EXAMPLE_SEED, 3, 3, 16, 1, 2, 1);
}
