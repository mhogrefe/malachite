...
Floats (arbitrary-precision floating-point numbers) are still in development and are not yet feature-complete, but the floating-point functions that *are* implemented are thoroughly tested and documented.
