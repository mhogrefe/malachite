    ...
    Limb: PowerOf2Digits<T>,
{
    test_properties(
        ...
        |&(ref n, log_base)| {
            ...
            assert_eq!(to_power_of_2_digits_asc_naive(n, log_base), digits);
            assert_eq!(
...
fn to_power_of_2_digits_asc_properties() {
    to_power_of_2_digits_asc_properties_helper::<u8, _>(Natural::_to_power_of_2_digits_asc_naive);
    to_power_of_2_digits_asc_properties_helper::<u16, _>(Natural::_to_power_of_2_digits_asc_naive);
    to_power_of_2_digits_asc_properties_helper::<u32, _>(Natural::_to_power_of_2_digits_asc_naive);
    to_power_of_2_digits_asc_properties_helper::<u64, _>(Natural::_to_power_of_2_digits_asc_naive);
    to_power_of_2_digits_asc_properties_helper::<u128, _>(Natural::_to_power_of_2_digits_asc_naive);
    to_power_of_2_digits_asc_properties_helper::<usize, _>(
...
fn to_power_of_2_digits_desc_properties_helper<T: PrimitiveUnsigned>()
where
    Natural: From<T> + PowerOf2Digits<T>,
    Limb: PowerOf2Digits<T>,
{
...
fn to_power_of_2_digits_desc_properties() {
    to_power_of_2_digits_desc_properties_helper::<u8>();
    to_power_of_2_digits_desc_properties_helper::<u16>();
    to_power_of_2_digits_desc_properties_helper::<u32>();
    to_power_of_2_digits_desc_properties_helper::<u64>();
    to_power_of_2_digits_desc_properties_helper::<u128>();
    to_power_of_2_digits_desc_properties_helper::<usize>();
