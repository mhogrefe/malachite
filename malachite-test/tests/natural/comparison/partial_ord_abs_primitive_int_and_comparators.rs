...
fn partial_cmp_abs_primitive_int_properties() {
    partial_cmp_abs_primitive_int_properties_helper_unsigned::<u8>();
    partial_cmp_abs_primitive_int_properties_helper_unsigned::<u16>();
    partial_cmp_abs_primitive_int_properties_helper_unsigned::<u32>();
    partial_cmp_abs_primitive_int_properties_helper_unsigned::<u64>();
    partial_cmp_abs_primitive_int_properties_helper_unsigned::<usize>();
    partial_cmp_abs_primitive_int_properties_helper_signed::<i8>();
    partial_cmp_abs_primitive_int_properties_helper_signed::<i16>();
    partial_cmp_abs_primitive_int_properties_helper_signed::<i32>();
    partial_cmp_abs_primitive_int_properties_helper_signed::<i64>();
    partial_cmp_abs_primitive_int_properties_helper_signed::<isize>();
}
