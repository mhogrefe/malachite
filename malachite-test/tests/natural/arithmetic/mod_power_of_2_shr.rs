...
macro_rules! properties_signed {
    ($t:ident, $mod_power_of_2_shr_i_properties:ident) => {
        #[test]
        fn $mod_power_of_2_shr_i_properties() {
            test_properties(
...
properties_signed!(i8, mod_power_of_2_shr_i8_properties);
properties_signed!(i16, mod_power_of_2_shr_i16_properties);
properties_signed!(i32, mod_power_of_2_shr_i32_properties);
properties_signed!(i64, mod_power_of_2_shr_i64_properties);
properties_signed!(isize, mod_power_of_2_shr_isize_properties);
