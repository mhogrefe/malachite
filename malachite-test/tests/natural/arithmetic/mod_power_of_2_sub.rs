    ...
    test_properties(
        ...
        |&(x, ref ys, pow)| {
            assert_eq!(
                ...
                Natural::from(x).mod_power_of_2_sub(Natural::from_limbs_asc(ys), pow),
            );
        },
    );
}
...
fn limbs_mod_power_of_2_limb_sub_limbs_in_place_properties() {
    test_properties(
        ...
        |&(x, ref ys, pow)| {
            ...
            let n = Natural::from(x).mod_power_of_2_sub(Natural::from_limbs_asc(&old_ys), pow);
    ...
    test_properties(
        ...
        |&(ref xs, ref ys, pow)| {
            assert_eq!(
                ...
                Natural::from_limbs_asc(xs).mod_power_of_2_sub(Natural::from_limbs_asc(ys), pow)
            );
        },
    );
}
        ...
        |&(ref xs, ref ys, pow)| {
            ...
            assert_eq!(
                ...
                Natural::from_owned_limbs_asc(xs_old)
                    .mod_power_of_2_sub(Natural::from_limbs_asc(ys), pow)
            );
        },
    );
}
