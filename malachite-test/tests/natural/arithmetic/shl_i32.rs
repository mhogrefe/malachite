...
fn shl_i32_properties() {
    ...
    for (n, i) in log_pairs(exhaustive_naturals(), exhaustive_i::<i32>()).take(LARGE_LIMIT) {
        natural_and_i32(n, i);
    }
...
fn test_shl_round_i32() {
    let test = |i, j: i32, rm: RoundingMode, out| {
        ...
        let n = native::Natural::from_str(i).unwrap().shl_round(j, rm);
        assert_eq!(n.to_string(), out);
        assert!(n.is_valid());

        let n = gmp::Natural::from_str(i).unwrap().shl_round(j, rm);
        assert_eq!(n.to_string(), out);
        assert!(n.is_valid());
...
fn shl_round_assign_i32_fail_native_1() {
    native::Natural::from(123u32).shl_round_assign(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shl_round_assign_i32_fail_native_2() {
    native::Natural::from(123u32).shl_round_assign(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shl_round_assign_i32_fail_native_3() {
...
fn shl_round_assign_i32_fail_native_4() {
    native::Natural::from_str("1000000000001")
        .unwrap()
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shl_round_i32_fail_native_1() {
    native::Natural::from(123u32).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shl_round_i32_fail_native_2() {
    native::Natural::from(123u32).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shl_round_i32_fail_native_3() {
    native::Natural::from_str("1000000000001")
        .unwrap()
...
#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 100")]
fn shl_round_i32_fail_native_4() {
    native::Natural::from_str("1000000000001")
        .unwrap()
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 1")]
fn shl_round_ref_i32_fail_native_1() {
    (&native::Natural::from(123u32)).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 100")]
fn shl_round_ref_i32_fail_native_2() {
    (&native::Natural::from(123u32)).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 1")]
fn shl_round_ref_i32_fail_native_3() {
    (&native::Natural::from_str("1000000000001").unwrap()).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 100")]
fn shl_round_ref_i32_fail_native_4() {
    (&native::Natural::from_str("1000000000001").unwrap()).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shl_round_assign_i32_fail_gmp_1() {
    gmp::Natural::from(123u32).shl_round_assign(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shl_round_assign_i32_fail_gmp_2() {
    gmp::Natural::from(123u32).shl_round_assign(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shl_round_assign_i32_fail_gmp_3() {
...
#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 100")]
fn shl_round_assign_i32_fail_gmp_4() {
    gmp::Natural::from_str("1000000000001")
        .unwrap()
        .shl_round_assign(-100i32, RoundingMode::Exact);
}
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shl_round_i32_fail_gmp_1() {
    gmp::Natural::from(123u32).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shl_round_i32_fail_gmp_2() {
    gmp::Natural::from(123u32).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shl_round_i32_fail_gmp_3() {
    gmp::Natural::from_str("1000000000001").unwrap().shl_round(
        -1i32,
        RoundingMode::Exact,
    );
}
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 1")]
fn shl_round_ref_i32_fail_gmp_1() {
    (&gmp::Natural::from(123u32)).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 100")]
fn shl_round_ref_i32_fail_gmp_2() {
    (&gmp::Natural::from(123u32)).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 1")]
fn shl_round_ref_i32_fail_gmp_3() {
    (&gmp::Natural::from_str("1000000000001").unwrap()).shl_round(-1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 100")]
fn shl_round_ref_i32_fail_gmp_4() {
    (&gmp::Natural::from_str("1000000000001").unwrap()).shl_round(-100i32, RoundingMode::Exact);
}

#[test]
fn shl_round_u32_properties() {
    // n.shl_round_assign(i, rm) is equivalent for malachite-gmp and malachite-native.
    // n.shl_round(i, rm) is equivalent for malachite-gmp and malachite-native.
    // (&n).shl_round(i, rm) is equivalent for malachite-gmp and malachite-native.
    // n.shl_round_assign(i, rm); n is valid.
    // n.shl_round(i, rm) is valid.
    // (&n).shl_round(i, rm) is valid.
    // n.shl_round_assign(i, rm), n.shl_round(u, rm), and (&n).shl_round(u, rm) give the same
    //      result.
    // n.shl_round(u, rm) <= n
    let natural_i32_and_rounding_mode = |mut gmp_n: gmp::Natural, i: i32, rm: RoundingMode| {
        let mut n = gmp_natural_to_native(&gmp_n);
        let old_n = n.clone();
        gmp_n.shl_round_assign(i, rm);
        assert!(gmp_n.is_valid());
        ...
        let gmp_n2 = native_natural_to_gmp(&old_n);
        let result = (&gmp_n2).shl_round(i, rm);
        assert!(result.is_valid());
        assert_eq!(gmp_natural_to_native(&result), n);
        let result = gmp_n2.shl_round(i, rm);
        assert!(result.is_valid());
    ...
    let i32_and_rounding_mode = |i: i32, rm: RoundingMode| {
        assert_eq!(native::Natural::ZERO.shl_round(i, rm), 0);
    };
