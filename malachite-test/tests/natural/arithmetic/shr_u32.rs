...
fn shr_round_u32_properties() {
    ...
    // if u >= 32 and n > 0, n.shr_round(0, Down) == 0
    // if u >= 32 and n > 0, n.shr_round(0, Floor) == 0
    // if u >= 32 and n > 0, n.shr_round(0, Up) == 1
    // if u >= 32 and n > 0, n.shr_round(0, Ceiling) == 1
    // if u >= 33 and n > 0, n.shr_round(0, Nearest) == 0
    let positive_u32_and_natural_u32 = |u: u32, v: u32| {
        assert_eq!(
    ...
    for (n, u) in log_pairs(exhaustive_positive_x::<u32>(), exhaustive_u::<u32>())
        .take(LARGE_LIMIT)
    {
        positive_u32_and_natural_u32(n, u);
    }
