...
use malachite_test::inputs::natural::{
    ...
    triples_of_natural_unsigned_and_unsigned_var_1, triples_of_natural_unsigned_and_unsigned_var_2,
};
use rug;
use std::str::FromStr;
...
fn eq_u32_mod_u32_properties() {
    test_properties(
        ...
        |&(ref n, u, modulus): &(Natural, u32, u32)| {
    ...
    test_properties(
        triples_of_natural_unsigned_and_unsigned_var_2,
        |&(ref n, u, modulus): &(Natural, u32, u32)| {
            assert!(!n.eq_mod(u, modulus));
            assert!(!u.eq_mod(n, modulus));
            assert!(*n != u && (modulus == 0 || n % modulus != u % modulus));
