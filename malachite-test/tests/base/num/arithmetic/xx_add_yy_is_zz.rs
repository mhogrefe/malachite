...
use malachite_test::inputs::base::{
    pairs_of_unsigneds, quadruples_of_unsigneds, sextuples_of_unsigneds,
};

fn xx_add_yy_is_zz_properties_helper<T: PrimitiveUnsigned + Rand + SampleRange>() {
...
fn xx_add_yy_is_zz_properties() {
    xx_add_yy_is_zz_properties_helper::<u8>();
    xx_add_yy_is_zz_properties_helper::<u16>();
    xx_add_yy_is_zz_properties_helper::<u32>();
    xx_add_yy_is_zz_properties_helper::<u64>();
    xx_add_yy_is_zz_properties_helper::<usize>();
}
