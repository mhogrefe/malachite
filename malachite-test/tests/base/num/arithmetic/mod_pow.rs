...
use malachite_test::inputs::base::{
    pairs_of_unsigned_and_positive_unsigned, pairs_of_unsigneds_var_5, positive_unsigneds,
    quadruples_of_unsigneds_var_3, quadruples_of_unsigneds_var_4,
    triples_of_unsigned_small_unsigned_and_unsigned_var_1,
    triples_of_unsigned_unsigned_and_unsigned_var_1, triples_of_unsigneds_var_1,
};
