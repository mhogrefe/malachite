...
fn mod_power_of_2_add_properties_helper<T: PrimitiveUnsigned + Rand + SampleRange>() {
...
fn mod_power_of_2_add_properties() {
    mod_power_of_2_add_properties_helper::<u8>();
    mod_power_of_2_add_properties_helper::<u16>();
    mod_power_of_2_add_properties_helper::<u32>();
    mod_power_of_2_add_properties_helper::<u64>();
    mod_power_of_2_add_properties_helper::<usize>();
}
