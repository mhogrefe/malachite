...
fn round_to_multiple_of_power_of_2_properties_unsigned_helper<T: PrimitiveUnsigned + Rand>() {
    test_properties(
...
fn round_to_multiple_of_power_of_2_properties_signed_helper<T: PrimitiveSigned + Rand>()
where
...
fn round_to_multiple_of_power_of_2_properties() {
    round_to_multiple_of_power_of_2_properties_unsigned_helper::<u8>();
    round_to_multiple_of_power_of_2_properties_unsigned_helper::<u16>();
    round_to_multiple_of_power_of_2_properties_unsigned_helper::<u32>();
    round_to_multiple_of_power_of_2_properties_unsigned_helper::<u64>();
    round_to_multiple_of_power_of_2_properties_unsigned_helper::<usize>();
    round_to_multiple_of_power_of_2_properties_signed_helper::<i8>();
    round_to_multiple_of_power_of_2_properties_signed_helper::<i16>();
    round_to_multiple_of_power_of_2_properties_signed_helper::<i32>();
    round_to_multiple_of_power_of_2_properties_signed_helper::<i64>();
    round_to_multiple_of_power_of_2_properties_signed_helper::<isize>();
}
