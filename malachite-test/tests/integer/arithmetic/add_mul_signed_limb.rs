...
#[test]
fn add_mul_signed_limb_properties() {
    test_properties(
    ...
    test_properties(integers, |n| {
        assert_eq!(n.add_mul(n, -1 as SignedLimb), 0 as Limb);
        assert_eq!(n.add_mul(-n, 1 as SignedLimb), 0 as Limb);
    });
    ...
    test_properties(pairs_of_integers, |&(ref a, ref b)| {
        assert_eq!(a.add_mul(b, 0 as SignedLimb), *a);
        assert_eq!(a.add_mul(b, 1 as SignedLimb), a + b);
        assert_eq!(a.add_mul(b, -1 as SignedLimb), a - b);
    });
}
