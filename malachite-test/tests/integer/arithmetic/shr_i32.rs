...
fn shr_round_i32_assign_fail_1() {
    Integer::from(123u32).shr_round_assign(1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_i32_assign_fail_2() {
    Integer::from(123u32).shr_round_assign(100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_i32_assign_fail_3() {
...
fn shr_round_i32_assign_fail_4() {
    Integer::from_str("1000000000001")
        .unwrap()
...
fn shr_round_i32_fail_1() {
    Integer::from(123u32).shr_round(1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_i32_fail_2() {
    Integer::from(123u32).shr_round(100i32, RoundingMode::Exact);
}
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 1")]
fn shr_round_i32_ref_fail_1() {
    (&Integer::from(123u32)).shr_round(1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 100")]
fn shr_round_i32_ref_fail_2() {
    (&Integer::from(123u32)).shr_round(100i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 1")]
fn shr_round_i32_ref_fail_3() {
    (&Integer::from_str("1000000000001").unwrap()).shr_round(1i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 100")]
fn shr_round_i32_ref_fail_4() {
    (&Integer::from_str("1000000000001").unwrap()).shr_round(100i32, RoundingMode::Exact);
}
...
fn shr_round_i32_properties() {
    ...
    for (n, i, rm) in triples_of_integer_small_i32_and_rounding_mode_var_2(
    ...
    for (n, i, rm) in triples_of_integer_small_i32_and_rounding_mode_var_2(GenerationMode::Random(
        32,
    )).take(LARGE_LIMIT)
    {
        integer_i32_and_rounding_mode(n, i, rm);
