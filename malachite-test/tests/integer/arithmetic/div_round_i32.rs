...
use malachite_test::inputs::integer::{
    ...
    pairs_of_integer_and_nonzero_signed, pairs_of_integer_and_rounding_mode,
...
use malachite_test::integer::arithmetic::div_round_i32::num_div_round_i32_floor;
use num::BigInt;
...
fn test_div_round_i32() {
    let test = |i, j: i32, rm: RoundingMode, quotient| {
        ...
        match rm {
            ...
            RoundingMode::Floor => {
                assert_eq!(
                    num_div_round_i32_floor(BigInt::from_str(i).unwrap(), j).to_string(),
                    quotient
                );
                assert_eq!(
...
fn div_round_assign_i32_fail_1() {
    let mut n = Integer::from(10i32);
    n.div_round_assign(0i32, RoundingMode::Floor);
}

#[test]
#[should_panic(expected = "Division is not exact")]
fn div_round_assign_i32_fail_2() {
    let mut n = Integer::from(10i32);
    n.div_round_assign(3i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "division by zero")]
fn div_round_i32_fail_1() {
    Integer::from(10i32).div_round(0i32, RoundingMode::Floor);
}

#[test]
#[should_panic(expected = "Division is not exact")]
fn div_round_i32_fail_2() {
    Integer::from(10i32).div_round(3i32, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "division by zero")]
fn div_round_i32_ref_fail_1() {
    (&Integer::from(10i32)).div_round(0i32, RoundingMode::Floor);
}

#[test]
#[should_panic(expected = "Division is not exact: 10 / 3")]
fn div_round_i32_ref_fail_2() {
    (&Integer::from(10i32)).div_round(3i32, RoundingMode::Exact);
}

#[test]
fn test_i32_div_round_integer() {
    let test = |i: i32, j, rm, quotient| {
...
#[test]
#[should_panic(expected = "division by zero")]
fn i32_div_round_integer_fail_1() {
    10i32.div_round(Integer::ZERO, RoundingMode::Floor);
}

#[test]
#[should_panic(expected = "Division is not exact")]
fn i32_div_round_integer_fail_2() {
    10i32.div_round(Integer::from(3i32), RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "division by zero")]
fn i32_div_round_integer_ref_fail_1() {
    10i32.div_round(&Integer::ZERO, RoundingMode::Floor);
}

#[test]
#[should_panic(expected = "Division is not exact: 10 / 3")]
fn i32_div_round_integer_ref_fail_2() {
    10i32.div_round(&Integer::from(3i32), RoundingMode::Exact);
}

#[test]
fn div_round_i32_properties() {
    test_properties(
        triples_of_integer_nonzero_signed_and_rounding_mode_var_1,
        |&(ref n, i, rm): &(Integer, i32, RoundingMode)| {
    ...
    test_properties(pairs_of_integer_and_nonzero_signed::<i32>, |&(ref n, i)| {
        ...
        assert_eq!(
            bigint_to_integer(&num_div_round_i32_floor(integer_to_bigint(n), i)),
    ...
    test_properties(pairs_of_integer_and_nonzero_i32_var_2, |&(ref n, i)| {
    ...
    test_properties(pairs_of_integer_and_rounding_mode, |&(ref n, rm)| {
        assert_eq!(n.div_round(1i32, rm), *n);
    });

    test_properties(
        pairs_of_nonzero_integer_and_rounding_mode,
        |&(ref n, rm)| {
            assert_eq!(0i32.div_round(n, rm), 0);
        },
    );

    test_properties(
        pairs_of_nonzero_signed_and_rounding_mode::<i32>,
        |&(i, rm)| {
            assert_eq!(Integer::ZERO.div_round(i, rm), 0);
            assert_eq!(i.div_round(Integer::from(i), rm), 1);
            assert_eq!(Integer::from(i).div_round(i, rm), 1);
            assert_eq!(i.div_round(-Integer::from(i), rm), -1);
            assert_eq!((-Integer::from(i)).div_round(i, rm), -1);
        },
    );
    ...
    test_properties(
        triples_of_signed_nonzero_integer_and_rounding_mode_var_1,
        |&(i, ref n, rm): &(i32, Integer, RoundingMode)| {
    ...
    // TODO test using Rationals
    test_properties(pairs_of_i32_and_nonzero_integer_var_1, |&(i, ref n)| {
    ...
    test_properties(pairs_of_signed_and_rounding_mode::<i32>, |&(i, rm)| {
