...
properties!(u8, shr_round_u8_properties);
properties!(u16, shr_round_u16_properties);
properties!(u32, shr_round_u32_properties);
properties!(u64, shr_round_u64_properties);
properties!(usize, shr_round_usize_properties);
