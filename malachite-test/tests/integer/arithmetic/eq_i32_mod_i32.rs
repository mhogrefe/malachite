...
use malachite_test::integer::arithmetic::eq_i32_mod_i32::rug_eq_i32_mod_i32;
use rug;
use std::str::FromStr;

#[test]
fn test_eq_i32_mod_i32() {
    let test = |n, i: i32, modulus, out| {
        assert_eq!(Integer::from_str(n).unwrap().eq_mod(i, modulus), out);
        assert_eq!(i.eq_mod(&Integer::from_str(n).unwrap(), modulus), out);
        assert_eq!(
            rug_eq_i32_mod_i32(rug::Integer::from_str(n).unwrap(), i, modulus),
            out
        );
    };
    test("0", 0, 0, true);
...
#[test]
fn eq_i32_mod_i32_properties() {
    test_properties(
        triples_of_integer_signed_and_signed,
        |&(ref n, i, modulus): &(Integer, i32, i32)| {
            ...
            assert_eq!(
                rug_eq_i32_mod_i32(integer_to_rug_integer(n), i, modulus),
                equal
            );
        },
    );
    ...
    test_properties(
        ...
        |&(ref n, i, modulus): &(Integer, i32, i32)| {
            ...
            assert!(rug_eq_i32_mod_i32(integer_to_rug_integer(n), i, modulus));
        },
    );
    ...
    test_properties(pairs_of_integer_and_signed, |&(ref n, i)| {
        assert!(n.eq_mod(i, 1i32));
        assert!(i.eq_mod(n, 1i32));
        assert_eq!(n.eq_mod(0i32, i), n.divisible_by(i));
        assert_eq!(0i32.eq_mod(n, i), n.divisible_by(i));
    });

    test_properties(pairs_of_signeds::<i32>, |&(i, modulus)| {
    ...
    test_properties(triples_of_signeds::<i32>, |&(n, i, modulus)| {
