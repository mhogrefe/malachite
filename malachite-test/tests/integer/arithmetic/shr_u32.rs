...
fn shr_u32_properties() {
    ...
    // n >> u is equivalent for malachite-gmp, malachite-native, and rugint.
    // &n >> u is equivalent for malachite-gmp and malachite-native.
    ...
    let two_u32s = |u: u32, v: u32| {
        assert_eq!(native::Integer::from(u) >> (v + 32), 0);
    };

    // n >> u >> v == n >> (u + v)
    let integer_and_two_u32s = |gmp_n: gmp::Integer, u: u32, v: u32| {
...
fn test_shr_round_u32() {
    let test = |u, v: u32, rm: RoundingMode, out| {
        ...
        let n = native::Integer::from_str(u).unwrap().shr_round(v, rm);
        assert_eq!(n.to_string(), out);
        assert!(n.is_valid());

        let n = gmp::Integer::from_str(u).unwrap().shr_round(v, rm);
        assert_eq!(n.to_string(), out);
        assert!(n.is_valid());
...
fn shr_round_assign_fail_native_1() {
    native::Integer::from(123u32).shr_round_assign(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_assign_fail_native_2() {
    native::Integer::from(123u32).shr_round_assign(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_assign_fail_native_3() {
...
fn shr_round_assign_fail_native_4() {
    native::Integer::from_str("1000000000001")
        .unwrap()
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shr_round_fail_native_1() {
    native::Integer::from(123u32).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_fail_native_2() {
    native::Integer::from(123u32).shr_round(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_fail_native_3() {
    native::Integer::from_str("1000000000001")
        .unwrap()
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 1")]
fn shr_round_ref_fail_native_1() {
    (&native::Integer::from(123u32)).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >> 100")]
fn shr_round_ref_fail_native_2() {
    (&native::Integer::from(123u32)).shr_round(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 1")]
fn shr_round_ref_fail_native_3() {
    (&native::Integer::from_str("1000000000001").unwrap()).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >> 100")]
fn shr_round_ref_fail_native_4() {
    (&native::Integer::from_str("1000000000001").unwrap()).shr_round(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shr_round_assign_fail_gmp_1() {
    gmp::Integer::from(123u32).shr_round_assign(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_assign_fail_gmp_2() {
    gmp::Integer::from(123u32).shr_round_assign(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_assign_fail_gmp_3() {
...
#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 100")]
fn shr_round_assign_fail_gmp_4() {
    gmp::Integer::from_str("1000000000001")
        .unwrap()
        .shr_round_assign(100, RoundingMode::Exact);
}
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shr_round_fail_gmp_1() {
    gmp::Integer::from(123u32).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_fail_gmp_2() {
    gmp::Integer::from(123u32).shr_round(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_fail_gmp_3() {
...
#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 1")]
fn shr_round_ref_fail_gmp_1() {
    (&gmp::Integer::from(123u32)).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 123 >>= 100")]
fn shr_round_ref_fail_gmp_2() {
    (&gmp::Integer::from(123u32)).shr_round(100, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 1")]
fn shr_round_ref_fail_gmp_3() {
    (&gmp::Integer::from_str("1000000000001").unwrap()).shr_round(1, RoundingMode::Exact);
}

#[test]
#[should_panic(expected = "Right shift is not exact: 1000000000001 >>= 100")]
fn shr_round_ref_fail_gmp_4() {
    (&gmp::Integer::from_str("1000000000001").unwrap()).shr_round(100, RoundingMode::Exact);
}
...
fn shr_round_u32_properties() {
    ...
    let integer_u32_and_rounding_mode = |mut gmp_n: gmp::Integer, u: u32, rm: RoundingMode| {
        let mut n = gmp_integer_to_native(&gmp_n);
        let old_n = n.clone();
    ...
    let integer_and_u32_inexact = |gmp_n: gmp::Integer, u: u32| {
        let n = gmp_integer_to_native(&gmp_n);
    ...
    let positive_i32_and_u32 = |i: i32, j: u32| {
        assert_eq!(
            native::Integer::from(i).shr_round(j + 31, RoundingMode::Down),
            0
        );
        assert_eq!(
            native::Integer::from(i).shr_round(j + 31, RoundingMode::Floor),
            0
        );
        assert_eq!(
            native::Integer::from(i).shr_round(j + 31, RoundingMode::Up),
            1
        );
        assert_eq!(
            native::Integer::from(i).shr_round(j + 31, RoundingMode::Ceiling),
            1
        );
        assert_eq!(
            native::Integer::from(i).shr_round(j + 32, RoundingMode::Nearest),
            0
        );
    };
    ...
    let u32_and_rounding_mode = |u: u32, rm: RoundingMode| {
        assert_eq!(native::Integer::ZERO.shr_round(u, rm), 0);
    };
