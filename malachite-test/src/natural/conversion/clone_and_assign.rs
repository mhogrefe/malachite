...
pub fn benchmark_natural_clone_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_natural_clone_from_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_natural_assign_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
