...
pub fn demo_exhaustive_natural_not(limit: usize) {
    for n in exhaustive_naturals().take(limit) {
        println!("!({}) = {}", n.clone(), !n);
    }
}

pub fn demo_random_natural_not(limit: usize) {
    for n in random_naturals(&EXAMPLE_SEED, 32).take(limit) {
        println!("!({}) = {}", n.clone(), !n);
    }
}

pub fn demo_exhaustive_natural_not_ref(limit: usize) {
    for n in exhaustive_naturals().take(limit) {
        println!("!(&{}) = {}", n, !&n);
    }
}

pub fn demo_random_natural_not_ref(limit: usize) {
    for n in random_naturals(&EXAMPLE_SEED, 32).take(limit) {
        println!("!(&{}) = {}", n, !&n);
    }
}

pub fn benchmark_exhaustive_natural_not(limit: usize, file_name: &str) {
...
pub fn benchmark_random_natural_not(limit: usize, scale: u32, file_name: &str) {
...
pub fn benchmark_exhaustive_natural_not_evaluation_strategy(limit: usize, file_name: &str) {
...
pub fn benchmark_random_natural_not_evaluation_strategy(limit: usize, scale: u32, file_name: &str) {
