...
fn demo_natural_partial_cmp_u32(gm: GenerationMode, limit: usize) {
...
fn demo_u32_partial_cmp_natural(gm: GenerationMode, limit: usize) {
...
fn benchmark_natural_partial_cmp_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
    m_run_benchmark(
        "Natural.partial_cmp(&u32)",
...
fn benchmark_u32_partial_cmp_natural_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
    m_run_benchmark(
        "u32.partial_cmp(&Natural)",
        BenchmarkType::LibraryComparison,
