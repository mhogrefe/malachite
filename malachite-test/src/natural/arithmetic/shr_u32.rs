...
fn demo_natural_shr_round_assign_u32(gm: GenerationMode, limit: usize) {
...
fn demo_natural_shr_round_u32(gm: GenerationMode, limit: usize) {
...
fn demo_natural_shr_round_u32_ref(gm: GenerationMode, limit: usize) {
    for (n, u, rm) in triples_of_natural_small_u32_and_rounding_mode_var_1(gm).take(limit) {
        println!(
            "(&{}).shr_round({}, {}) = {}",
            n,
...
fn benchmark_natural_shr_u32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_natural_shr_round_assign_u32(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "Natural.shr_round_assign(u32, RoundingMode)",
        BenchmarkType::Single,
        triples_of_natural_small_u32_and_rounding_mode_var_1(gm),
        gm.name(),
        limit,
        file_name,
...
fn benchmark_natural_shr_round_u32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
    m_run_benchmark(
        "Natural.shr_round(u32, RoundingMode)",
        BenchmarkType::EvaluationStrategy,
        triples_of_natural_small_u32_and_rounding_mode_var_1(gm),
        gm.name(),
        limit,
