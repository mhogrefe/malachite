...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    register_demo!(registry, demo_limbs_mod_power_of_2_add_limb);
    register_demo!(registry, demo_limbs_slice_mod_power_of_2_add_limb_in_place);
    register_demo!(registry, demo_limbs_vec_mod_power_of_2_add_limb_in_place);
    register_demo!(registry, demo_limbs_mod_power_of_2_add_greater);
    register_demo!(registry, demo_limbs_mod_power_of_2_add);
    register_demo!(
        registry,
        demo_limbs_slice_mod_power_of_2_add_greater_in_place_left
    );
    register_demo!(registry, demo_limbs_vec_mod_power_of_2_add_in_place_left);
    register_demo!(registry, demo_limbs_mod_power_of_2_add_in_place_either);
    register_demo!(registry, demo_natural_mod_power_of_2_add_assign);
    register_demo!(registry, demo_natural_mod_power_of_2_add_assign_ref);
    register_demo!(registry, demo_natural_mod_power_of_2_add);
    register_demo!(registry, demo_natural_mod_power_of_2_add_val_ref);
    register_demo!(registry, demo_natural_mod_power_of_2_add_ref_val);
    register_demo!(registry, demo_natural_mod_power_of_2_add_ref_ref);
    register_bench!(registry, Small, benchmark_limbs_mod_power_of_2_add_limb);
    register_bench!(
        registry,
        Small,
    ...
    register_bench!(
        registry,
        Small,
        benchmark_limbs_vec_mod_power_of_2_add_limb_in_place
    );
    register_bench!(registry, Small, benchmark_limbs_mod_power_of_2_add_greater);
    register_bench!(registry, Small, benchmark_limbs_mod_power_of_2_add);
    register_bench!(
        registry,
        Small,
    ...
    register_bench!(
        registry,
        Small,
        benchmark_limbs_vec_mod_power_of_2_add_in_place_left
    );
    register_bench!(
        registry,
        Small,
        benchmark_limbs_mod_power_of_2_add_in_place_either
    );
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_natural_mod_power_of_2_add_algorithms
    );
    register_bench!(
        registry,
        Large,
...
fn demo_limbs_mod_power_of_2_add_limb(gm: GenerationMode, limit: usize) {
...
fn demo_limbs_slice_mod_power_of_2_add_limb_in_place(gm: GenerationMode, limit: usize) {
    for (xs, y, pow) in triples_of_limb_vec_limb_and_u64_var_1(gm).take(limit) {
        let mut xs = xs.to_vec();
        let xs_old = xs.clone();
        let carry = limbs_slice_mod_power_of_2_add_limb_in_place(&mut xs, y, pow);
        println!(
            "xs := {:?}; limbs_slice_mod_power_of_2_add_limb_in_place(&mut xs, {}, {}) = {}; \
            xs = {:?}",
...
fn demo_limbs_vec_mod_power_of_2_add_limb_in_place(gm: GenerationMode, limit: usize) {
    for (mut xs, y, pow) in triples_of_limb_vec_limb_and_u64_var_2(gm).take(limit) {
        ...
        println!(
            "xs := {:?}; limbs_vec_mod_power_of_2_add_limb_in_place(&mut xs, {}, {}); xs = {:?}",
            xs_old, y, pow, xs
        );
    }
}

fn demo_limbs_mod_power_of_2_add_greater(gm: GenerationMode, limit: usize) {
...
fn demo_limbs_mod_power_of_2_add(gm: GenerationMode, limit: usize) {
...
fn demo_limbs_slice_mod_power_of_2_add_greater_in_place_left(gm: GenerationMode, limit: usize) {
    for (xs, ys, pow) in triples_of_limb_vec_limb_vec_and_u64_var_14(gm).take(limit) {
        let mut xs = xs.to_vec();
        let xs_old = xs.clone();
        let carry = limbs_slice_mod_power_of_2_add_greater_in_place_left(&mut xs, &ys, pow);
        println!(
            "xs := {:?}; limbs_slice_mod_power_of_2_add_greater_in_place_left(&mut xs, {:?}, {}) \
            = {}; xs = {:?}",
...
fn demo_limbs_vec_mod_power_of_2_add_in_place_left(gm: GenerationMode, limit: usize) {
    for (xs, ys, pow) in triples_of_limb_vec_limb_vec_and_u64_var_13(gm).take(limit) {
        let mut xs = xs.to_vec();
        let xs_old = xs.clone();
        limbs_vec_mod_power_of_2_add_in_place_left(&mut xs, &ys, pow);
        println!(
            "xs := {:?}; limbs_vec_mod_power_of_2_add_in_place_left(&mut xs, {:?}, {}); \
            xs = {:?}",
            xs_old, ys, pow, xs
        );
    }
...
fn demo_limbs_mod_power_of_2_add_in_place_either(gm: GenerationMode, limit: usize) {
    for (xs, ys, pow) in triples_of_limb_vec_limb_vec_and_u64_var_13(gm).take(limit) {
        let mut xs = xs.to_vec();
        ...
        println!(
            "xs := {:?}; ys := {:?}; limbs_mod_power_of_2_add_in_place_either(&mut xs, &mut ys, \
            {}) = {}; xs = {:?}; ys = {:?}",
...
fn demo_natural_mod_power_of_2_add_assign(gm: GenerationMode, limit: usize) {
...
fn demo_natural_mod_power_of_2_add_assign_ref(gm: GenerationMode, limit: usize) {
    for (mut x, y, pow) in triples_of_natural_natural_and_u64_var_1(gm).take(limit) {
        let x_old = x.clone();
        x.mod_power_of_2_add_assign(&y, pow);
        println!(
...
fn demo_natural_mod_power_of_2_add(gm: GenerationMode, limit: usize) {
...
fn demo_natural_mod_power_of_2_add_val_ref(gm: GenerationMode, limit: usize) {
    for (x, y, pow) in triples_of_natural_natural_and_u64_var_1(gm).take(limit) {
        let x_old = x.clone();
        println!(
            "{} + {} === {} mod 2^{}",
...
fn demo_natural_mod_power_of_2_add_ref_val(gm: GenerationMode, limit: usize) {
    for (x, y, pow) in triples_of_natural_natural_and_u64_var_1(gm).take(limit) {
        let y_old = y.clone();
        println!(
            "{} + {} === {} mod 2^{}",
...
fn demo_natural_mod_power_of_2_add_ref_ref(gm: GenerationMode, limit: usize) {
    for (x, y, pow) in triples_of_natural_natural_and_u64_var_1(gm).take(limit) {
        println!(
            "{} + {} === {} mod 2^{}",
            x,
...
fn benchmark_limbs_mod_power_of_2_add_limb(gm: GenerationMode, limit: usize, file_name: &str) {
    run_benchmark_old(
        ...
        &mut [(
            "Malachite",
            &mut (|(xs, y, pow)| no_out!(limbs_mod_power_of_2_add_limb(&xs, y, pow))),
        )],
    );
}
...
fn benchmark_limbs_vec_mod_power_of_2_add_limb_in_place(
    ...
    run_benchmark_old(
        ...
        &mut [(
            "Malachite",
            &mut (|(mut limbs, limb, pow)| {
                limbs_vec_mod_power_of_2_add_limb_in_place(&mut limbs, limb, pow)
            }),
        )],
    );
}

fn benchmark_limbs_mod_power_of_2_add_greater(gm: GenerationMode, limit: usize, file_name: &str) {
    run_benchmark_old(
        ...
        &mut [(
            "Malachite",
            &mut (|(ref xs, ref ys, pow)| no_out!(limbs_mod_power_of_2_add_greater(xs, ys, pow))),
        )],
    );
}

fn benchmark_limbs_mod_power_of_2_add(gm: GenerationMode, limit: usize, file_name: &str) {
    run_benchmark_old(
        ...
        &mut [(
            "Malachite",
            &mut (|(ref xs, ref ys, pow)| no_out!(limbs_mod_power_of_2_add(xs, ys, pow))),
        )],
    );
}
...
fn benchmark_natural_mod_power_of_2_add_algorithms(
    ...
    run_benchmark_old(
        ...
        &mut [
            ...
            (
                "using mod_add",
                &mut (|(x, y, pow)| no_out!(x.mod_add(y, Natural::power_of_2(pow)))),
            ),
        ],
    );
}
