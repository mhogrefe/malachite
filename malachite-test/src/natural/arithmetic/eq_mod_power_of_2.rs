...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    register_demo!(registry, demo_limbs_eq_limb_mod_power_of_2);
    register_demo!(registry, demo_limbs_eq_mod_power_of_2);
    register_demo!(registry, demo_natural_eq_mod_power_of_2);
    register_bench!(registry, Small, benchmark_limbs_eq_limb_mod_power_of_2);
    register_bench!(registry, Small, benchmark_limbs_eq_mod_power_of_2);
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_natural_eq_mod_power_of_2_algorithms
    );
}

fn demo_limbs_eq_limb_mod_power_of_2(gm: GenerationMode, limit: usize) {
...
fn demo_limbs_eq_mod_power_of_2(gm: GenerationMode, limit: usize) {
...
fn demo_natural_eq_mod_power_of_2(gm: GenerationMode, limit: usize) {
...
fn benchmark_limbs_eq_limb_mod_power_of_2(gm: GenerationMode, limit: usize, file_name: &str) {
    run_benchmark_old(
        ...
        &mut [(
            "Malachite",
            &mut (|(ref limbs, limb, pow)| no_out!(limbs_eq_limb_mod_power_of_2(limbs, limb, pow))),
        )],
    );
}

fn benchmark_limbs_eq_mod_power_of_2(gm: GenerationMode, limit: usize, file_name: &str) {
    run_benchmark_old(
        "limbs_eq_mod_power_of_2(&[u32], &[u32], u64)",
        BenchmarkType::Single,
        ...
        &mut [(
            "Malachite",
            &mut (|(ref xs, ref ys, pow)| no_out!(limbs_eq_mod_power_of_2(xs, ys, pow))),
        )],
    );
}
