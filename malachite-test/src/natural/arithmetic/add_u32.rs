...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_demo!(registry, demo_natural_add_assign_u32);
    register_demo!(registry, demo_natural_add_u32);
    register_demo!(registry, demo_natural_add_u32_ref);
    register_demo!(registry, demo_u32_add_natural);
    register_demo!(registry, demo_u32_add_natural_ref);
...
fn demo_natural_add_assign_u32(gm: GenerationMode, limit: usize) {
...
fn demo_natural_add_u32(gm: GenerationMode, limit: usize) {
...
fn demo_natural_add_u32_ref(gm: GenerationMode, limit: usize) {
    for (n, u) in pairs_of_natural_and_unsigned::<u32>(gm).take(limit) {
        println!("&{} + {} = {}", n, u, &n + u);
    }
}

fn demo_u32_add_natural(gm: GenerationMode, limit: usize) {
...
fn demo_u32_add_natural_ref(gm: GenerationMode, limit: usize) {
    for (u, n) in pairs_of_unsigned_and_natural::<u32>(gm).take(limit) {
        let n_old = n.clone();
        println!("{} + &{} = {}", u, n_old, u + &n);
    }
...
fn benchmark_limbs_add_limb_to_out(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "limbs_add_limb_to_out(&mut [u32], &[u32], u32)",
        BenchmarkType::Single,
        ...
        &mut [(
            ...
            &mut (|(mut out_limbs, in_limbs, limb)| {
                no_out!(limbs_add_limb_to_out(&mut out_limbs, &in_limbs, limb))
            }),
        )],
    );
}
...
fn benchmark_limbs_slice_add_limb_in_place(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "limbs_slice_add_limb_in_place(&mut [u32], u32)",
        BenchmarkType::Single,
        pairs_of_unsigned_vec_and_unsigned(gm),
        gm.name(),
        limit,
...
fn benchmark_natural_add_assign_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_natural_add_u32_library_comparison(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "Natural + u32",
        BenchmarkType::LibraryComparison,
...
fn benchmark_natural_add_u32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_u32_add_natural_library_comparison(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "u32 + Natural",
        BenchmarkType::LibraryComparison,
...
fn benchmark_u32_add_natural_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
