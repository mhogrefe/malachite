...
use inputs::base::{
    pairs_of_unsigned_vec_var_10, quadruples_of_three_unsigned_vecs_and_unsigned_var_1,
    quadruples_of_three_unsigned_vecs_and_unsigned_var_2, sextuples_of_limbs_var_1,
