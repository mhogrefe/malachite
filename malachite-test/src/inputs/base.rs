...
pub fn pairs_of_unsigneds_var_1<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = (T, T)>> {
    Box::new(pairs_of_unsigneds(gm).filter(|&(x, y)| x >= y))
}

pub fn pairs_of_signeds<T: PrimitiveSigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = (T, T)>>
where
    T::UnsignedOfEqualWidth: Rand,
...
pub fn triples_of_signeds<T: PrimitiveSigned + Rand>(
    gm: GenerationMode,
...
pub fn pairs_of_signed_limb_and_nonzero_signed_limb_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (SignedLimb, SignedLimb)>> {
    Box::new(
...
pub fn triples_of_unsigneds<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = (T, T, T)>> {
    match gm {
...
pub fn odd_limbs(gm: GenerationMode) -> Box<Iterator<Item = Limb>> {
    Box::new(u32s_range_2(gm).map(|u| (u << 1) + 1))
}

// All pairs of `u32`s smaller than `NUMBER_OF_CHARS`.
pub fn pairs_of_limbs_range_1(gm: NoSpecialGenerationMode) -> Box<Iterator<Item = (u32, u32)>> {
    match gm {
...
pub fn small_unsigneds<T: PrimitiveUnsigned + Rand>(
...
pub fn small_positive_unsigneds<T: PrimitiveUnsigned + Rand>(
    gm: NoSpecialGenerationMode,
) -> Box<Iterator<Item = T>> {
    match gm {
...
pub fn pairs_of_limb_and_positive_limb_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Limb, Limb)>> {
    Box::new(
...
pub fn pairs_of_signed_limb_and_positive_limb_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (SignedLimb, Limb)>> {
    Box::new(
...
pub fn pairs_of_limb_and_nonzero_signed_limb_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Limb, SignedLimb)>> {
    Box::new(
...
fn random_pairs_of_primitive_and_rounding_mode<T: PrimitiveInteger + Rand>(
...
pub fn triples_of_limb_positive_limb_and_rounding_mode_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Limb, Limb, RoundingMode)>> {
    Box::new(
...
pub fn triples_of_signed_limb_nonzero_signed_limb_and_rounding_mode_var_1(
    gm: GenerationMode,
) -> Box<Iterator<Item = (SignedLimb, SignedLimb, RoundingMode)>> {
    Box::new(
...
pub fn vecs_of_unsigned<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
...
pub fn nonempty_vecs_of_unsigned<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = Vec<T>>> {
...
pub fn vecs_of_unsigned_var_1<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = Vec<T>>> {
    Box::new(
...
pub fn vecs_of_unsigned_var_2<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = Vec<T>>> {
    Box::new(
        vecs_of_unsigned(gm).filter(|limbs| limbs.is_empty() || *limbs.last().unwrap() != T::ZERO),
...
pub fn vecs_of_unsigned_var_3<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = Vec<T>>> {
...
// not zero.
pub fn vecs_of_unsigned_var_4<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
) -> Box<Iterator<Item = Vec<T>>> {
    Box::new(
...
pub fn vecs_of_unsigned_var_5(gm: GenerationMode) -> Box<Iterator<Item = Vec<Limb>>> {
    Box::new(
        vecs_of_unsigned(gm)
...
pub fn triples_of_limb_vec_var_5(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, Vec<Limb>, Vec<Limb>)>> {
    Box::new(
...
pub fn triples_of_limb_vec_var_6(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, Vec<Limb>, Vec<Limb>)>> {
    Box::new(
        triples_of_unsigned_vec(gm).filter(|&(ref xs, ref ys, ref zs)| {
...
pub fn triples_of_limb_vec_var_7(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, Vec<Limb>, Vec<Limb>)>> {
    Box::new(
        triples_of_unsigned_vec(gm).filter(|&(ref xs, ref ys, ref zs)| {
...
pub fn triples_of_limb_vec_var_8(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, Vec<Limb>, Vec<Limb>)>> {
    Box::new(
        triples_of_unsigned_vec(gm).filter(|&(ref xs, ref ys, ref zs)| {
...
fn exhaustive_pairs_of_unsigned_vec_and_unsigned<T: PrimitiveUnsigned + Rand>(
...
pub fn pairs_of_limb_vec_and_positive_limb_var_2(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, Limb)>> {
    Box::new(
...
// the `Vec`.
pub fn pairs_of_limb_vec_and_small_u64_var_2(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, u64)>> {
    Box::new(
        pairs_of_unsigned_vec_and_small_unsigned(gm)
...
pub fn pairs_of_limb_vec_and_small_u64_var_3(
    gm: GenerationMode,
) -> Box<Iterator<Item = (Vec<Limb>, u64)>> {
    Box::new(
