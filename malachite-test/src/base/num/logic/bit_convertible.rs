...
macro_rules! unsigned {
    (
        ...
        $to_bits_asc_bench_name:ident,
        $to_bits_desc_demo_name:ident,
        $to_bits_desc_bench_name:ident,
        ...
        fn $to_bits_asc_bench_name(gm: GenerationMode, limit: usize, file_name: &str) {
        ...
        fn $to_bits_desc_bench_name(gm: GenerationMode, limit: usize, file_name: &str) {
