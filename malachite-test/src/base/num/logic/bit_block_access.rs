...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_bench!(registry, None, benchmark_u8_get_bits);
    register_bench!(registry, None, benchmark_u16_get_bits);
    register_bench!(registry, None, benchmark_u32_get_bits);
    register_bench!(registry, None, benchmark_u64_get_bits);
    register_bench!(registry, None, benchmark_usize_get_bits);
    register_bench!(registry, None, benchmark_i8_get_bits);
    register_bench!(registry, None, benchmark_i16_get_bits);
    register_bench!(registry, None, benchmark_i32_get_bits);
    register_bench!(registry, None, benchmark_i64_get_bits);
    register_bench!(registry, None, benchmark_isize_get_bits);
}
...
fn benchmark_unsigned_get_bits<T: PrimitiveUnsigned + Rand>(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_signed_get_bits<T: PrimitiveSigned + Rand>(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) where
...
macro_rules! unsigned {
    (
        ...
        fn $get_bits_bench_name(gm: GenerationMode, limit: usize, file_name: &str) {
            benchmark_unsigned_get_bits::<$t>(gm, limit, file_name);
        }
    };
}
...
macro_rules! signed {
    (
        ...
        fn $get_bits_bench_name(gm: GenerationMode, limit: usize, file_name: &str) {
            benchmark_signed_get_bits::<$t>(gm, limit, file_name);
        }
    };
}

unsigned!(u8, demo_u8_get_bits, benchmark_u8_get_bits);
unsigned!(u16, demo_u16_get_bits, benchmark_u16_get_bits);
unsigned!(u32, demo_u32_get_bits, benchmark_u32_get_bits);
unsigned!(u64, demo_u64_get_bits, benchmark_u64_get_bits);
unsigned!(usize, demo_usize_get_bits, benchmark_usize_get_bits);
signed!(i8, demo_i8_get_bits, benchmark_i8_get_bits);
signed!(i16, demo_i16_get_bits, benchmark_i16_get_bits);
signed!(i32, demo_i32_get_bits, benchmark_i32_get_bits);
signed!(i64, demo_i64_get_bits, benchmark_i64_get_bits);
signed!(isize, demo_isize_get_bits, benchmark_isize_get_bits);
