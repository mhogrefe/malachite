...
fn demo_unsigned_set_bit<T: PrimitiveUnsigned>(gm: GenerationMode, limit: usize) {
...
fn demo_signed_set_bit<T: PrimitiveSigned>(gm: GenerationMode, limit: usize) {
...
fn benchmark_signed_set_bit<T: PrimitiveSigned>(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        &format!("{}.set_bit(u64)", T::NAME),
        BenchmarkType::Single,
