...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_bench!(registry, None, benchmark_u8_mod_mul);
    register_bench!(registry, None, benchmark_u16_mod_mul);
    register_bench!(registry, None, benchmark_u32_mod_mul);
    register_bench!(registry, None, benchmark_u64_mod_mul);
    register_bench!(registry, None, benchmark_usize_mod_mul);
...
fn benchmark_mod_mul<T: PrimitiveUnsigned + Rand + SampleRange>(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
    m_run_benchmark(
        ...
        &mut [("malachite", &mut (|(x, y, m)| no_out!(x.mod_mul(y, m))))],
    );
}
...
macro_rules! unsigned {
    (
        ...
        fn $bench_name(gm: GenerationMode, limit: usize, file_name: &str) {
            benchmark_mod_mul::<$t>(gm, limit, file_name);
        }
