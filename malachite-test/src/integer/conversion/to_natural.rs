...
pub fn benchmark_integer_to_natural(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        xs: integers(gm),
        function_f: &mut (|n: Integer| n.into_natural()),
        x_cons: &(|x| x.clone()),
        x_param: &(|n| n.significant_bits() as usize),
        limit,
        f_name: "malachite",
        title: "Integer.to_natural()",
...
pub fn benchmark_integer_to_natural_evaluation_strategy(
    ...
    benchmark_2(BenchmarkOptions2 {
        xs: integers(gm),
        function_f: &mut (|n: Integer| n.into_natural()),
        function_g: &mut (|n: Integer| n.to_natural()),
        x_cons: &(|x| x.clone()),
        y_cons: &(|x| x.clone()),
        x_param: &(|n| n.significant_bits() as usize),
        limit,
        f_name: "into_natural (by value)",
        g_name: "to_natural (by reference)",
        title: "Integer.to_natural()",
        x_axis_label: "n.significant_bits()",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
