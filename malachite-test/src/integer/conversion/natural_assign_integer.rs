...
pub fn benchmark_exhaustive_natural_assign_integer_evaluation_strategy(
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_random_natural_assign_integer_evaluation_strategy(
    limit: usize,
    scale: u32,
    file_name: &str,
) {
