...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    register_demo!(registry, demo_integer_assign_u32);
    register_bench!(
        registry,
        Large,
...
fn demo_integer_assign_u32(gm: GenerationMode, limit: usize) {
...
fn benchmark_integer_assign_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
