...
use inputs::base::{pairs_of_u32_vec_and_u32_var_1, triples_of_u32_vec_u32_vec_and_u32_var_2};
use inputs::integer::{
...
pub fn integer_xor_u32_alt_1(n: &Integer, i: u32) -> Integer {
    integer_xor_alt_1(n, &Integer::from(i))
}

pub fn integer_xor_u32_alt_2(n: &Integer, i: u32) -> Integer {
...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_demo!(registry, demo_integer_xor_assign_u32);
    register_demo!(registry, demo_integer_xor_u32);
    register_demo!(registry, demo_integer_xor_u32_ref);
    register_demo!(registry, demo_u32_xor_integer);
    register_demo!(registry, demo_u32_xor_integer_ref);
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_xor_assign_u32_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_integer_xor_u32_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_integer_xor_u32_evaluation_strategy
    );
    register_bench!(registry, Large, benchmark_integer_xor_u32_algorithms);
    register_bench!(
        registry,
        Large,
        benchmark_u32_xor_integer_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_u32_xor_integer_evaluation_strategy
    );
}
...
fn demo_limbs_neg_xor_limb_to_out(gm: GenerationMode, limit: usize) {
    for (out_limbs, in_limbs, limb) in triples_of_u32_vec_u32_vec_and_u32_var_2(gm).take(limit) {
...
fn demo_integer_xor_assign_u32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_xor_u32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_xor_u32_ref(gm: GenerationMode, limit: usize) {
    for (n, u) in pairs_of_integer_and_unsigned::<u32>(gm).take(limit) {
        println!("&{} ^ {} = {}", n, u, &n ^ u);
    }
}

fn demo_u32_xor_integer(gm: GenerationMode, limit: usize) {
...
fn demo_u32_xor_integer_ref(gm: GenerationMode, limit: usize) {
    for (u, n) in pairs_of_unsigned_and_integer::<u32>(gm).take(limit) {
        println!("{} ^ &{} = {}", u, n, u ^ &n);
    }
}
...
fn benchmark_limbs_neg_xor_limb_to_out(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "limbs_neg_xor_limb_to_out(&mut [u32], &[u32], u32)",
        BenchmarkType::Single,
        triples_of_u32_vec_u32_vec_and_u32_var_2(gm),
        gm.name(),
        limit,
        file_name,
...
fn benchmark_limbs_slice_neg_xor_limb_in_place(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "limbs_neg_slice_xor_limb_in_place(&mut [u32], u32)",
        BenchmarkType::Single,
        pairs_of_u32_vec_and_u32_var_1(gm),
        gm.name(),
        limit,
...
fn benchmark_limbs_vec_neg_xor_limb_in_place(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "limbs_neg_vec_xor_limb_in_place(&mut [u32], u32)",
        BenchmarkType::Single,
        pairs_of_u32_vec_and_u32_var_1(gm),
        gm.name(),
        limit,
...
fn benchmark_integer_xor_assign_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_xor_u32_library_comparison(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "Integer ^ u32",
        BenchmarkType::LibraryComparison,
        rm_pairs_of_integer_and_unsigned::<u32>(gm),
...
fn benchmark_integer_xor_u32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_xor_u32_algorithms(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "Integer ^ u32",
        ...
        &mut [
            ...
            (
                ...
                &mut (|(x, y)| no_out!(integer_xor_u32_alt_1(&x, y))),
            ),
            (
                "using limbs explicitly",
                &mut (|(x, y)| no_out!(integer_xor_u32_alt_2(&x, y))),
            ),
        ],
    );
}

fn benchmark_u32_xor_integer_library_comparison(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        "u32 ^ Integer",
        BenchmarkType::LibraryComparison,
...
fn benchmark_u32_xor_integer_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
