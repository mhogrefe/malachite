...
pub fn demo_exhaustive_integer_from_twos_complement_limbs_le(limit: usize) {
    for xs in exhaustive_vecs(exhaustive_u::<u32>()).take(limit) {
        println!("from_twos_complement_limbs_le({:?}) = {:?}",
                 xs,
...
pub fn demo_exhaustive_integer_from_twos_complement_limbs_be(limit: usize) {
    for xs in exhaustive_vecs(exhaustive_u::<u32>()).take(limit) {
        println!("from_twos_complement_limbs_be({:?}) = {:?}",
                 xs,
...
pub fn benchmark_exhaustive_integer_from_twos_complement_limbs_le(limit: usize, file_name: &str) {
    ...
    benchmark_2(BenchmarkOptions2 {
                    ...
                    function_f: &(|xs: Vec<u32>| {
                                      gmp::Integer::from_twos_complement_limbs_le(xs.as_slice())
                                  }),
                    function_g: &(|xs: Vec<u32>| {
                                      native::Integer::from_twos_complement_limbs_le(xs.as_slice())
                                  }),
                    x_cons: &(|xs| xs.clone()),
                    y_cons: &(|xs| xs.clone()),
                    x_param: &(|xs| xs.len()),
...
pub fn benchmark_random_integer_from_twos_complement_limbs_le(limit: usize,
                                                              scale: u32,
                                                              file_name: &str) {
...
pub fn benchmark_exhaustive_integer_from_twos_complement_limbs_be(limit: usize, file_name: &str) {
    ...
    benchmark_2(BenchmarkOptions2 {
                    ...
                    function_g: &(|xs: Vec<u32>| {
                                      native::Integer::from_twos_complement_limbs_be(xs.as_slice())
                                  }),
                    x_cons: &(|xs| xs.clone()),
                    y_cons: &(|xs| xs.clone()),
                    x_param: &(|xs| xs.len()),
...
pub fn benchmark_random_integer_from_twos_complement_limbs_be(limit: usize,
                                                              scale: u32,
                                                              file_name: &str) {
