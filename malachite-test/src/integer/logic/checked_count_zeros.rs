...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_bench!(registry, Large, benchmark_integer_checked_count_zeros);
}
...
fn benchmark_integer_checked_count_zeros(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
        ...
        "n.significant_bits()",
        &mut [("malachite", &mut (|n| no_out!(n.checked_count_zeros())))],
    );
}
