...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_demo!(registry, demo_integer_shr_i32);
...
fn demo_integer_shr_assign_i32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_shr_i32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_shr_i32_ref(gm: GenerationMode, limit: usize) {
    for (n, i) in pairs_of_integer_and_small_i32(gm).take(limit) {
        println!("&{} >> {} = {}", n, i, &n >> i);
    }
}

fn demo_integer_shr_round_assign_i32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_shr_round_i32(gm: GenerationMode, limit: usize) {
...
fn demo_integer_shr_round_i32_ref(gm: GenerationMode, limit: usize) {
    for (n, i, rm) in triples_of_integer_small_i32_and_rounding_mode_var_2(gm).take(limit) {
        println!(
            "(&{}).shr_round({}, {}) = {}",
            n,
...
fn benchmark_integer_shr_i32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_shr_round_assign_i32(gm: GenerationMode, limit: usize, file_name: &str) {
    m_run_benchmark(
...
fn benchmark_integer_shr_round_i32_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
