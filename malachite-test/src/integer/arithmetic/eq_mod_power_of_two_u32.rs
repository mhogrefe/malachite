...
use natural::arithmetic::eq_mod_power_of_two_u32::rug_eq_mod_power_of_two_u32;
...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_eq_mod_power_of_two_u32_library_comparison
    );
    register_bench!(
        registry,
        Large,
...
fn benchmark_integer_eq_mod_power_of_two_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
