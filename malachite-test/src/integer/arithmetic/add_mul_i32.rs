...
pub fn benchmark_integer_add_mul_assign_i32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        ...
        function_f: &mut (|(mut a, b, c): (Integer, Integer, i32)| a.add_mul_assign(b, c)),
        x_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "malachite",
        title: "Integer.add_mul_assign(Integer, i32)",
...
pub fn benchmark_integer_add_mul_assign_i32_evaluation_strategy(
    ...
    benchmark_2(BenchmarkOptions2 {
        xs: triples_of_integer_integer_and_signed::<i32>(gm),
        function_f: &mut (|(mut a, b, c): (Integer, Integer, i32)| a.add_mul_assign(b, c)),
        function_g: &mut (|(mut a, b, c): (Integer, Integer, i32)| a.add_mul_assign(&b, c)),
        x_cons: &(|t| t.clone()),
        y_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "Integer.add_mul_assign(Integer, i32)",
        g_name: "Integer.add_mul_assign(&Integer, i32)",
        title: "Integer.add_mul_assign(Integer, i32) evaluation strategy",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_assign_i32_algorithms(
    ...
    benchmark_2(BenchmarkOptions2 {
        ...
        title: "Integer.add_mul_assign(Integer, i32) algorithms",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_i32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        xs: triples_of_integer_integer_and_signed::<i32>(gm),
        function_f: &mut (|(a, b, c): (Integer, Integer, i32)| a.add_mul(b, c)),
        x_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "malachite",
        title: "Integer.add_mul(Integer, i32)",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_i32_evaluation_strategy(
    ...
    benchmark_4(BenchmarkOptions4 {
        xs: triples_of_integer_integer_and_signed::<i32>(gm),
        function_f: &mut (|(a, b, c): (Integer, Integer, i32)| a.add_mul(b, c)),
        function_g: &mut (|(a, b, c): (Integer, Integer, i32)| a.add_mul(&b, c)),
        function_h: &mut (|(a, b, c): (Integer, Integer, i32)| (&a).add_mul(b, c)),
        function_i: &mut (|(a, b, c): (Integer, Integer, i32)| (&a).add_mul(&b, c)),
        x_cons: &(|t| t.clone()),
        y_cons: &(|t| t.clone()),
        z_cons: &(|t| t.clone()),
        w_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "Integer.add_mul(Integer, i32)",
        g_name: "Integer.add_mul(&Integer, i32)",
        h_name: "(&Integer).add_mul(Integer, i32)",
        i_name: "(&Integer).add_mul(&Integer, i32)",
        title: "Integer.add_mul(&Integer, i32) evaluation strategy",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_i32_algorithms(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_2(BenchmarkOptions2 {
        ...
        f_name: "Integer.add_mul(Integer, i32)",
        g_name: "Integer + Integer * i32",
        title: "Integer.add_mul(Integer, i32) algorithms",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
