...
pub fn benchmark_integer_mul_assign_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_integer_mul_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_u32_mul_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
