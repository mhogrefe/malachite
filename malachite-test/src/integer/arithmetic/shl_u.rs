...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_demo!(registry, demo_integer_shl_assign_limb);
    ...
    register_demo!(registry, demo_integer_shl_limb);
    ...
    register_demo!(registry, demo_integer_shl_limb_ref);
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shl_limb_evaluation_strategy
    );
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shl_assign_limb_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_integer_shl_limb_library_comparison
    );
}
...
demos_and_benches!(
    u32,
    demo_integer_shl_assign_limb,
    demo_integer_shl_limb,
    demo_integer_shl_limb_ref,
    benchmark_integer_shl_limb_evaluation_strategy
);
demos_and_benches!(
    u64,
...
fn benchmark_integer_shl_assign_limb_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_shl_limb_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
