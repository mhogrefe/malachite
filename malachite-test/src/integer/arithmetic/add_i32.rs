...
pub fn benchmark_integer_add_assign_i32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_integer_add_i32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_i32_add_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
