...
pub fn benchmark_integer_sub_mul_assign_u32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        ...
        function_f: &(|(mut a, b, c): (Integer, Integer, u32)| a.sub_mul_assign(b, c)),
        x_cons: &(|t| t.clone()),
...
pub fn benchmark_integer_sub_mul_assign_u32_evaluation_strategy(
    ...
    benchmark_2(BenchmarkOptions2 {
        xs: triples_of_integer_integer_and_unsigned::<u32>(gm),
        function_f: &(|(mut a, b, c): (Integer, Integer, u32)| a.sub_mul_assign(b, c)),
        function_g: &(|(mut a, b, c): (Integer, Integer, u32)| a.sub_mul_assign(&b, c)),
        x_cons: &(|t| t.clone()),
        y_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
...
pub fn benchmark_integer_sub_mul_u32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        xs: triples_of_integer_integer_and_unsigned::<u32>(gm),
        function_f: &(|(a, b, c): (Integer, Integer, u32)| a.sub_mul(b, c)),
        x_cons: &(|t| t.clone()),
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "malachite",
...
pub fn benchmark_integer_sub_mul_u32_evaluation_strategy(
    ...
    benchmark_4(BenchmarkOptions4 {
        xs: triples_of_integer_integer_and_unsigned::<u32>(gm),
        function_f: &(|(a, b, c): (Integer, Integer, u32)| a.sub_mul(b, c)),
        function_g: &(|(a, b, c): (Integer, Integer, u32)| a.sub_mul(&b, c)),
        function_h: &(|(a, b, c): (Integer, Integer, u32)| (&a).sub_mul(b, c)),
        function_i: &(|(a, b, c): (Integer, Integer, u32)| (&a).sub_mul(&b, c)),
        x_cons: &(|t| t.clone()),
        y_cons: &(|t| t.clone()),
        z_cons: &(|t| t.clone()),
        w_cons: &(|t| t.clone()),
