...
pub fn benchmark_integer_add_mul_assign_u32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        ...
        limit,
        f_name: "malachite",
        title: "Integer.add_mul_assign(Integer, u32)",
...
pub fn benchmark_integer_add_mul_assign_u32_evaluation_strategy(
    ...
    benchmark_2(BenchmarkOptions2 {
        ...
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "Integer.add_mul_assign(Integer, u32)",
        g_name: "Integer.add_mul_assign(&Integer, u32)",
        title: "Integer.add_mul_assign(Integer, u32) evaluation strategy",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_assign_u32_algorithms(
    ...
    benchmark_2(BenchmarkOptions2 {
        ...
        title: "Integer.add_mul_assign(Integer, u32) algorithms",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_u32(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_1(BenchmarkOptions1 {
        ...
        limit,
        f_name: "malachite",
        title: "Integer.add_mul(Integer, u32)",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_u32_evaluation_strategy(
    ...
    benchmark_4(BenchmarkOptions4 {
        ...
        x_param: &(|&(ref a, ref b, _)| max(a.significant_bits(), b.significant_bits()) as usize),
        limit,
        f_name: "Integer.add_mul(Integer, u32)",
        g_name: "Integer.add_mul(&Integer, u32)",
        h_name: "(&Integer).add_mul(Integer, u32)",
        i_name: "(&Integer).add_mul(&Integer, u32)",
        title: "Integer.add_mul(&Integer, u32) evaluation strategy",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
...
pub fn benchmark_integer_add_mul_u32_algorithms(gm: GenerationMode, limit: usize, file_name: &str) {
    ...
    benchmark_2(BenchmarkOptions2 {
        ...
        f_name: "Integer.add_mul(Integer, u32)",
        g_name: "Integer + Integer * u32",
        title: "Integer.add_mul(Integer, u32) algorithms",
        x_axis_label: "max(a.significant_bits(), b.significant_bits())",
        y_axis_label: "time (ns)",
        file_name: &format!("benchmarks/{}", file_name),
    });
