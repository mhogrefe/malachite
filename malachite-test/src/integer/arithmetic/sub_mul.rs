...
type NT = (native::Integer, native::Integer, native::Integer);
type It = Iterator<Item = (gmp::Integer, gmp::Integer, gmp::Integer)>;
...
pub fn benchmark_integer_sub_mul_assign_evaluation_strategy(
    ...
    benchmark_4(BenchmarkOptions4 {
        ...
        function_g: &(|(mut a, b, c): NT| a.sub_mul_assign(b, &c)),
        function_h: &(|(mut a, b, c): NT| a.sub_mul_assign(&b, c)),
        function_i: &(|(mut a, b, c): NT| a.sub_mul_assign(&b, &c)),
...
pub fn benchmark_integer_sub_mul_evaluation_strategy(
    ...
    benchmark_5(BenchmarkOptions5 {
        ...
        function_g: &(|(a, b, c): NT| a.sub_mul(b, &c)),
        function_h: &(|(a, b, c): NT| a.sub_mul(&b, c)),
        function_i: &(|(a, b, c): NT| a.sub_mul(&b, &c)),
        function_j: &(|(a, b, c): NT| (&a).sub_mul(&b, &c)),
        x_cons: &(|&(ref a, ref b, ref c)| {
            (
                gmp_integer_to_native(a),
                gmp_integer_to_native(b),
