...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    register_demo!(registry, demo_integer_sub_assign_limb);
    register_demo!(registry, demo_integer_sub_limb);
    register_demo!(registry, demo_integer_sub_limb_ref);
    register_demo!(registry, demo_limb_sub_integer);
    register_demo!(registry, demo_limb_sub_integer_ref);
    #[cfg(feature = "32_bit_limbs")]
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_sub_limb_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_integer_sub_limb_evaluation_strategy
    );
    #[cfg(feature = "32_bit_limbs")]
    register_bench!(
        registry,
        Large,
        benchmark_limb_sub_integer_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_limb_sub_integer_evaluation_strategy
    );
}

pub fn num_sub_limb(x: BigInt, u: Limb) -> BigInt {
    x - BigInt::from(u)
}

fn demo_integer_sub_assign_limb(gm: GenerationMode, limit: usize) {
...
fn demo_integer_sub_limb(gm: GenerationMode, limit: usize) {
...
fn demo_integer_sub_limb_ref(gm: GenerationMode, limit: usize) {
    for (n, u) in pairs_of_integer_and_unsigned::<Limb>(gm).take(limit) {
        println!("&{} - {} = {}", n, u, &n - u);
    }
}

fn demo_limb_sub_integer(gm: GenerationMode, limit: usize) {
...
fn demo_limb_sub_integer_ref(gm: GenerationMode, limit: usize) {
    for (u, n) in pairs_of_unsigned_and_integer::<Limb>(gm).take(limit) {
        let n_old = n.clone();
        println!("{} - &{} = {}", u, n_old, u - &n);
    }
...
#[cfg(feature = "32_bit_limbs")]
fn benchmark_integer_sub_assign_limb_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_sub_limb_library_comparison(
    ...
    m_run_benchmark(
        ...
        &mut [
            ...
            ("num", &mut (|((x, y), _, _)| no_out!(num_sub_limb(x, y)))),
...
fn benchmark_integer_sub_limb_library_comparison(
    ...
    m_run_benchmark(
        ...
        &mut [
            ...
            ("num", &mut (|((x, y), _)| no_out!(num_sub_limb(x, y)))),
        ],
    );
}

fn benchmark_integer_sub_limb_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
#[cfg(feature = "32_bit_limbs")]
fn benchmark_limb_sub_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_limb_sub_integer_evaluation_strategy(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
