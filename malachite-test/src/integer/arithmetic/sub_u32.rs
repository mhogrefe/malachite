...
pub fn benchmark_integer_sub_assign_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_integer_sub_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
pub fn benchmark_u32_sub_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
