...
pub(crate) fn register(registry: &mut DemoBenchRegistry) {
    ...
    register_demo!(registry, demo_integer_shr_assign_signed_limb);
    register_demo!(registry, demo_integer_shr_assign_i64);

    register_demo!(registry, demo_integer_shr_i8);
    register_demo!(registry, demo_integer_shr_i16);
    register_demo!(registry, demo_integer_shr_signed_limb);
    register_demo!(registry, demo_integer_shr_i64);

    register_demo!(registry, demo_integer_shr_i8_ref);
    register_demo!(registry, demo_integer_shr_i16_ref);
    register_demo!(registry, demo_integer_shr_signed_limb_ref);
    ...
    register_demo!(registry, demo_integer_shr_round_assign_signed_limb);
    ...
    register_demo!(registry, demo_integer_shr_round_signed_limb);
    ...
    register_demo!(registry, demo_integer_shr_round_signed_limb_ref);
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shr_signed_limb_evaluation_strategy
    );
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shr_round_assign_signed_limb
    );
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shr_round_signed_limb_evaluation_strategy
    );
    register_bench!(
        registry,
        Large,
    ...
    register_bench!(
        registry,
        Large,
        benchmark_integer_shr_assign_signed_limb_library_comparison
    );
    register_bench!(
        registry,
        Large,
        benchmark_integer_shr_signed_limb_library_comparison
    );
}
...
macro_rules! demos_and_benches {
    (
        ...
        fn $demo_integer_shr_i(gm: GenerationMode, limit: usize) {
        ...
        fn $benchmark_integer_shr_i_evaluation_strategy(
            gm: GenerationMode,
            limit: usize,
            file_name: &str,
        ) {
...
demos_and_benches!(
    i32,
    demo_integer_shr_assign_signed_limb,
    demo_integer_shr_signed_limb,
    demo_integer_shr_signed_limb_ref,
    demo_integer_shr_round_assign_signed_limb,
    demo_integer_shr_round_signed_limb,
    demo_integer_shr_round_signed_limb_ref,
    benchmark_integer_shr_signed_limb_evaluation_strategy,
    benchmark_integer_shr_round_assign_signed_limb,
    benchmark_integer_shr_round_signed_limb_evaluation_strategy
);
...
fn benchmark_integer_shr_assign_signed_limb_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_integer_shr_signed_limb_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
