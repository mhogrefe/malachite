...
pub fn demo_exhaustive_integer_add_assign_u32(limit: usize) {
...
pub fn demo_random_integer_add_assign_u32(limit: usize) {
...
pub fn demo_exhaustive_integer_add_u32(limit: usize) {
...
pub fn demo_random_integer_add_u32(limit: usize) {
...
pub fn demo_exhaustive_integer_add_u32_ref(limit: usize) {
    for (n, u) in exhaustive_pairs(exhaustive_integers(), exhaustive_u::<u32>()).take(limit) {
        println!("&{} + {} = {}", n, u, &n + u);
    }
}

pub fn demo_random_integer_add_u32_ref(limit: usize) {
    for (n, u) in random_pairs(
        &EXAMPLE_SEED,
        &(|seed| random_integers(seed, 32)),
        &(|seed| random_x::<u32>(seed)),
...
pub fn demo_exhaustive_u32_add_integer(limit: usize) {
...
pub fn demo_random_u32_add_integer(limit: usize) {
...
pub fn demo_exhaustive_u32_add_integer_ref(limit: usize) {
    for (u, n) in exhaustive_pairs(exhaustive_u::<u32>(), exhaustive_integers()).take(limit) {
        let n_old = n.clone();
        println!("{} + &{} = {}", u, n_old, u + &n);
    }
...
pub fn demo_random_u32_add_integer_ref(limit: usize) {
    for (u, n) in random_pairs(
        &EXAMPLE_SEED,
        &(|seed| random_x::<u32>(seed)),
        &(|seed| random_integers(seed, 32)),
...
pub fn benchmark_exhaustive_integer_add_assign_u32(limit: usize, file_name: &str) {
...
pub fn benchmark_random_integer_add_assign_u32(limit: usize, scale: u32, file_name: &str) {
...
pub fn benchmark_exhaustive_integer_add_u32(limit: usize, file_name: &str) {
    println!("benchmarking exhaustive Integer + u32");
...
pub fn benchmark_random_integer_add_u32(limit: usize, scale: u32, file_name: &str) {
    println!("benchmarking random Integer + u32");
    benchmark_4(BenchmarkOptions4 {
        xs: random_pairs(
            &EXAMPLE_SEED,
...
pub fn benchmark_exhaustive_integer_add_u32_evaluation_strategy(limit: usize, file_name: &str) {
...
pub fn benchmark_random_integer_add_u32_evaluation_strategy(
    limit: usize,
    scale: u32,
    file_name: &str,
) {
...
pub fn benchmark_exhaustive_u32_add_integer(limit: usize, file_name: &str) {
...
pub fn benchmark_random_u32_add_integer(limit: usize, scale: u32, file_name: &str) {
...
pub fn benchmark_exhaustive_u32_add_integer_evaluation_strategy(limit: usize, file_name: &str) {
...
pub fn benchmark_random_u32_add_integer_evaluation_strategy(
    limit: usize,
    scale: u32,
    file_name: &str,
) {
