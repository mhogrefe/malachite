...
pub fn demo_exhaustive_integer_sub_assign(limit: usize) {
...
pub fn demo_random_integer_sub_assign(limit: usize) {
...
pub fn demo_exhaustive_integer_sub_assign_ref(limit: usize) {
    for (mut x, y) in exhaustive_pairs_from_single(exhaustive_integers()).take(limit) {
        let x_old = x.clone();
        x -= &y;
        println!("x := {}; x -= &{}; x = {}", x_old, y, x);
...
pub fn demo_random_integer_sub_assign_ref(limit: usize) {
    for (mut x, y) in random_pairs_from_single(random_integers(&EXAMPLE_SEED, 32)).take(limit) {
        let x_old = x.clone();
        x -= &y;
        println!("x := {}; x -= &{}; x = {}", x_old, y, x);
...
pub fn demo_exhaustive_integer_sub(limit: usize) {
...
pub fn demo_random_integer_sub(limit: usize) {
...
pub fn demo_exhaustive_integer_sub_val_ref(limit: usize) {
    for (x, y) in exhaustive_pairs_from_single(exhaustive_integers()).take(limit) {
        let x_old = x.clone();
        println!("{} - &{} = {}", x_old, y, x - &y);
    }
...
pub fn demo_random_integer_sub_val_ref(limit: usize) {
    for (x, y) in random_pairs_from_single(random_integers(&EXAMPLE_SEED, 32)).take(limit) {
        let x_old = x.clone();
        println!("{} - &{} = {}", x_old, y, x - &y);
    }
...
pub fn demo_exhaustive_integer_sub_ref_val(limit: usize) {
    for (x, y) in exhaustive_pairs_from_single(exhaustive_integers()).take(limit) {
        let y_old = y.clone();
        println!("&{} - {} = {}", x, y_old, &x - y);
    }
...
pub fn demo_random_integer_sub_ref_val(limit: usize) {
    for (x, y) in random_pairs_from_single(random_integers(&EXAMPLE_SEED, 32)).take(limit) {
        let y_old = y.clone();
        println!("&{} - {} = {}", x, y_old, &x - y);
    }
...
pub fn demo_exhaustive_integer_sub_ref_ref(limit: usize) {
    for (x, y) in exhaustive_pairs_from_single(exhaustive_integers()).take(limit) {
        println!("&{} - &{} = {}", x, y, &x - &y);
    }
}

pub fn demo_random_integer_sub_ref_ref(limit: usize) {
    for (x, y) in random_pairs_from_single(random_integers(&EXAMPLE_SEED, 32)).take(limit) {
        println!("&{} - &{} = {}", x, y, &x - &y);
    }
}

pub fn benchmark_exhaustive_integer_sub_assign(limit: usize, file_name: &str) {
...
pub fn benchmark_random_integer_sub_assign(limit: usize, scale: u32, file_name: &str) {
...
pub fn benchmark_exhaustive_integer_sub_assign_evaluation_strategy(limit: usize, file_name: &str) {
...
pub fn benchmark_random_integer_sub_assign_evaluation_strategy(
    limit: usize,
    scale: u32,
    file_name: &str,
) {
...
pub fn benchmark_exhaustive_integer_sub(limit: usize, file_name: &str) {
    println!("benchmarking exhaustive Integer - Integer");
...
pub fn benchmark_random_integer_sub(limit: usize, scale: u32, file_name: &str) {
    println!("benchmarking random Integer - Integer");
    benchmark_4(BenchmarkOptions4 {
        xs: random_pairs_from_single(random_integers(&EXAMPLE_SEED, scale)),
        function_f: &(|(x, y)| x - y),
...
pub fn benchmark_exhaustive_integer_sub_evaluation_strategy(limit: usize, file_name: &str) {
    println!("benchmarking exhaustive Integer - Integer evaluation strategy");
    benchmark_4(BenchmarkOptions4 {
        xs: exhaustive_pairs_from_single(exhaustive_integers()),
        function_f: &(|(x, y)| x - y),
...
pub fn benchmark_random_integer_sub_evaluation_strategy(limit: usize, scale: u32, file_name: &str) {
    println!("benchmarking random Integer - Integer evaluation strategy");
    benchmark_4(BenchmarkOptions4 {
        xs: random_pairs_from_single(random_integers(&EXAMPLE_SEED, scale)),
        function_f: &(|(x, y)| x - y),
