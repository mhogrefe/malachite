...
pub fn benchmark_exhaustive_integer_partial_cmp_abs_natural(limit: usize, file_name: &str) {
    ...
    benchmark_3(BenchmarkOptions3 {
                    ...
                    function_g: &(|(x, y): (native::integer::Integer,
                                            native::natural::Natural)| x.partial_cmp_abs(&y)),
...
pub fn benchmark_random_integer_partial_cmp_abs_natural(limit: usize,
                                                        scale: u32,
                                                        file_name: &str) {
...
pub fn benchmark_exhaustive_natural_partial_cmp_abs_integer(limit: usize, file_name: &str) {
    ...
    benchmark_3(BenchmarkOptions3 {
                    ...
                    function_g: &(|(x, y): (native::natural::Natural,
                                            native::integer::Integer)| x.partial_cmp_abs(&y)),
                    function_h: &(|(x, y): (rugint::Integer, rugint::Integer)| x.cmp_abs(&y)),
                    x_cons: &(|p| p.clone()),
                    y_cons: &(|&(ref x, ref y)| {
...
pub fn benchmark_random_natural_partial_cmp_abs_integer(limit: usize,
                                                        scale: u32,
                                                        file_name: &str) {
