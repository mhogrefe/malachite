...
fn demo_integer_partial_cmp_u32(gm: GenerationMode, limit: usize) {
...
fn demo_u32_partial_cmp_integer(gm: GenerationMode, limit: usize) {
...
fn benchmark_integer_partial_cmp_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_u32_partial_cmp_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
