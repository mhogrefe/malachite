...
fn demo_integer_partial_eq_u32(gm: GenerationMode, limit: usize) {
...
fn demo_u32_partial_eq_integer(gm: GenerationMode, limit: usize) {
...
fn benchmark_integer_partial_eq_u32_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
...
fn benchmark_u32_partial_eq_integer_library_comparison(
    gm: GenerationMode,
    limit: usize,
    file_name: &str,
) {
